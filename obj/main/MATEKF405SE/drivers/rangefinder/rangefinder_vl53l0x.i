# 1 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
...
# 1 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
# 99 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
...
# 100 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 2
...
# 101 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 2
...
# 64 "./src/main/platform.h" 2
# 103 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 2
...
# 107 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 2
...
# 109 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 2
...
# 110 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 2
...
# 112 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 2
...
# 113 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 2
...
# 115 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 2
...
# 229 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
   _Bool 
# 229 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
        tcc;
    
# 230 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
   _Bool 
# 230 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
        msrc;
    
# 231 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
   _Bool 
# 231 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
        dss;
    
# 232 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
   _Bool 
# 232 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
        pre_range;
    
# 233 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
   _Bool 
# 233 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
        final_range;
...
static int32_t lastMeasurementCm = (-1);
static 
# 248 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
      _Bool 
# 248 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
           lastMeasurementIsNew = 
# 248 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                                  0
# 248 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                                       ;
...
static 
# 250 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
      _Bool 
# 250 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
           isInitialized = 
# 250 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                           0
# 250 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                                ;
static 
# 251 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
      _Bool 
# 251 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
           isResponding = 
# 251 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                          1
# 251 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
...
# 302 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
...
# 368 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"

# 368 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
_Bool 
# 368 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
    setSignalRateLimit(busDevice_t * busDev, float limit_Mcps)
{
    if (limit_Mcps < 0 || limit_Mcps > 511.99) {
        return 
# 371 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
              0
# 371 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                   ;
    }


    writeReg16(busDev, 0x44, limit_Mcps * (1 << 7));
    return 
# 376 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
          1
# 376 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
              ;
}
...
{
    return (float)readReg16(busDev, 0x44) / (1 << 7);
}



# 386 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
_Bool 
# 386 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
    performSingleRefCalibration(busDevice_t * busDev, uint8_t vhv_init_byte)
{
    writeReg(busDev, 0x00, 0x01 | vhv_init_byte);

    (timeoutStartMs = millis());
    while ((readReg(busDev, 0x13) & 0x07) == 0) {
        if ((timeoutValueMs > 0 && ((uint16_t)millis() - timeoutStartMs) > timeoutValueMs)) {
            return 
# 393 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                  0
# 393 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                       ;
        }
    }

    writeReg(busDev, 0x0B, 0x01);

    writeReg(busDev, 0x00, 0x00);

    return 
# 401 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
          1
# 401 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
              ;
}
...
{
    uint8_t sequence_config = readReg(busDev, 0x01);
...
uint8_t getVcselPulsePeriod(busDevice_t * busDev, vcselPeriodType_e type)
{
    if (type == VcselPeriodPreRange) {
        return (((readReg(busDev, 0x50)) + 1) << 1);
    }
    else if (type == VcselPeriodFinalRange) {
        return (((readReg(busDev, 0x70)) + 1) << 1);
    }
    else {
        return 255;
    }
...
void getSequenceStepTimeouts(busDevice_t * busDev, sequenceStepEnables_t const * enables, sequenceStepTimeouts_t * timeouts)
{
    ...
    timeouts->final_range_mclks = decodeTimeout(readReg16(busDev, 0x71));
...
# 464 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"

# 464 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
_Bool 
# 464 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
    setMeasurementTimingBudget(busDevice_t * busDev, uint32_t budget_us)
{
...
# 479 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                                             0
# 479 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                                                  ; }
    ...
    if (enables.final_range) {
        ...
        if (used_budget_us > budget_us) {
            ...
            return 
# 512 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                  0
# 512 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                       ;
        }

        uint32_t final_range_timeout_us = budget_us - used_budget_us;
# 525 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
        ...
        writeReg16(busDev, 0x71, encodeTimeout(final_range_timeout_mclks));



        measurementTimingBudgetUs = budget_us;
    }

    return 
# 539 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
          1
# 539 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
              ;
}
...
# 594 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"

# 594 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
_Bool 
# 594 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
    setVcselPulsePeriod(busDevice_t * busDev, vcselPeriodType_e type, uint8_t period_pclks)
{
    ...
    getSequenceStepEnables(busDev, &enables);
    getSequenceStepTimeouts(busDev, &enables, &timeouts);
# 617 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
    if (type == VcselPeriodPreRange) {

        switch (period_pclks) {
            case 12:
                writeReg(busDev, 0x57, 0x18);
                break;

            case 14:
                writeReg(busDev, 0x57, 0x30);
                break;

            case 16:
                writeReg(busDev, 0x57, 0x40);
                break;

            case 18:
                writeReg(busDev, 0x57, 0x50);
                break;

            default:

                return 
# 638 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                      0
# 638 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                           ;
        }

        writeReg(busDev, 0x56, 0x08);


        writeReg(busDev, 0x50, vcsel_period_reg);
        ...
        writeReg16(busDev, 0x51, encodeTimeout(new_pre_range_timeout_mclks));
        ...
        writeReg(busDev, 0x46, (new_msrc_timeout_mclks > 256) ? 255 : (new_msrc_timeout_mclks - 1));
        ...
        switch (period_pclks) {
            case 8:
                writeReg(busDev, 0x48, 0x10);
                writeReg(busDev, 0x47, 0x08);
                writeReg(busDev, 0x32, 0x02);
                writeReg(busDev, 0x30, 0x0C);
                writeReg(busDev, 0xFF, 0x01);
                writeReg(busDev, 0x30, 0x30);
                writeReg(busDev, 0xFF, 0x00);
                break;

            case 10:
                writeReg(busDev, 0x48, 0x28);
                writeReg(busDev, 0x47, 0x08);
                writeReg(busDev, 0x32, 0x03);
                writeReg(busDev, 0x30, 0x09);
                writeReg(busDev, 0xFF, 0x01);
                writeReg(busDev, 0x30, 0x20);
                writeReg(busDev, 0xFF, 0x00);
                break;

            case 12:
                writeReg(busDev, 0x48, 0x38);
                writeReg(busDev, 0x47, 0x08);
                writeReg(busDev, 0x32, 0x03);
                writeReg(busDev, 0x30, 0x08);
                writeReg(busDev, 0xFF, 0x01);
                writeReg(busDev, 0x30, 0x20);
                writeReg(busDev, 0xFF, 0x00);
                break;
            ...
            case 14:
                writeReg(busDev, 0x48, 0x48);
                writeReg(busDev, 0x47, 0x08);
                writeReg(busDev, 0x32, 0x03);
                writeReg(busDev, 0x30, 0x07);
                writeReg(busDev, 0xFF, 0x01);
                writeReg(busDev, 0x30, 0x20);
                writeReg(busDev, 0xFF, 0x00);
                break;
            ...
            default:
                ...
                return 
# 710 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                      0
# 710 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                           ;
        }


        writeReg(busDev, 0x70, vcsel_period_reg);
# 726 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
        ...
        writeReg16(busDev, 0x71, encodeTimeout(new_final_range_timeout_mclks));

    }
    else {

        return 
# 737 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
              0
# 737 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                   ;
    }
    ...
    uint8_t sequence_config = readReg(busDev, 0x01);
    writeReg(busDev, 0x01, 0x02);
    performSingleRefCalibration(busDev, 0x0);
    writeReg(busDev, 0x01, sequence_config);



    return 
# 753 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
          1
# 753 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
              ;
}
...
# 759 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
_Bool 
# 759 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
    getSpadInfo(busDevice_t * busDev, uint8_t * count, 
# 759 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                                                       _Bool 
# 759 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                                                            * type_is_aperture)
{
    ...
    while (readReg(busDev, 0x83) == 0x00)
    {
        if ((timeoutValueMs > 0 && ((uint16_t)millis() - timeoutStartMs) > timeoutValueMs)) {
            return 
# 781 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                  0
# 781 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                       ;
        }
    }
    ...
    *type_is_aperture = (tmp >> 7) & 0x01;
    ...
    return 
# 800 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
          1
# 800 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
              ;
}
...
static void vl53l0x_Init(rangefinderDev_t * rangefinder)
{
    uint8_t byte;
    isInitialized = 
# 806 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                   0
# 806 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                        ;



    byte = readReg(rangefinder->busDev, 0x89);
    writeReg(rangefinder->busDev, 0x89, byte | 0x01);
    ...
    byte = readReg(rangefinder->busDev, 0x60);
    writeReg(rangefinder->busDev, 0x60, byte | 0x12);


    setSignalRateLimit(rangefinder->busDev, 0.25);

    writeReg(rangefinder->busDev, 0x01, 0xFF);



    uint8_t spad_count;
    
# 836 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
   _Bool 
# 836 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
    ...
    readMulti(rangefinder->busDev, 0xB0, ref_spad_map, 6);


    writeReg(rangefinder->busDev, 0xFF, 0x01);
    writeReg(rangefinder->busDev, 0x4F, 0x00);
    writeReg(rangefinder->busDev, 0x4E, 0x2C);
    writeReg(rangefinder->busDev, 0xFF, 0x00);
    writeReg(rangefinder->busDev, 0xB6, 0xB4);
    ...
    writeMulti(rangefinder->busDev, 0xB0, ref_spad_map, 6);
    ...
    writeReg(rangefinder->busDev, 0x0A, 0x04);
    writeReg(rangefinder->busDev, 0x84, readReg(rangefinder->busDev, 0x84) & ~0x10);
    writeReg(rangefinder->busDev, 0x0B, 0x01);
    ...
    writeReg(rangefinder->busDev, 0x01, 0xE8);


    setMeasurementTimingBudget(rangefinder->busDev, measurementTimingBudgetUs);


    writeReg(rangefinder->busDev, 0x01, 0x01);
    ...
    writeReg(rangefinder->busDev, 0x01, 0x02);
    ...
    isInitialized = 
# 1016 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                   1
# 1016 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                       ;
}
...
void vl53l0x_Update(rangefinderDev_t * rangefinder)
{
    ...
    switch (measSteps) {
        ...
        case MEASUREMENT_WAIT:
            ...
            if (readReg(rangefinder->busDev, 0x00) & 0x01) {
                if ((timeoutValueMs > 0 && ((uint16_t)millis() - timeoutStartMs) > timeoutValueMs)) {
                    lastMeasurementCm = (-1);
        ...
        case MEASUREMENT_READ:
            if ((readReg(rangefinder->busDev, 0x13) & 0x07) == 0) {
                if ((timeoutValueMs > 0 && ((uint16_t)millis() - timeoutStartMs) > timeoutValueMs)) {
                    lastMeasurementCm = (-1);
                    measSteps = MEASUREMENT_START;
                }
                ...
                uint16_t raw = readReg16(rangefinder->busDev, 0x14 + 10);
                writeReg(rangefinder->busDev, 0x0B, 0x01);

                lastMeasurementCm = raw / 10;
                lastMeasurementIsNew = 
# 1069 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                                      1
# 1069 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                                          ;
                measSteps = MEASUREMENT_START;
            }
            break;
    }
# 1126 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
}
...
int32_t vl53l0x_GetDistance(rangefinderDev_t *dev)
{
    ...
    if (isResponding && isInitialized) {
        if (lastMeasurementIsNew) {
            lastMeasurementIsNew = 
# 1134 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                                  0
# 1134 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                                       ;
            return lastMeasurementCm < 250 ? lastMeasurementCm : (-1);
        }
        else {
            return (-3);
        }
...
static 
# 1146 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
      _Bool 
# 1146 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
...
# 1153 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
       _Bool 
# 1153 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
            ack = busRead(busDev, 0xc0, &model_id);
        if (ack && model_id == 0xEE) {
            return 
# 1155 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                  1
# 1155 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                      ;
        }
    };

    return 
# 1159 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
          0
# 1159 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
               ;
}



# 1163 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
_Bool 
# 1163 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
    vl53l0xDetect(rangefinderDev_t * rangefinder)
{
    rangefinder->busDev = busDeviceInit(BUSTYPE_I2C, DEVHW_VL53L0X, 0, OWNER_RANGEFINDER);
    if (rangefinder->busDev == 
# 1166 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
                              ((void *)0)
# 1166 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                                  ) {
        return 
# 1167 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
              0
# 1167 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                   ;
    }
    ...
    if (!deviceDetect(rangefinder->busDev)) {
        ...
        return 
# 1172 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
              0
# 1172 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
                   ;
    }

    rangefinder->delayMs = 33;
    rangefinder->maxRangeCm = 250;
    rangefinder->detectionConeDeciDegrees = 900;
    rangefinder->detectionConeExtendedDeciDegrees = 900;
    ...
    return 
# 1184 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c" 3 4
          1
# 1184 "./src/main/drivers/rangefinder/rangefinder_vl53l0x.c"
              ;
}
