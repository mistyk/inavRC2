...
# 38 "./src/main/drivers/timer.c" 2

timHardwareContext_t * timerCtx[14];
...
{
    if (tch == 
# 59 "./src/main/drivers/timer.c" 3 4
              ((void *)0)
# 59 "./src/main/drivers/timer.c"
                  ) {
        return;
    }
...
{
    if (tch == 
# 69 "./src/main/drivers/timer.c" 3 4
              ((void *)0)
# 69 "./src/main/drivers/timer.c"
                  ) {
        return;
    }

    impl_timerConfigBase(tch, period, hz);
    impl_timerNVICConfigure(tch, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0));
...
TCH_t * timerGetTCH(const timerHardware_t * timHw)
{
    ...
    if (timerIndex >= 14) {
        debugTracePrintf(
# 83 "./src/main/drivers/timer.c" 3 4
       0
# 83 "./src/main/drivers/timer.c"
       , "Can't find hardware timer definition");
        return 
# 84 "./src/main/drivers/timer.c" 3 4
              ((void *)0)
# 84 "./src/main/drivers/timer.c"
                  ;
    }


    if (timerCtx[timerIndex] == 
# 88 "./src/main/drivers/timer.c" 3 4
                               ((void *)0)
# 88 "./src/main/drivers/timer.c"
                                   ) {
        timerCtx[timerIndex] = memAllocate(sizeof(timHardwareContext_t), OWNER_TIMER);


        if (timerCtx[timerIndex] == 
# 92 "./src/main/drivers/timer.c" 3 4
                                   ((void *)0)
# 92 "./src/main/drivers/timer.c"
                                       ) {
            debugTracePrintf(
# 93 "./src/main/drivers/timer.c" 3 4
           0
# 93 "./src/main/drivers/timer.c"
           , "Can't allocate TCH object");
            return 
# 94 "./src/main/drivers/timer.c" 3 4
                  ((void *)0)
# 94 "./src/main/drivers/timer.c"
                      ;
        }
    ...
    timerCtx[timerIndex]->ch[timHw->channelIndex].dma = 
# 111 "./src/main/drivers/timer.c" 3 4
                                                       ((void *)0)
# 111 "./src/main/drivers/timer.c"
                                                           ;
    timerCtx[timerIndex]->ch[timHw->channelIndex].cb = 
# 112 "./src/main/drivers/timer.c" 3 4
                                                      ((void *)0)
# 112 "./src/main/drivers/timer.c"
                                                          ;
...
{
    if (tch == 
# 128 "./src/main/drivers/timer.c" 3 4
              ((void *)0)
# 128 "./src/main/drivers/timer.c"
                  ) {
        return;
    }

    if (cb->callbackEdge == 
# 132 "./src/main/drivers/timer.c" 3 4
                           ((void *)0)
# 132 "./src/main/drivers/timer.c"
                               ) {
        impl_timerDisableIT(tch, (((uint16_t)0x0002) << (tch->timHw->channelIndex)));
    }

    if (cb->callbackOvr == 
# 136 "./src/main/drivers/timer.c" 3 4
                          ((void *)0)
# 136 "./src/main/drivers/timer.c"
                              ) {
        impl_timerDisableIT(tch, ((uint16_t)0x0001));
    }

    tch->cb = cb;

    if (cb->callbackEdge) {
        impl_timerEnableIT(tch, (((uint16_t)0x0002) << (tch->timHw->channelIndex)));
    }

    if (cb->callbackOvr) {
        impl_timerEnableIT(tch, ((uint16_t)0x0001));
    }
}


void timerChConfigIC(TCH_t * tch, 
# 152 "./src/main/drivers/timer.c" 3 4
                                 _Bool 
# 152 "./src/main/drivers/timer.c"
                                      polarityRising, unsigned inputFilterSamples)
{
...
const timerHardware_t * timerGetByTag(ioTag_t tag, timerUsageFlag_e flag)
{
    if (!tag) {
        return 
# 183 "./src/main/drivers/timer.c" 3 4
              ((void *)0)
# 183 "./src/main/drivers/timer.c"
                  ;
    }
    ...
    return 
# 193 "./src/main/drivers/timer.c" 3 4
          ((void *)0)
# 193 "./src/main/drivers/timer.c"
              ;
}
...
void timerChCaptureEnable(TCH_t * tch)
{
    impl_timerChCaptureCompareEnable(tch, 
...
{
    impl_timerChCaptureCompareEnable(tch, 
# 223 "./src/main/drivers/timer.c" 3 4
                                         0
# 223 "./src/main/drivers/timer.c"
                                              );
}
...
# 236 "./src/main/drivers/timer.c" 3 4
_Bool 
# 236 "./src/main/drivers/timer.c"
    timerPWMConfigChannelDMA(TCH_t * tch, void * dmaBuffer, uint32_t dmaBufferSize)
{
...
# 256 "./src/main/drivers/timer.c" 3 4
_Bool 
# 256 "./src/main/drivers/timer.c"
    timerPWMDMAInProgress(TCH_t * tch)
{
