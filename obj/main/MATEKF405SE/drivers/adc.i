...
# 32 "./src/main/drivers/adc.c" 2
# 40 "./src/main/drivers/adc.c"
...
volatile uint16_t adcValues[ADCDEV_COUNT][ADC_CHN_COUNT * 20];
...
# 76 "./src/main/drivers/adc.c" 3 4
_Bool 
# 76 "./src/main/drivers/adc.c"
    adcIsFunctionAssigned(uint8_t function)
{
...
# 103 "./src/main/drivers/adc.c"
           isChannelInUse(int channel)
{
    for (int i = 0; i < ADC_FUNCTION_COUNT; i++) {
        if (adcFunctionMap[i] == channel)
            return 
# 107 "./src/main/drivers/adc.c" 3 4
                  1
# 107 "./src/main/drivers/adc.c"
                      ;
    }

    return 
# 110 "./src/main/drivers/adc.c" 3 4
          0
# 110 "./src/main/drivers/adc.c"
               ;
}
...
void adcInit(drv_adc_config_t *init)
{
    ...
    if (isChannelInUse(ADC_CHN_1)) {
        adcConfig[ADC_CHN_1].adcDevice = adcDeviceByInstance(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)));
        if (adcConfig[ADC_CHN_1].adcDevice != ADCINVALID) {
            adcConfig[ADC_CHN_1].tag = ((((2) + 1) << 4) | (0));
    ...
    if (isChannelInUse(ADC_CHN_2)) {
        adcConfig[ADC_CHN_2].adcDevice = adcDeviceByInstance(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)));
        if (adcConfig[ADC_CHN_2].adcDevice != ADCINVALID) {
            adcConfig[ADC_CHN_2].tag = ((((2) + 1) << 4) | (1));
    ...
    if (isChannelInUse(ADC_CHN_3)) {
        adcConfig[ADC_CHN_3].adcDevice = adcDeviceByInstance(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000)));
        if (adcConfig[ADC_CHN_3].adcDevice != ADCINVALID) {
            adcConfig[ADC_CHN_3].tag = ((((2) + 1) << 4) | (5));

            activeChannelCount[adcConfig[ADC_CHN_3].adcDevice] += 1;

        }
    }
# 191 "./src/main/drivers/adc.c"
