...
# 81 "./src/main/drivers/pwm_mapping.c"
        if (init->useUART6 && (timerHardwarePtr->tag == ((((2) + 1) << 4) | (6)) || timerHardwarePtr->tag == ((((2) + 1) << 4) | (7)))) {
        ...
        if (init->useSoftSerial) {
            ...
            if (ss1TimerHardware != 
# 90 "./src/main/drivers/pwm_mapping.c" 3 4
                                   ((void *)0) 
# 90 "./src/main/drivers/pwm_mapping.c"
                                        && ss1TimerHardware->tim == timerHardwarePtr->tim) {
                addBootlogEvent6(BOOT_EVENT_TIMER_CH_SKIPPED, BOOT_EVENT_FLAGS_WARNING, timerIndex, pwmIOConfiguration.motorCount, pwmIOConfiguration.servoCount, 3);
                continue;
            }
        }
# 109 "./src/main/drivers/pwm_mapping.c"
        if (init->useLEDStrip) {
            const timerHardware_t * ledTimHw = timerGetByTag(((((0) + 1) << 4) | (15)), TIM_USE_ANY);
            if (ledTimHw != 
# 111 "./src/main/drivers/pwm_mapping.c" 3 4
                           ((void *)0) 
# 111 "./src/main/drivers/pwm_mapping.c"
                                && timerHardwarePtr->tim == ledTimHw->tim) {
                addBootlogEvent6(BOOT_EVENT_TIMER_CH_SKIPPED, BOOT_EVENT_FLAGS_WARNING, timerIndex, pwmIOConfiguration.motorCount, pwmIOConfiguration.servoCount, 3);
                continue;
            }
        }
# 151 "./src/main/drivers/pwm_mapping.c"
        if (init->useSerialRx) {
            type = MAP_TO_NONE;
        }
