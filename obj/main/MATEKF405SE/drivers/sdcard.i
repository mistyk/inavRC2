...
# 38 "./src/main/drivers/sdcard.c" 2
...
void sdcardInsertionDetectDeinit(void)
{
    sdcard.cardDetectPin = IOGetByTag(0);
...
# 68 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 68 "./src/main/drivers/sdcard.c"
    sdcard_isInserted(void)
{
    if (sdcard.cardDetectPin) {
        
# 71 "./src/main/drivers/sdcard.c" 3 4
       _Bool 
# 71 "./src/main/drivers/sdcard.c"
        ...
        return 
# 79 "./src/main/drivers/sdcard.c" 3 4
              1
# 79 "./src/main/drivers/sdcard.c"
                  ;
    }
}
...
# 101 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 101 "./src/main/drivers/sdcard.c"
    sdcard_readBlock(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData)
{
...
# 116 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 116 "./src/main/drivers/sdcard.c"
    sdcard_poll(void)
{
    if (sdcardVTable) {
        ...
        return 
# 121 "./src/main/drivers/sdcard.c" 3 4
              0
# 121 "./src/main/drivers/sdcard.c"
                   ;
    }
}


# 125 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 125 "./src/main/drivers/sdcard.c"
    sdcard_isFunctional(void)
{
    if (sdcardVTable) {
        ...
        return 
# 130 "./src/main/drivers/sdcard.c" 3 4
              0
# 130 "./src/main/drivers/sdcard.c"
                   ;
    }
}


# 134 "./src/main/drivers/sdcard.c" 3 4
_Bool 
# 134 "./src/main/drivers/sdcard.c"
    sdcard_isInitialized(void)
{
    if (sdcardVTable) {
...
const sdcardMetadata_t* sdcard_getMetadata(void)
{
    if (sdcardVTable) {
        ...
        return 
# 149 "./src/main/drivers/sdcard.c" 3 4
              ((void *)0)
# 149 "./src/main/drivers/sdcard.c"
                  ;
    }
}
