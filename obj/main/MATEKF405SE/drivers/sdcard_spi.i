# 1 "./src/main/drivers/sdcard_spi.c"
...
# 1 "./src/main/drivers/sdcard_spi.c"
# 21 "./src/main/drivers/sdcard_spi.c"
...
# 22 "./src/main/drivers/sdcard_spi.c" 2
...
# 23 "./src/main/drivers/sdcard_spi.c" 2
...
# 64 "./src/main/platform.h" 2
# 25 "./src/main/drivers/sdcard_spi.c" 2
...
# 27 "./src/main/drivers/sdcard_spi.c" 2
...
# 28 "./src/main/drivers/sdcard_spi.c" 2
...
# 30 "./src/main/drivers/sdcard_spi.c" 2
...
# 31 "./src/main/drivers/sdcard_spi.c" 2
...
# 32 "./src/main/drivers/sdcard_spi.c" 2
...
# 33 "./src/main/drivers/sdcard_spi.c" 2
...
# 36 "./src/main/drivers/sdcard_spi.c" 2
# 1 "./src/main/drivers/sdcard_impl.h" 1
# 21 "./src/main/drivers/sdcard_impl.h"
       
# 31 "./src/main/drivers/sdcard_impl.h"
...
# 32 "./src/main/drivers/sdcard_impl.h" 2
...
# 69 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 69 "./src/main/drivers/sdcard_impl.h"
        highCapacity;
...
# 87 "./src/main/drivers/sdcard_impl.h" 3 4
_Bool 
# 87 "./src/main/drivers/sdcard_impl.h"
    sdcard_isInserted(void);

typedef struct sdcardVTable_s {
    void (*init)(void);
    
# 91 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 91 "./src/main/drivers/sdcard_impl.h"
        (*readBlock)(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData);
...
# 94 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 94 "./src/main/drivers/sdcard_impl.h"
        (*poll)(void);
    
# 95 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 95 "./src/main/drivers/sdcard_impl.h"
        (*isFunctional)(void);
    
# 96 "./src/main/drivers/sdcard_impl.h" 3 4
   _Bool 
# 96 "./src/main/drivers/sdcard_impl.h"
        (*isInitialized)(void);
...
# 37 "./src/main/drivers/sdcard_spi.c" 2
...
# 161 "./src/main/scheduler/protothreads.h"
#define ptDelayUs(delay) do { (currentPt)->startTime = (timeUs_t)micros(); (currentPt)->delayTime = (delay); ptLabel(); if ((timeDelta_t)(micros() - (currentPt)->startTime) <= (currentPt)->delayTime) { return; } } while (0)
# 172 "./src/main/scheduler/protothreads.h"
#define ptYield() do { ptYielded = false; ptLabel(); if (!ptYielded) { return; } } while (0)
# 182 "./src/main/scheduler/protothreads.h"
...
# 199 "./src/main/scheduler/protothreads.h"
typedef 
# 199 "./src/main/scheduler/protothreads.h" 3 4
       _Bool 
# 199 "./src/main/scheduler/protothreads.h"
            ptSemaphore_t;
...
# 40 "./src/main/drivers/sdcard_spi.c" 2
...
static void sdcardSpi_deselect(void)
{
    ...
    while (busIsBusy(sdcard.dev)) { __asm volatile ("nop"); }
...
# 75 "./src/main/drivers/sdcard_spi.c" 3 4
_Bool 
# 75 "./src/main/drivers/sdcard_spi.c"
    sdcardSpi_isFunctional(void)
{
...
static 
# 111 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 111 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_waitForIdle(int maxBytesToWait)
{
    while (maxBytesToWait > 0) {
        uint8_t response;

        busTransfer(sdcard.dev, &response, 
# 116 "./src/main/drivers/sdcard_spi.c" 3 4
                                          ((void *)0)
# 116 "./src/main/drivers/sdcard_spi.c"
                                              , 1);

        if (response == 0xFF) {
            return 
# 119 "./src/main/drivers/sdcard_spi.c" 3 4
                  1
# 119 "./src/main/drivers/sdcard_spi.c"
                      ;
        }
    ...
    return 
# 125 "./src/main/drivers/sdcard_spi.c" 3 4
          0
# 125 "./src/main/drivers/sdcard_spi.c"
               ;
}
...
static uint8_t sdcardSpi_waitForNonIdleByte(int maxDelay)
{
    for (int i = 0; i <= maxDelay; i++) {
        ...
        busTransfer(sdcard.dev, &response, 
# 138 "./src/main/drivers/sdcard_spi.c" 3 4
                                          ((void *)0)
# 138 "./src/main/drivers/sdcard_spi.c"
                                              , 1);
...
# 157 "./src/main/drivers/sdcard_spi.c"
static uint8_t sdcardSpi_sendCommand(uint8_t commandCode, uint32_t commandArgument)
{
    ...
    if (!sdcardSpi_waitForIdle(8) && commandCode != 0)
        return 0xFF;

    busTransfer(sdcard.dev, 
# 173 "./src/main/drivers/sdcard_spi.c" 3 4
                           ((void *)0)
# 173 "./src/main/drivers/sdcard_spi.c"
...
static 
# 192 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 192 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_validateInterfaceCondition(void)
{
    ...
    uint8_t status = sdcardSpi_sendCommand(8, (0x01 << 8) | 0xAB);
    ...
    if (status == (4 | 1)) {
        ...
        busTransfer(sdcard.dev, ifCondReply, 
# 208 "./src/main/drivers/sdcard_spi.c" 3 4
                                            ((void *)0)
# 208 "./src/main/drivers/sdcard_spi.c"
                                                , sizeof(ifCondReply));
...
static 
# 224 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 224 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_readOCRRegister(uint32_t *result)
{
    uint8_t response[4];

    sdcardSpi_select();

    uint8_t status = sdcardSpi_sendCommand(58, 0);

    busTransfer(sdcard.dev, response, 
# 232 "./src/main/drivers/sdcard_spi.c" 3 4
                                     ((void *)0)
# 232 "./src/main/drivers/sdcard_spi.c"
                                         , sizeof(response));
    ...
    if (status == 0) {
        *result = (response[0] << 24) | (response[1] << 16) | (response[2] << 8) | response[3];
        return 
# 238 "./src/main/drivers/sdcard_spi.c" 3 4
              1
# 238 "./src/main/drivers/sdcard_spi.c"
                  ;
    } else {
        return 
# 240 "./src/main/drivers/sdcard_spi.c" 3 4
              0
# 240 "./src/main/drivers/sdcard_spi.c"
                   ;
    }
}
...
static sdcardReceiveBlockStatus_e sdcardSpi_receiveDataBlock(uint8_t *buffer, int count)
{
    ...
    busTransfer(sdcard.dev, buffer, 
# 267 "./src/main/drivers/sdcard_spi.c" 3 4
                                   ((void *)0)
# 267 "./src/main/drivers/sdcard_spi.c"
                                       , count);


    busTransfer(sdcard.dev, 
# 270 "./src/main/drivers/sdcard_spi.c" 3 4
                           ((void *)0)
# 270 "./src/main/drivers/sdcard_spi.c"
                               , 
# 270 "./src/main/drivers/sdcard_spi.c" 3 4
                                 ((void *)0)
# 270 "./src/main/drivers/sdcard_spi.c"
...
static 
# 275 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 275 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_sendDataBlockFinish(void)
{
    static const uint8_t dummyCRC[2] = { 0x00, 0x00 };


    busTransfer(sdcard.dev, 
# 280 "./src/main/drivers/sdcard_spi.c" 3 4
                           ((void *)0)
# 280 "./src/main/drivers/sdcard_spi.c"
                               , dummyCRC, 2);

    uint8_t dataResponseToken;
    busTransfer(sdcard.dev, &dataResponseToken, 
# 283 "./src/main/drivers/sdcard_spi.c" 3 4
                                               ((void *)0)
# 283 "./src/main/drivers/sdcard_spi.c"
                                                   , 1);
# 297 "./src/main/drivers/sdcard_spi.c"
...
static void sdcardSpi_sendDataBlockBegin(uint8_t *buffer, 
# 303 "./src/main/drivers/sdcard_spi.c" 3 4
                                                         _Bool 
# 303 "./src/main/drivers/sdcard_spi.c"
                                                              multiBlockWrite)
{
    uint8_t blockStartToken[2] = { 0xFF, multiBlockWrite ? 0xFC : 0xFE };


    busTransfer(sdcard.dev, 
# 308 "./src/main/drivers/sdcard_spi.c" 3 4
                           ((void *)0)
# 308 "./src/main/drivers/sdcard_spi.c"
                               , blockStartToken, 2);


    busTransfer(sdcard.dev, 
# 311 "./src/main/drivers/sdcard_spi.c" 3 4
                           ((void *)0)
# 311 "./src/main/drivers/sdcard_spi.c"
                               , buffer, 128);
}

static 
# 314 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 314 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_receiveCID(void)
{
    uint8_t cid[16];

    if (sdcardSpi_receiveDataBlock(cid, sizeof(cid)) != SDCARD_RECEIVE_SUCCESS) {
        return 
# 319 "./src/main/drivers/sdcard_spi.c" 3 4
              0
# 319 "./src/main/drivers/sdcard_spi.c"
                   ;
    }
    ...
    return 
# 335 "./src/main/drivers/sdcard_spi.c" 3 4
          1
# 335 "./src/main/drivers/sdcard_spi.c"
              ;
}

static 
# 338 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 338 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_fetchCSD(void)
{
...
# 348 "./src/main/drivers/sdcard_spi.c" 3 4
   _Bool 
# 348 "./src/main/drivers/sdcard_spi.c"
        success =
        sdcardSpi_sendCommand(9, 0) == 0
    ...
    if (success) {
        switch (readBitfield(sdcard.csd.data, 0, 2)) {
            ...
            default:
                success = 
# 371 "./src/main/drivers/sdcard_spi.c" 3 4
                         0
# 371 "./src/main/drivers/sdcard_spi.c"
                              ;
        }
    }
...
static 
# 385 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 385 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_checkInitDone(void)
{
    sdcardSpi_select();
    uint8_t status = sdcardSpi_sendAppCommand(41, sdcard.version == 2 ? 1 << 30 : 0);
    sdcardSpi_deselect();
...
static 
# 395 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 395 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_setBlockLength(uint32_t blockLen)
{
    sdcardSpi_select();
    uint8_t status = sdcardSpi_sendCommand(16, blockLen);
    sdcardSpi_deselect();
...
static 
# 407 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 407 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_isReady(void)
{
    return sdcard.state == SDCARD_STATE_READY || sdcard.state == SDCARD_STATE_WRITING_MULTIPLE_BLOCKS;
}
# 422 "./src/main/drivers/sdcard_spi.c"
static sdcardOperationStatus_e sdcardSpi_endWriteBlocks(void)
{
    uint8_t writeEndToken[2] = { 0xFF, 0xFD };

    sdcard.multiWriteBlocksRemain = 0;


    busTransfer(sdcard.dev, 
# 429 "./src/main/drivers/sdcard_spi.c" 3 4
                           ((void *)0)
# 429 "./src/main/drivers/sdcard_spi.c"
                               , writeEndToken, 2);
...
static 
# 448 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 448 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_poll(void)
{
    if (sdcard.dev == 
# 450 "./src/main/drivers/sdcard_spi.c" 3 4
                     ((void *)0)
# 450 "./src/main/drivers/sdcard_spi.c"
                         ) {
        return 
# 451 "./src/main/drivers/sdcard_spi.c" 3 4
              0
# 451 "./src/main/drivers/sdcard_spi.c"
                   ;
    }

    uint8_t initStatus;
    
# 455 "./src/main/drivers/sdcard_spi.c" 3 4
   _Bool 
# 455 "./src/main/drivers/sdcard_spi.c"
        sendComplete;
    ...
    switch (sdcard.state) {
        case SDCARD_STATE_RESET:
            ...
            initStatus = sdcardSpi_sendCommand(0, 0);
        ...
        case SDCARD_STATE_CARD_INIT_IN_PROGRESS:
            if (sdcardSpi_checkInitDone()) {
                if (sdcard.version == 2) {
                    ...
                    sdcard.highCapacity = 
# 493 "./src/main/drivers/sdcard_spi.c" 3 4
                                         0
# 493 "./src/main/drivers/sdcard_spi.c"
                                              ;
                }
                ...
                if (sdcardSpi_fetchCSD()) {
                    ...
                    uint8_t status = sdcardSpi_sendCommand(10, 0);
        ...
        case SDCARD_STATE_INITIALIZATION_RECEIVE_CID:
            if (sdcardSpi_receiveCID()) {
                ...
                if (!sdcard.highCapacity && !sdcardSpi_setBlockLength(512)) {
                    sdcardSpi_reset();
                    goto doMore;
                }
        ...
        case SDCARD_STATE_SENDING_WRITE:
            ...
            sendComplete = 
# 538 "./src/main/drivers/sdcard_spi.c" 3 4
                          0
# 538 "./src/main/drivers/sdcard_spi.c"
                               ;


            busTransfer(sdcard.dev, 
# 541 "./src/main/drivers/sdcard_spi.c" 3 4
                                   ((void *)0)
# 541 "./src/main/drivers/sdcard_spi.c"
                                       , sdcard.pendingOperation.buffer + 128 * sdcard.pendingOperation.chunkIndex, 128);
            sdcard.pendingOperation.chunkIndex++;
            sendComplete = sdcard.pendingOperation.chunkIndex == 512 / 128;
...
# 564 "./src/main/drivers/sdcard_spi.c" 3 4
                                                                                                                          ((void *)0)
# 564 "./src/main/drivers/sdcard_spi.c"
        ...
        case SDCARD_STATE_READING:
            switch (sdcardSpi_receiveDataBlock(sdcard.pendingOperation.buffer, 512)) {
...
# 632 "./src/main/drivers/sdcard_spi.c" 3 4
                           ((void *)0)
# 632 "./src/main/drivers/sdcard_spi.c"
                               ,
                            sdcard.pendingOperation.callbackData
                        );
                    }
...
# 679 "./src/main/drivers/sdcard_spi.c"
static sdcardOperationStatus_e sdcardSpi_writeBlock(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData)
{
    ...
    switch (sdcard.state) {
        ...
        case SDCARD_STATE_READY:
            ...
            status = sdcardSpi_sendCommand(24, sdcard.highCapacity ? blockIndex : blockIndex * 512);
...
# 742 "./src/main/drivers/sdcard_spi.c"
static sdcardOperationStatus_e sdcardSpi_beginWriteBlocks(uint32_t blockIndex, uint32_t blockCount)
{
    ...
    if (
        sdcardSpi_sendAppCommand(23, blockCount) == 0
        && sdcardSpi_sendCommand(25, sdcard.highCapacity ? blockIndex : blockIndex * 512) == 0
    ) {
        sdcard.state = SDCARD_STATE_WRITING_MULTIPLE_BLOCKS;
...
# 790 "./src/main/drivers/sdcard_spi.c"
static 
# 790 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 790 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_readBlock(uint32_t blockIndex, uint8_t *buffer, sdcard_operationCompleteCallback_c callback, uint32_t callbackData)
{
    if (sdcard.state != SDCARD_STATE_READY) {
        if (sdcard.state == SDCARD_STATE_WRITING_MULTIPLE_BLOCKS) {
            if (sdcardSpi_endWriteBlocks() != SDCARD_OPERATION_SUCCESS) {
                return 
# 795 "./src/main/drivers/sdcard_spi.c" 3 4
                      0
# 795 "./src/main/drivers/sdcard_spi.c"
                           ;
            }
        } else {
            return 
# 798 "./src/main/drivers/sdcard_spi.c" 3 4
                  0
# 798 "./src/main/drivers/sdcard_spi.c"
                       ;
        }
    }
    ...
    uint8_t status = sdcardSpi_sendCommand(17, sdcard.highCapacity ? blockIndex : blockIndex * 512);
    ...
    if (status == 0) {
        ...
        return 
# 819 "./src/main/drivers/sdcard_spi.c" 3 4
              1
# 819 "./src/main/drivers/sdcard_spi.c"
                  ;
    } else {
        sdcardSpi_deselect();
        return 
# 822 "./src/main/drivers/sdcard_spi.c" 3 4
              0
# 822 "./src/main/drivers/sdcard_spi.c"
                   ;
    }
}
...
static 
# 829 "./src/main/drivers/sdcard_spi.c" 3 4
      _Bool 
# 829 "./src/main/drivers/sdcard_spi.c"
           sdcardSpi_isInitialized(void)
{
...
void sdcardSpi_init(void)
{
    ...
    busDeselectDevice(sdcard.dev);
    busTransfer(sdcard.dev, 
# 858 "./src/main/drivers/sdcard_spi.c" 3 4
                           ((void *)0)
# 858 "./src/main/drivers/sdcard_spi.c"
                               , 
# 858 "./src/main/drivers/sdcard_spi.c" 3 4
                                 ((void *)0)
# 858 "./src/main/drivers/sdcard_spi.c"
    ...
    while (busIsBusy(sdcard.dev)) {
        if (time-- == 0) {
            ...
            sdcard.dev = 
# 865 "./src/main/drivers/sdcard_spi.c" 3 4
                        ((void *)0)
# 865 "./src/main/drivers/sdcard_spi.c"
                            ;
            sdcard.state = SDCARD_STATE_NOT_PRESENT;
            sdcard.failureCount++;
            return;
