...
# 116 "./src/main/drivers/rx_pwm.c" 3 4
_Bool 
# 116 "./src/main/drivers/rx_pwm.c"
    isPPMDataBeingReceived(void)
{
...
static void ppmInit(void)
{
    ...
    ppmDev.tracking = 
# 168 "./src/main/drivers/rx_pwm.c" 3 4
                         0
# 168 "./src/main/drivers/rx_pwm.c"
                              ;
    ppmDev.overflowed = 
...
static void ppmOverflowCallback(struct TCH_s * tch, uint32_t capture)
{
    ...
    if (capture == 0x10000 - 1) {
        ppmDev.overflowed = 
# 179 "./src/main/drivers/rx_pwm.c" 3 4
                           1
# 179 "./src/main/drivers/rx_pwm.c"
                               ;
    }
}
...
static void ppmEdgeCallback(struct TCH_s * tch, uint32_t capture)
{
    ...
    ppmDev.overflowed = 
# 215 "./src/main/drivers/rx_pwm.c" 3 4
                       0
# 215 "./src/main/drivers/rx_pwm.c"
                            ;
    ...
    if (ppmDev.deltaTime > 2700) {
        ...
        ppmDev.tracking = 
# 269 "./src/main/drivers/rx_pwm.c" 3 4
                           1
# 269 "./src/main/drivers/rx_pwm.c"
                               ;
        ...
        if (ppmDev.deltaTime > 750
            ...
            ppmDev.tracking = 
# 284 "./src/main/drivers/rx_pwm.c" 3 4
                             0
# 284 "./src/main/drivers/rx_pwm.c"
                                  ;
            for (i = 0; i < 16; i++) {
                ppmDev.captures[i] = 0;
            }
...
# 294 "./src/main/drivers/rx_pwm.c" 3 4
_Bool 
# 294 "./src/main/drivers/rx_pwm.c"
    isPWMDataBeingReceived(void)
{
    int channel;
    for (channel = 0; channel < 16; channel++) {
        if (captures[channel] != 0) {
            return 
# 299 "./src/main/drivers/rx_pwm.c" 3 4
                  1
# 299 "./src/main/drivers/rx_pwm.c"
                      ;
        }
    }
    return 
# 302 "./src/main/drivers/rx_pwm.c" 3 4
          0
# 302 "./src/main/drivers/rx_pwm.c"
               ;
}
...
static void pwmEdgeCallback(struct TCH_s * tch, uint32_t capture)
{
    ...
    if (pwmInputPort->state == 0) {
        ...
        timerChConfigIC(tch, 
# 323 "./src/main/drivers/rx_pwm.c" 3 4
                            0
# 323 "./src/main/drivers/rx_pwm.c"
                                 , 10);
    } else {
        ...
        timerChConfigIC(tch, 
# 338 "./src/main/drivers/rx_pwm.c" 3 4
                            1
# 338 "./src/main/drivers/rx_pwm.c"
                                , 10);
        pwmInputPort->missedEvents = 0;
    }
}
...
void pwmInConfig(const timerHardware_t *timerHardwarePtr, uint8_t channel)
{
    ...
    if (tch == 
# 348 "./src/main/drivers/rx_pwm.c" 3 4
              ((void *)0)
# 348 "./src/main/drivers/rx_pwm.c"
                  ) {
        return;
    }
...
void ppmInConfig(const timerHardware_t *timerHardwarePtr)
{
    TCH_t * tch = timerGetTCH(timerHardwarePtr);
    if (tch == 
# 374 "./src/main/drivers/rx_pwm.c" 3 4
              ((void *)0)
# 374 "./src/main/drivers/rx_pwm.c"
                  ) {
        return;
    }
    ...
    timerChConfigCallbacks(tch, &self->cb);
    timerChConfigIC(tch, 
# 391 "./src/main/drivers/rx_pwm.c" 3 4
                        1
# 391 "./src/main/drivers/rx_pwm.c"
                            , 10);
    timerChCaptureEnable(tch);
}
