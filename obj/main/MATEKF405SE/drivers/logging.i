...
const char * getBootlogEventDescription(bootLogEventCode_e eventCode)
{
    if (eventCode < BOOT_EVENT_CODE_COUNT) {
        ...
        return 
# 70 "./src/main/drivers/logging.c" 3 4
              ((void *)0)
# 70 "./src/main/drivers/logging.c"
                  ;
    }
}
...
void initBootlog(void)
{
    ...
    eventCount = 0;
    eventOverflow = 
# 79 "./src/main/drivers/logging.c" 3 4
                   0
# 79 "./src/main/drivers/logging.c"
                        ;
}
...
static void addBootlogEntry(bootLogEntry_t * event)
{
    if (eventCount >= 64) {
        eventOverflow = 
# 100 "./src/main/drivers/logging.c" 3 4
                       1
# 100 "./src/main/drivers/logging.c"
                           ;
        return;
    }
