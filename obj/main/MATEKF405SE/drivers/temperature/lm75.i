# 1 "./src/main/drivers/temperature/lm75.c"
...
# 1 "./src/main/drivers/temperature/lm75.c"
# 18 "./src/main/drivers/temperature/lm75.c"
...
# 19 "./src/main/drivers/temperature/lm75.c" 2
...
# 20 "./src/main/drivers/temperature/lm75.c" 2
...
# 22 "./src/main/drivers/temperature/lm75.c" 2
...
# 64 "./src/main/platform.h" 2
# 24 "./src/main/drivers/temperature/lm75.c" 2
...
# 26 "./src/main/drivers/temperature/lm75.c" 2
...
# 28 "./src/main/drivers/temperature/lm75.c" 2
# 1 "./src/main/drivers/temperature/lm75.h" 1
# 18 "./src/main/drivers/temperature/lm75.h"
       


# 1 "./src/main/drivers/temperature/temperature.h" 1
...
# 22 "./src/main/drivers/temperature/lm75.h" 2


# 23 "./src/main/drivers/temperature/lm75.h" 3 4
_Bool 
# 23 "./src/main/drivers/temperature/lm75.h"
    lm75Detect(temperatureDev_t * mag);
# 29 "./src/main/drivers/temperature/lm75.c" 2
...
# 31 "./src/main/drivers/temperature/lm75.c" 2
...
static 
# 37 "./src/main/drivers/temperature/lm75.c" 3 4
      _Bool 
# 37 "./src/main/drivers/temperature/lm75.c"
           lm75Read(temperatureDev_t *tempDev, int16_t *temperature)
{
    uint8_t buf[2];

    
# 41 "./src/main/drivers/temperature/lm75.c" 3 4
   _Bool 
# 41 "./src/main/drivers/temperature/lm75.c"
        ack = busReadBuf(tempDev->busDev, 0x0, buf, 2);

    if (ack) {
        if (temperature) *temperature = (int8_t)buf[0] * 10 + (buf[1] >> 7) * 5;
        return 
# 45 "./src/main/drivers/temperature/lm75.c" 3 4
              1
# 45 "./src/main/drivers/temperature/lm75.c"
                  ;
    }

    return 
# 48 "./src/main/drivers/temperature/lm75.c" 3 4
          0
# 48 "./src/main/drivers/temperature/lm75.c"
               ;
}

#define DETECTION_MAX_RETRY_COUNT 20
static 
# 52 "./src/main/drivers/temperature/lm75.c" 3 4
      _Bool 
# 52 "./src/main/drivers/temperature/lm75.c"
           deviceDetect(temperatureDev_t *tempDev)
{
    for (int retryCount = 0; retryCount < 20; retryCount++) {
        delay(10);
        if (lm75Read(tempDev, 
# 56 "./src/main/drivers/temperature/lm75.c" 3 4
                             ((void *)0)
# 56 "./src/main/drivers/temperature/lm75.c"
                                 )) return 
# 56 "./src/main/drivers/temperature/lm75.c" 3 4
                                           1
# 56 "./src/main/drivers/temperature/lm75.c"
    ...
    return 
# 59 "./src/main/drivers/temperature/lm75.c" 3 4
          0
# 59 "./src/main/drivers/temperature/lm75.c"
               ;
}


# 62 "./src/main/drivers/temperature/lm75.c" 3 4
_Bool 
# 62 "./src/main/drivers/temperature/lm75.c"
    lm75Detect(temperatureDev_t *tempDev)
{
    tempDev->busDev = busDeviceInit(BUSTYPE_I2C, DEVHW_LM75, 0, OWNER_TEMPERATURE);
    if (tempDev->busDev == 
# 65 "./src/main/drivers/temperature/lm75.c" 3 4
                          ((void *)0)
# 65 "./src/main/drivers/temperature/lm75.c"
                              ) {
        return 
# 66 "./src/main/drivers/temperature/lm75.c" 3 4
              0
# 66 "./src/main/drivers/temperature/lm75.c"
                   ;
    }
    ...
    if (!deviceDetect(tempDev)) {
        ...
        return 
# 71 "./src/main/drivers/temperature/lm75.c" 3 4
              0
# 71 "./src/main/drivers/temperature/lm75.c"
                   ;
    }
    ...
    return 
# 76 "./src/main/drivers/temperature/lm75.c" 3 4
          1
# 76 "./src/main/drivers/temperature/lm75.c"
              ;
}
