...
static 
# 41 "./src/main/drivers/pitotmeter_adc.c" 3 4
      _Bool 
# 41 "./src/main/drivers/pitotmeter_adc.c"
           adcPitotStart(pitotDev_t *pitot)
{
    (void)(pitot);
    return 
# 44 "./src/main/drivers/pitotmeter_adc.c" 3 4
          1
# 44 "./src/main/drivers/pitotmeter_adc.c"
              ;
}

static 
# 47 "./src/main/drivers/pitotmeter_adc.c" 3 4
      _Bool 
# 47 "./src/main/drivers/pitotmeter_adc.c"
           adcPitotRead(pitotDev_t *pitot)
{
    (void)(pitot);
    return 
# 50 "./src/main/drivers/pitotmeter_adc.c" 3 4
          1
# 50 "./src/main/drivers/pitotmeter_adc.c"
              ;
}
...
# 65 "./src/main/drivers/pitotmeter_adc.c" 3 4
_Bool 
# 65 "./src/main/drivers/pitotmeter_adc.c"
    adcPitotDetect(pitotDev_t *pitot)
{
    pitot->delay = 10000;
