...
static 
# 74 "./src/main/drivers/bus.c" 3 4
      _Bool 
# 74 "./src/main/drivers/bus.c"
           busDevInit_I2C(busDevice_t * dev, const busDeviceDescriptor_t * descriptor)
{
    ...
    return 
# 80 "./src/main/drivers/bus.c" 3 4
          1
# 80 "./src/main/drivers/bus.c"
              ;
}
...
static 
# 85 "./src/main/drivers/bus.c" 3 4
      _Bool 
# 85 "./src/main/drivers/bus.c"
           busDevInit_SPI(busDevice_t * dev, const busDeviceDescriptor_t * descriptor, resourceOwner_e owner)
{
    ...
    if (dev->busdev.spi.csnPin) {
        ...
        return 
# 95 "./src/main/drivers/bus.c" 3 4
              1
# 95 "./src/main/drivers/bus.c"
                  ;
    }

    return 
# 98 "./src/main/drivers/bus.c" 3 4
          0
# 98 "./src/main/drivers/bus.c"
               ;
}
...
void busDeviceDeInit(busDevice_t * dev)
{
    ...
    dev->descriptorPtr = 
# 105 "./src/main/drivers/bus.c" 3 4
                        ((void *)0)
# 105 "./src/main/drivers/bus.c"
                            ;
        ...
        if (hw == descriptor->devHwType && (bus == descriptor->busType || bus == BUSTYPE_ANY) && (tag == descriptor->tag)) {
            ...
            if (dev) {
                switch (descriptor->busType) {
                    ...
                    case BUSTYPE_NONE:
                        return 
# 127 "./src/main/drivers/bus.c" 3 4
                              ((void *)0)
# 127 "./src/main/drivers/bus.c"
                                  ;
                    ...
                    case BUSTYPE_I2C:
                        ...
                        if (!busDevInit_I2C(dev, descriptor)) {
                            busDeviceDeInit(dev);
                            return 
# 133 "./src/main/drivers/bus.c" 3 4
                                  ((void *)0)
# 133 "./src/main/drivers/bus.c"
                                      ;
                        }
                        break;
                    ...
                    case BUSTYPE_SPI:
                        ...
                        if (!busDevInit_SPI(dev, descriptor, owner)) {
                            busDeviceDeInit(dev);
                            return 
# 145 "./src/main/drivers/bus.c" 3 4
                                  ((void *)0)
# 145 "./src/main/drivers/bus.c"
                                      ;
                        }
                        break;
                ...
                return 
# 157 "./src/main/drivers/bus.c" 3 4
                      ((void *)0)
# 157 "./src/main/drivers/bus.c"
                          ;
            }
        }
    }
    ...
    return 
# 162 "./src/main/drivers/bus.c" 3 4
          ((void *)0)
# 162 "./src/main/drivers/bus.c"
              ;
}
...
busDevice_t * busDeviceOpen(busType_e bus, devHardwareType_e hw, uint8_t tag)
{
    ...
    return 
# 177 "./src/main/drivers/bus.c" 3 4
          ((void *)0)
# 177 "./src/main/drivers/bus.c"
              ;
}
...
# 215 "./src/main/drivers/bus.c" 3 4
_Bool 
# 215 "./src/main/drivers/bus.c"
    busTransfer(const busDevice_t * dev, uint8_t * rxBuf, const uint8_t * txBuf, int length)
{
    ...
    return 
# 226 "./src/main/drivers/bus.c" 3 4
          0
# 226 "./src/main/drivers/bus.c"
               ;
}


# 229 "./src/main/drivers/bus.c" 3 4
_Bool 
# 229 "./src/main/drivers/bus.c"
    busTransferMultiple(const busDevice_t * dev, busTransferDescriptor_t * dsc, int count)
{
    ...
    return 
# 242 "./src/main/drivers/bus.c" 3 4
          0
# 242 "./src/main/drivers/bus.c"
               ;
}


# 245 "./src/main/drivers/bus.c" 3 4
_Bool 
# 245 "./src/main/drivers/bus.c"
    busWriteBuf(const busDevice_t * dev, uint8_t reg, const uint8_t * data, uint8_t length)
{
    switch (dev->busType) {
        ...
        default:
            return 
# 268 "./src/main/drivers/bus.c" 3 4
                  0
# 268 "./src/main/drivers/bus.c"
                       ;
    }
}


# 272 "./src/main/drivers/bus.c" 3 4
_Bool 
# 272 "./src/main/drivers/bus.c"
    busWrite(const busDevice_t * dev, uint8_t reg, uint8_t data)
{
    switch (dev->busType) {
        ...
        default:
            return 
# 295 "./src/main/drivers/bus.c" 3 4
                  0
# 295 "./src/main/drivers/bus.c"
                       ;
    }
}


# 299 "./src/main/drivers/bus.c" 3 4
_Bool 
# 299 "./src/main/drivers/bus.c"
    busReadBuf(const busDevice_t * dev, uint8_t reg, uint8_t * data, uint8_t length)
{
    switch (dev->busType) {
        ...
        default:
            return 
# 322 "./src/main/drivers/bus.c" 3 4
                  0
# 322 "./src/main/drivers/bus.c"
                       ;
    }
}


# 326 "./src/main/drivers/bus.c" 3 4
_Bool 
# 326 "./src/main/drivers/bus.c"
    busRead(const busDevice_t * dev, uint8_t reg, uint8_t * data)
{
    switch (dev->busType) {
        ...
        default:
            return 
# 349 "./src/main/drivers/bus.c" 3 4
                  0
# 349 "./src/main/drivers/bus.c"
                       ;
    }
}
...
# 375 "./src/main/drivers/bus.c" 3 4
_Bool 
# 375 "./src/main/drivers/bus.c"
    busIsBusy(const busDevice_t * dev)
{
    switch (dev->busType) {
        case BUSTYPE_SPI:
        ...
        case BUSTYPE_I2C:
            ...
            return 
# 388 "./src/main/drivers/bus.c" 3 4
                  0
# 388 "./src/main/drivers/bus.c"
                       ;

        default:
            return 
# 391 "./src/main/drivers/bus.c" 3 4
                  0
# 391 "./src/main/drivers/bus.c"
                       ;
    }
}
