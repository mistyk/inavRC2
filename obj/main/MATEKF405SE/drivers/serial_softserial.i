...
static void serialInputPortActivate(softSerial_t *softSerial)
{
    ...
    softSerial->rxActive = 
# 133 "./src/main/drivers/serial_softserial.c" 3 4
                          1
# 133 "./src/main/drivers/serial_softserial.c"
                              ;
    softSerial->isSearchingForStartBit = 
# 134 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 134 "./src/main/drivers/serial_softserial.c"
                                            ;
...
static void serialInputPortDeActivate(softSerial_t *softSerial)
{
    ...
    IOConfigGPIOAF(softSerial->rxIO, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)), softSerial->tch->timHw->alternateFunction);
    softSerial->rxActive = 
...
{
    if (softSerial->exTch)
        IOConfigGPIOAF(softSerial->txIO, ((GPIO_Mode_OUT) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), softSerial->exTch->timHw->alternateFunction);
    else
...
{
    if (softSerial->exTch)
        IOConfigGPIOAF(softSerial->txIO, ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)), softSerial->exTch->timHw->alternateFunction);
    else
...
# 224 "./src/main/drivers/serial_softserial.c"
    ...
    if (options & SERIAL_BIDIR) {
        ...
        if (!timerTx || (timerTx->output & TIMER_OUTPUT_N_CHANNEL)) {
            return 
# 235 "./src/main/drivers/serial_softserial.c" 3 4
                  ((void *)0)
# 235 "./src/main/drivers/serial_softserial.c"
                      ;
        }
        ...
        if (!softSerial->tch) {
            return 
# 240 "./src/main/drivers/serial_softserial.c" 3 4
                  ((void *)0)
# 240 "./src/main/drivers/serial_softserial.c"
        ...
        if (mode & MODE_RX) {
            ...
            if (!timerRx || (timerRx->output & TIMER_OUTPUT_N_CHANNEL)) {
                return 
# 250 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 250 "./src/main/drivers/serial_softserial.c"
                          ;
            }
...
# 255 "./src/main/drivers/serial_softserial.c"
        ...
        if (mode & MODE_TX) {
            ...
            if (!tagTx) {
                return 
# 265 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 265 "./src/main/drivers/serial_softserial.c"
                          ;
            }
...
# 306 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 306 "./src/main/drivers/serial_softserial.c"
                                         ;
    ...
    if ((mode & MODE_TX) && softSerial->exTch && softSerial->exTch->timHw->tim != softSerial->tch->timHw->tim) {
        ...
        timerChInitCallbacks(&softSerial->tchCallbacks, softSerial, onSerialRxPinChange, 
# 320 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                        ((void *)0)
# 320 "./src/main/drivers/serial_softserial.c"
                                                                                            );
        timerChInitCallbacks(&softSerial->exTchCallbacks, softSerial, 
# 321 "./src/main/drivers/serial_softserial.c" 3 4
                                                                     ((void *)0)
# 321 "./src/main/drivers/serial_softserial.c"
...
void processTxState(softSerial_t *softSerial)
{
    ...
    if (!softSerial->isTransmittingData) {
        ...
        softSerial->isTransmittingData = 
# 370 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 370 "./src/main/drivers/serial_softserial.c"
                                            ;
    ...
    softSerial->isTransmittingData = 
# 390 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 390 "./src/main/drivers/serial_softserial.c"
                                         ;
}
...
void prepareForNextRxByte(softSerial_t *softSerial)
{
    ...
    softSerial->rxBitIndex = 0;
    softSerial->isSearchingForStartBit = 
# 412 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 412 "./src/main/drivers/serial_softserial.c"
                                            ;
...
# 489 "./src/main/drivers/serial_softserial.c" 3 4
   _Bool 
# 489 "./src/main/drivers/serial_softserial.c"
...
# 523 "./src/main/drivers/serial_softserial.c" 3 4
                                      0
# 523 "./src/main/drivers/serial_softserial.c"
                                           ;
        return;
    }
...
# 615 "./src/main/drivers/serial_softserial.c" 3 4
_Bool 
# 615 "./src/main/drivers/serial_softserial.c"
...
# 628 "./src/main/drivers/serial_softserial.c"
                      ,
    .writeBuf = 
# 629 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)
# 629 "./src/main/drivers/serial_softserial.c"
                   ,
    .beginWrite = 
# 630 "./src/main/drivers/serial_softserial.c" 3 4
                 ((void *)0)
# 630 "./src/main/drivers/serial_softserial.c"
                     ,
    .endWrite = 
# 631 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)
