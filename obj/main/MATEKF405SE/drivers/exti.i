...
void EXTIRelease(IO_t io)
{
    ...
    EXTIEnable(io, 
# 147 "./src/main/drivers/exti.c" 3 4
                  0
# 147 "./src/main/drivers/exti.c"
                       );
    ...
    extiChannelRec_t *rec = &extiChannelRecs[chIdx];
    rec->handler = 
# 158 "./src/main/drivers/exti.c" 3 4
                  ((void *)0)
# 158 "./src/main/drivers/exti.c"
                      ;
}

void EXTIEnable(IO_t io, 
# 161 "./src/main/drivers/exti.c" 3 4
                        _Bool 
# 161 "./src/main/drivers/exti.c"
                             enable)
{
