...
# 1 "./src/main/drivers/timer_impl_stdperiph.c"
# 18 "./src/main/drivers/timer_impl_stdperiph.c"
...
# 24 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 25 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 27 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 29 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 30 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 31 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 32 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 33 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 34 "./src/main/drivers/timer_impl_stdperiph.c" 2
...
# 35 "./src/main/drivers/timer_impl_stdperiph.c" 2

const uint16_t lookupDMASourceTable[4] = { ((uint16_t)0x0200), ((uint16_t)0x0400), ((uint16_t)0x0800), ((uint16_t)0x1000) };
const uint8_t lookupTIMChannelTable[4] = { ((uint16_t)0x0000), ((uint16_t)0x0004), ((uint16_t)0x0008), ((uint16_t)0x000C) };
...
void impl_timerChConfigIC(TCH_t * tch, 
# 123 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
                                      _Bool 
# 123 "./src/main/drivers/timer_impl_stdperiph.c"
                                           polarityRising, unsigned inputFilterTicks)
{
...
{
    const 
# 210 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
         _Bool 
# 210 "./src/main/drivers/timer_impl_stdperiph.c"
              inverted = tch->timHw->output & TIMER_OUTPUT_INVERTED;
    ...
    switch (tch->timHw->channelIndex) {
        case 0:
            ...
            TIM_OC1PreloadConfig(tch->timHw->tim, ((uint16_t)0x0008));
            break;
        case 1:
            TIM_OC2Init(tch->timHw->tim, &TIM_OCInitStructure);
            TIM_OC2PreloadConfig(tch->timHw->tim, ((uint16_t)0x0008));
            break;
        case 2:
            TIM_OC3Init(tch->timHw->tim, &TIM_OCInitStructure);
            TIM_OC3PreloadConfig(tch->timHw->tim, ((uint16_t)0x0008));
            break;
        case 3:
            TIM_OC4Init(tch->timHw->tim, &TIM_OCInitStructure);
            TIM_OC4PreloadConfig(tch->timHw->tim, ((uint16_t)0x0008));
            break;
    }
}
...
volatile timCCR_t * impl_timerCCR(TCH_t * tch)
{
    ...
    return 
# 266 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
          ((void *)0)
# 266 "./src/main/drivers/timer_impl_stdperiph.c"
              ;
}

void impl_timerChCaptureCompareEnable(TCH_t * tch, 
# 269 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
                                                  _Bool 
# 269 "./src/main/drivers/timer_impl_stdperiph.c"
                                                       enable)
{
    TIM_CCxCmd(tch->timHw->tim, lookupTIMChannelTable[tch->timHw->channelIndex], (enable ? ((uint16_t)0x0001) : ((uint16_t)0x0000)));
}
...
# 287 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
_Bool 
# 287 "./src/main/drivers/timer_impl_stdperiph.c"
    impl_timerPWMConfigChannelDMA(TCH_t * tch, void * dmaBuffer, uint32_t dmaBufferSize)
{
    ...
    if (tch->dma == 
# 293 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
                   ((void *)0)
# 293 "./src/main/drivers/timer_impl_stdperiph.c"
                       ) {
        return 
# 294 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
              0
# 294 "./src/main/drivers/timer_impl_stdperiph.c"
                   ;
    }
    ...
    if (tch->dma->owner != OWNER_FREE) {
        return 
# 299 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
              0
# 299 "./src/main/drivers/timer_impl_stdperiph.c"
                   ;
    }
    ...
    TIM_CCxCmd(timer, lookupTIMChannelTable[tch->timHw->channelIndex], ((uint16_t)0x0001));
    TIM_Cmd(timer, ENABLE);

    dmaInit(tch->dma, OWNER_TIMER, 0);
    dmaSetHandler(tch->dma, impl_timerDMA_IRQHandler, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), (uint32_t)tch);
...
# 342 "./src/main/drivers/timer_impl_stdperiph.c"
    DMA_Init(tch->dma->ref, &DMA_InitStructure);
    DMA_ITConfig(tch->dma->ref, ((uint32_t)0x00000010), ENABLE);

    return 
# 345 "./src/main/drivers/timer_impl_stdperiph.c" 3 4
          1
# 345 "./src/main/drivers/timer_impl_stdperiph.c"
              ;
}
...
void impl_timerPWMPrepareDMA(TCH_t * tch, uint32_t dmaBufferSize)
{
    ...
    for ( uint8_t __basepri_save __attribute__((__cleanup__(__basepriRestoreMem))) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        DMA_Cmd(tch->dma->ref, DISABLE);
        TIM_DMACmd(tch->timHw->tim, lookupDMASourceTable[tch->timHw->channelIndex], DISABLE);
        if (tch->dma->flagsShift > 31) tch->dma->dma->HIFCR = (((uint32_t)0x00000020) << (tch->dma->flagsShift - 32)); else tch->dma->dma->LIFCR = (((uint32_t)0x00000020) << tch->dma->flagsShift);
    }
