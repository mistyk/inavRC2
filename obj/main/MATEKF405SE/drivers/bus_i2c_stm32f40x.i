...
# 80 "./src/main/drivers/bus_i2c_stm32f40x.c"
#define I2C3_SCL PA8
...
# 122 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
   _Bool 
# 122 "./src/main/drivers/bus_i2c_stm32f40x.c"
                   initialized;
    i2cState_t state;
    uint32_t timeout;
    ...
    uint8_t addr;
    i2cTransferDirection_t rw;
    uint8_t reg;
    uint32_t len;
    uint8_t *buf;
    
# 132 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
   _Bool 
# 132 "./src/main/drivers/bus_i2c_stm32f40x.c"
                               txnOk;
} i2cBusState_t;
...
static i2cDevice_t i2cHardwareMap[] = {
    { .dev = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), .scl = ((((1) + 1) << 4) | (8)), .sda = ((((1) + 1) << 4) | (9)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00200000))>65535L) + (8*(((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L)) >>8*(((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L)) >>8*(((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L))>255))/2+1))))), .speed = I2C_SPEED_400KHZ },
    { .dev = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5800)), .scl = ((((1) + 1) << 4) | (10)), .sda = ((((1) + 1) << 4) | (11)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00400000))>65535L) + (8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L)) >>8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L)) >>8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255))/2+1))))), .speed = I2C_SPEED_400KHZ },

    { .dev = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5C00)), .scl = ((((0) + 1) << 4) | (8)), .sda = ((((1) + 1) << 4) | (4)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00800000))>65535L) + (8*(((((uint32_t)0x00800000))*1L >>16*((((uint32_t)0x00800000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00800000))*1L >>16*((((uint32_t)0x00800000))>65535L)) >>8*(((((uint32_t)0x00800000))*1L >>16*((((uint32_t)0x00800000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00800000))*1L >>16*((((uint32_t)0x00800000))>65535L)) >>8*(((((uint32_t)0x00800000))*1L >>16*((((uint32_t)0x00800000))>65535L))>255))/2+1))))), .speed = I2C_SPEED_400KHZ }
...
static void i2cStateMachine(i2cBusState_t * i2cBusState, const uint32_t currentTicks)
{
    ...
    switch (i2cBusState->state) {
        ...
        case I2C_STATE_STOPPING:
            ...
            if ((I2Cx->CR1 & ((uint16_t)0x0200)) == 0) {
                i2cBusState->state = I2C_STATE_STOPPED;
            }
            else if (ticks_diff_us(i2cBusState->timeout, currentTicks) >= (10000)) {
        ...
        case I2C_STATE_STARTING:
            I2C_NACKPositionConfig(I2Cx, ((uint16_t)0xF7FF));
        ...
        case I2C_STATE_STARTING_WAIT:
            if (I2C_CheckEvent(I2Cx, ((uint32_t)0x00030001)) != ERROR) {
        ...
        case I2C_STATE_R_ADDR:
            I2C_Send7bitAddress(I2Cx, i2cBusState->addr, ((uint8_t)0x00));
            i2cBusState->state = I2C_STATE_R_ADDR_WAIT;
            i2cBusState->timeout = currentTicks;
            __attribute__ ((fallthrough));

        case I2C_STATE_R_ADDR_WAIT:
            if (I2C_CheckEvent(I2Cx, ((uint32_t)0x00070082)) != ERROR) {
                i2cBusState->state = I2C_STATE_R_REGISTER;
            }
            else if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x10000400)) != RESET) {
        ...
        case I2C_STATE_R_REGISTER_WAIT:
            if (I2C_CheckEvent(I2Cx, ((uint32_t)0x00070084)) != ERROR) {
        ...
        case I2C_STATE_R_RESTART_ADDR:
            I2C_Send7bitAddress(I2Cx, i2cBusState->addr, ((uint8_t)0x01));
            i2cBusState->state = I2C_STATE_R_RESTART_ADDR_WAIT;
            i2cBusState->timeout = currentTicks;
            __attribute__ ((fallthrough));

        case I2C_STATE_R_RESTART_ADDR_WAIT:
            if (I2C_CheckEvent(I2Cx, ((uint32_t)0x00030002)) != ERROR) {
                if (i2cBusState->len == 1) {
                    ...
                    I2C_NACKPositionConfig(I2Cx, ((uint16_t)0x0800));
                    for ( uint8_t __basepri_save __attribute__((__cleanup__(__basepriRestoreMem))) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
                        (void) I2Cx->SR2;
                        I2C_AcknowledgeConfig(I2Cx, DISABLE);
                    }
        ...
        case I2C_STATE_R_TRANSFER_EQ1:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x10000040)) != RESET) {
                *i2cBusState->buf++ = I2C_ReceiveData(I2Cx);
                i2cBusState->len--;


                i2cBusState->txnOk = 
# 320 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                                    1
# 320 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                        ;
                i2cBusState->timeout = currentTicks;
                i2cBusState->state = I2C_STATE_STOPPING;
            }
        ...
        case I2C_STATE_R_TRANSFER_EQ2:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x10000004)) != RESET) {
                for ( uint8_t __basepri_save __attribute__((__cleanup__(__basepriRestoreMem))) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
                    I2C_GenerateSTOP(I2Cx,ENABLE);
                    *i2cBusState->buf++ = I2C_ReceiveData(I2Cx);
                }
                ...
                *i2cBusState->buf++ = I2C_ReceiveData(I2Cx);
                ...
                i2cBusState->txnOk = 
# 340 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                                    1
# 340 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                        ;
                i2cBusState->timeout = currentTicks;
                i2cBusState->state = I2C_STATE_STOPPING;
            }
            ...
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x10000004)) != RESET) {
                if (i2cBusState->len == 3) {
                    ...
                    *i2cBusState->buf++ = I2C_ReceiveData(I2Cx);
                    ...
                    i2cBusState->txnOk = 
# 372 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                                        0
# 372 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                             ;
                    i2cBusState->timeout = currentTicks;
                    i2cBusState->state = I2C_STATE_STOPPING;
                }
        ...
        case I2C_STATE_W_TRANSFER:
            if (i2cBusState->len > 0) {
                ...
                i2cBusState->timeout = currentTicks;
                i2cBusState->txnOk = 
# 444 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                                    1
# 444 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                        ;
                i2cBusState->state = I2C_STATE_STOPPING;
            }
            break;
        ...
        case I2C_STATE_NACK:
            I2C_GenerateSTOP(I2Cx, ENABLE);
            I2C_ClearFlag(I2Cx, ((uint32_t)0x10000400));
            i2cBusState->timeout = currentTicks;
            i2cBusState->state = I2C_STATE_STOPPING;
            break;
    }
...
uint32_t i2cTimeoutUserCallback(void)
{
    i2cErrorCount++;
    return 
# 468 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
          0
# 468 "./src/main/drivers/bus_i2c_stm32f40x.c"
               ;
}
...
void i2cInit(I2CDevice device)
{
    ...
    IOInit(scl, OWNER_I2C, RESOURCE_I2C_SCL, (device + 1));
    IOInit(sda, OWNER_I2C, RESOURCE_I2C_SDA, (device + 1));


    IOConfigGPIOAF(scl, ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_UP) << 5)), ((uint8_t)0x04));
    IOConfigGPIOAF(sda, ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_UP) << 5)), ((uint8_t)0x04));
    ...
    busState[device].initialized = 
# 529 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                                  1
# 529 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                      ;
...
# 546 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
_Bool 
# 546 "./src/main/drivers/bus_i2c_stm32f40x.c"
    i2cWriteBuffer(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t len, const uint8_t * data)
{

    if (!busState[device].initialized)
        return 
# 550 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
              0
# 550 "./src/main/drivers/bus_i2c_stm32f40x.c"
                   ;
    ...
    busState[device].buf = ((uint8_t*)(data));
    busState[device].txnOk = 
# 558 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                            0
# 558 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                 ;
...
# 567 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
_Bool 
# 567 "./src/main/drivers/bus_i2c_stm32f40x.c"
...
# 572 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
_Bool 
# 572 "./src/main/drivers/bus_i2c_stm32f40x.c"
    i2cRead(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t len, uint8_t* buf)
{

    if (!busState[device].initialized)
        return 
# 576 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
              0
# 576 "./src/main/drivers/bus_i2c_stm32f40x.c"
                   ;
    ...
    busState[device].txnOk = 
# 584 "./src/main/drivers/bus_i2c_stm32f40x.c" 3 4
                            0
# 584 "./src/main/drivers/bus_i2c_stm32f40x.c"
                                 ;
    busState[device].state = I2C_STATE_STARTING;
