...
# 58 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 58 "./src/main/drivers/bus_busdev_spi.c"
    spiBusTransfer(const busDevice_t * dev, uint8_t * rxBuf, const uint8_t * txBuf, int length)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
    ...
    spiBusWriteRegister(const busDevice_t * dev, uint8_t reg, uint8_t data)
{
    ...
    return 
# 115 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 115 "./src/main/drivers/bus_busdev_spi.c"
              ;
}


# 118 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 118 "./src/main/drivers/bus_busdev_spi.c"
    spiBusWriteBuffer(const busDevice_t * dev, uint8_t reg, const uint8_t * data, uint8_t length)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
...
# 127 "./src/main/drivers/bus_busdev_spi.c" 3 4
                         ((void *)0)
# 127 "./src/main/drivers/bus_busdev_spi.c"
                             , data, length);
    ...
    return 
# 133 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 133 "./src/main/drivers/bus_busdev_spi.c"
              ;
}


# 136 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 136 "./src/main/drivers/bus_busdev_spi.c"
    spiBusReadBuffer(const busDevice_t * dev, uint8_t reg, uint8_t * data, uint8_t length)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
...
# 145 "./src/main/drivers/bus_busdev_spi.c" 3 4
                               ((void *)0)
# 145 "./src/main/drivers/bus_busdev_spi.c"
                                   , length);
    ...
    return 
# 151 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 151 "./src/main/drivers/bus_busdev_spi.c"
              ;
}


# 154 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 154 "./src/main/drivers/bus_busdev_spi.c"
    spiBusReadRegister(const busDevice_t * dev, uint8_t reg, uint8_t * data)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
    ...
    spiTransferByte(instance, reg);
    spiTransfer(instance, data, 
# 163 "./src/main/drivers/bus_busdev_spi.c" 3 4
                               ((void *)0)
# 163 "./src/main/drivers/bus_busdev_spi.c"
                                   , 1);
    ...
    return 
# 169 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 169 "./src/main/drivers/bus_busdev_spi.c"
              ;
}


# 172 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 172 "./src/main/drivers/bus_busdev_spi.c"
    spiBusIsBusy(const busDevice_t * dev)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
