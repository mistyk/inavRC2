...
# 131 "./src/main/drivers/bus_spi.c"
    ...
    { .dev = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), .nss = 0, .sck = ((((1) + 1) << 4) | (13)), .miso = ((((2) + 1) << 4) | (2)), .mosi = ((((2) + 1) << 4) | (3)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00004000))>65535L) + (8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x05), .leadingEdge = 
# 132 "./src/main/drivers/bus_spi.c" 3 4
                                                                                                                                                                                                    0
# 132 "./src/main/drivers/bus_spi.c"
                                                                                                                                                                                                                     , .divisorMap = spiDivisorMapSlow },
    { .dev = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), .nss = 0, .sck = ((((1) + 1) << 4) | (3)), .miso = ((((1) + 1) << 4) | (4)), .mosi = ((((1) + 1) << 4) | (5)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00008000))>65535L) + (8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L)) >>8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L)) >>8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x06), .leadingEdge = 
...
# 225 "./src/main/drivers/bus_spi.c"
    ...
    case SPIDEV_2:
        ...
        spiInitDevice(device);
        return 
# 232 "./src/main/drivers/bus_spi.c" 3 4
              1
# 232 "./src/main/drivers/bus_spi.c"
                  ;
