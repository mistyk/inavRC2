...
# 129 "./src/main/telemetry/smartport.c" 3 4
                                          ((void *)0)
# 129 "./src/main/telemetry/smartport.c"
                                              ;
...
static 
# 155 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 155 "./src/main/telemetry/smartport.c"
                                                                                                                         ...
                                                                                                                         useChecksum)
{
    ...
    static 
# 162 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 162 "./src/main/telemetry/smartport.c"
               skipUntilStart = 
# 162 "./src/main/telemetry/smartport.c" 3 4
                                1
# 162 "./src/main/telemetry/smartport.c"
                                    ;
    static 
# 163 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 163 "./src/main/telemetry/smartport.c"
               awaitingSensorId = 
# 163 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 163 "./src/main/telemetry/smartport.c"
...
# 164 "./src/main/telemetry/smartport.c"
    ...
    if (c == FSSP_START_STOP) {
        *clearToSend = 
# 168 "./src/main/telemetry/smartport.c" 3 4
                      0
# 168 "./src/main/telemetry/smartport.c"
                           ;
        smartPortRxBytes = 0;
        awaitingSensorId = 
# 170 "./src/main/telemetry/smartport.c" 3 4
                          1
# 170 "./src/main/telemetry/smartport.c"
                              ;
        skipUntilStart = 
...
# 171 "./src/main/telemetry/smartport.c"
        ...
        return 
# 173 "./src/main/telemetry/smartport.c" 3 4
              ((void *)0)
# 173 "./src/main/telemetry/smartport.c"
                  ;
...
# 179 "./src/main/telemetry/smartport.c"
        ...
        if ((c == FSSP_SENSOR_ID1) && checkQueueEmpty()) {
            ...
            *clearToSend = 
# 182 "./src/main/telemetry/smartport.c" 3 4
                          1
# 182 "./src/main/telemetry/smartport.c"
                              ;
            skipUntilStart = 
...
# 187 "./src/main/telemetry/smartport.c"
        ...
        if (c == FSSP_DLE) {
            byteStuffing = 
# 191 "./src/main/telemetry/smartport.c" 3 4
                          1
# 191 "./src/main/telemetry/smartport.c"
                              ;

            return 
# 193 "./src/main/telemetry/smartport.c" 3 4
                  ((void *)0)
# 193 "./src/main/telemetry/smartport.c"
                      ;
        } else if (byteStuffing) {
            c ^= FSSP_DLE_XOR;
            byteStuffing = 
# 196 "./src/main/telemetry/smartport.c" 3 4
                          0
# 196 "./src/main/telemetry/smartport.c"
                               ;
        }
        ...
        if (smartPortRxBytes < sizeof(smartPortPayload_t)) {
            ...
            if (!useChecksum && (smartPortRxBytes == sizeof(smartPortPayload_t))) {
                skipUntilStart = 
# 204 "./src/main/telemetry/smartport.c" 3 4
                                1
# 204 "./src/main/telemetry/smartport.c"
                                    ;
...
void smartPortSendByte(uint8_t c, uint16_t *checksum, serialPort_t *port)
{
    ...
    if (checksum != 
# 232 "./src/main/telemetry/smartport.c" 3 4
                   ((void *)0)
# 232 "./src/main/telemetry/smartport.c"
                       ) {
        *checksum += c;
    }
}
...
# 237 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 237 "./src/main/telemetry/smartport.c"
    smartPortPayloadContainsMSP(const smartPortPayload_t *payload)
{
...
# 249 "./src/main/telemetry/smartport.c" 3 4
                                        ((void *)0)
# 249 "./src/main/telemetry/smartport.c"
                                            , port);
}
...
# 267 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 267 "./src/main/telemetry/smartport.c"
    initSmartPortTelemetry(void)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
        ...
        return 
# 279 "./src/main/telemetry/smartport.c" 3 4
              1
# 279 "./src/main/telemetry/smartport.c"
                  ;
    }

    return 
# 282 "./src/main/telemetry/smartport.c" 3 4
          0
# 282 "./src/main/telemetry/smartport.c"
               ;
}


# 285 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 285 "./src/main/telemetry/smartport.c"
    initSmartPortTelemetryExternal(smartPortWriteFrameFn *smartPortWriteFrameExternal)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
...
# 292 "./src/main/telemetry/smartport.c"
    ...
    return 
# 295 "./src/main/telemetry/smartport.c" 3 4
          0
# 295 "./src/main/telemetry/smartport.c"
               ;
}
...
static void freeSmartPortTelemetryPort(void)
{
    ...
    smartPortSerialPort = 
# 301 "./src/main/telemetry/smartport.c" 3 4
                         ((void *)0)
# 301 "./src/main/telemetry/smartport.c"
                             ;
}
...
# 309 "./src/main/telemetry/smartport.c" 3 4
                                                                                                  ((void *)0)
# 309 "./src/main/telemetry/smartport.c"
                                                                                                      , 
# 309 "./src/main/telemetry/smartport.c" 3 4
                                                                                                        ((void *)0)
# 309 "./src/main/telemetry/smartport.c"
...
# 316 "./src/main/telemetry/smartport.c" 3 4
       _Bool 
# 316 "./src/main/telemetry/smartport.c"
...
static 
# 336 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 336 "./src/main/telemetry/smartport.c"
           smartPortShouldSendGPSData(void)
{




    return feature(FEATURE_GPS) && ((stateFlags & (GPS_FIX)) || !(armingFlags & (WAS_EVER_ARMED)));
}

void processSmartPortTelemetry(smartPortPayload_t *payload, volatile 
# 345 "./src/main/telemetry/smartport.c" 3 4
                                                                    _Bool 
# 345 "./src/main/telemetry/smartport.c"
...
# 360 "./src/main/telemetry/smartport.c" 3 4
   _Bool 
# 360 "./src/main/telemetry/smartport.c"
        doRun = 
# 360 "./src/main/telemetry/smartport.c" 3 4
                1
# 360 "./src/main/telemetry/smartport.c"
    ...
    while (doRun && *clearToSend) {
        ...
        if (requestTimeout) {
            if (millis() >= *requestTimeout) {
                *clearToSend = 
# 365 "./src/main/telemetry/smartport.c" 3 4
                              0
# 365 "./src/main/telemetry/smartport.c"
                                   ;
            ...
            doRun = 
# 370 "./src/main/telemetry/smartport.c" 3 4
                   0
# 370 "./src/main/telemetry/smartport.c"
                        ;
        }
        ...
        if (smartPortMspReplyPending) {
            ...
            *clearToSend = 
# 376 "./src/main/telemetry/smartport.c" 3 4
                          0
# 376 "./src/main/telemetry/smartport.c"
                               ;
        ...
        switch (id) {
            case FSSP_DATAID_VFAS :
                if (isBatteryVoltageConfigured()) {
                    ...
                    *clearToSend = 
# 395 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 395 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_CURRENT :
                if (isAmperageConfigured()) {
                    ...
                    *clearToSend = 
# 401 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 401 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_ALTITUDE :
                if (sensors(SENSOR_BARO)) {
                    smartPortSendPackage(id, getEstimatedActualPosition(Z));
                    *clearToSend = 
# 408 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 408 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_FUEL :
                if (telemetryConfig()->smartportFuelUnit == SMARTPORT_FUEL_UNIT_PERCENT) {
                    smartPortSendPackage(id, calculateBatteryPercentage());
                    *clearToSend = 
...
# 417 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_VARIO :
                if (sensors(SENSOR_BARO)) {
                    smartPortSendPackage(id, lrintf(getEstimatedActualVelocity(Z)));
                    *clearToSend = 
# 426 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 426 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
...
# 431 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_PITCH :
                if (telemetryConfig()->frsky_pitch_roll) {
                    smartPortSendPackage(id, attitude.values.pitch);
                    *clearToSend = 
# 436 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 436 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_ROLL :
                if (telemetryConfig()->frsky_pitch_roll) {
                    smartPortSendPackage(id, attitude.values.roll);
                    *clearToSend = 
# 442 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 442 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_ACCX :
                if (!telemetryConfig()->frsky_pitch_roll) {
                    ...
                    *clearToSend = 
# 448 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 448 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_ACCY :
                if (!telemetryConfig()->frsky_pitch_roll) {
                    ...
                    *clearToSend = 
# 454 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 454 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_ACCZ :
                if (!telemetryConfig()->frsky_pitch_roll) {
                    ...
                    *clearToSend = 
# 460 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 460 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_T1 :
                {
                    ...
                    *clearToSend = 
# 466 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 466 "./src/main/telemetry/smartport.c"
                                       ;
                    break;
                }
            ...
            case FSSP_DATAID_T2 :
                if (smartPortShouldSendGPSData()) {
                    ...
                    *clearToSend = 
# 473 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 473 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_SPEED :
                if (smartPortShouldSendGPSData()) {
                    ...
                    *clearToSend = 
# 482 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 482 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_LATLONG :
                if (smartPortShouldSendGPSData()) {
                    ...
                    smartPortSendPackage(id, tmpui);
                    *clearToSend = 
# 502 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 502 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_HOME_DIST :
                if (smartPortShouldSendGPSData()) {
                     ...
                     *clearToSend = 
# 508 "./src/main/telemetry/smartport.c" 3 4
                                   0
# 508 "./src/main/telemetry/smartport.c"
                                        ;
                }
                break;
            case FSSP_DATAID_GPS_ALT :
                if (smartPortShouldSendGPSData()) {
                    smartPortSendPackage(id, gpsSol.llh.alt);
                    *clearToSend = 
# 514 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 514 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_A4 :
                if (isBatteryVoltageConfigured()) {
                    ...
                    *clearToSend = 
# 521 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 521 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_ASPD :
                ...
                if (sensors(SENSOR_PITOT)) {
                    smartPortSendPackage(id, pitot.airSpeed * 0.194384449f);
                    *clearToSend = 
# 528 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 528 "./src/main/telemetry/smartport.c"
                                       ;
                }
...
static 
# 539 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 539 "./src/main/telemetry/smartport.c"
...
# 547 "./src/main/telemetry/smartport.c" 3 4
       _Bool 
# 547 "./src/main/telemetry/smartport.c"
            clearToSend = 
# 547 "./src/main/telemetry/smartport.c" 3 4
                          0
# 547 "./src/main/telemetry/smartport.c"
                               ;
        smartPortPayload_t *payload = 
# 548 "./src/main/telemetry/smartport.c" 3 4
                                     ((void *)0)
# 548 "./src/main/telemetry/smartport.c"
                                         ;
...
# 552 "./src/main/telemetry/smartport.c" 3 4
                                                                                  1
# 552 "./src/main/telemetry/smartport.c"
                                                                                      );
        }
