...
#define MS4525_I2C_BUS PITOT_I2C_BUS
    ...
    extern const busDeviceDescriptor_t busdev_sdcard_spi_registry; static busDevice_t busdev_sdcard_spi_memory; const busDeviceDescriptor_t busdev_sdcard_spi_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_sdcard_spi_memory, .busType = BUSTYPE_SPI, .devHwType = DEVHW_SDCARD, .flags = DEVFLAGS_USE_MANUAL_DEVICE_SELECT | DEVFLAGS_SPI_MODE_0, .tag = 0, .busdev.spi = { .spiBus = SPIDEV_3, .csnPin = ((((2) + 1) << 4) | (14)) }, .irqPin = 0 }; struct _dummy;
# 262 "./src/main/target/common_hardware.c"
