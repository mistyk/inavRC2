...
# 43 "./src/main/platform.h" 2


#define U_ID_0 (*(uint32_t*)0x1fff7a10)
#define U_ID_1 (*(uint32_t*)0x1fff7a14)
#define U_ID_2 (*(uint32_t*)0x1fff7a18)
# 62 "./src/main/platform.h"
...
# 1 "./src/main/target/MATEKF405SE/target.h" 1
# 18 "./src/main/target/MATEKF405SE/target.h"
...
# 77 "./src/main/build/debug.h" 3 4
                             _Bool 
# 77 "./src/main/build/debug.h"
...
# 22 "./src/main/drivers/pwm_output.h" 2
...
# 38 "./src/main/drivers/pwm_output.h" 3 4
_Bool 
# 38 "./src/main/drivers/pwm_output.h"
...
# 45 "./src/main/drivers/pwm_output.h" 3 4
_Bool 
# 45 "./src/main/drivers/pwm_output.h"
    pwmMotorConfig(const struct timerHardware_s *timerHardware, uint8_t motorIndex, uint16_t motorPwmRate, motorPwmProtocolTypes_e proto, 
# 45 "./src/main/drivers/pwm_output.h" 3 4
                                                                                                                                          _Bool 
# 45 "./src/main/drivers/pwm_output.h"
                                                                                                                                               enableOutput);

# 46 "./src/main/drivers/pwm_output.h" 3 4
_Bool 
# 46 "./src/main/drivers/pwm_output.h"
...
# 46 "./src/main/drivers/pwm_output.h"
                                                                                                                                           enableOutput);
void pwmWriteBeeper(
# 47 "./src/main/drivers/pwm_output.h" 3 4
                   _Bool 
# 47 "./src/main/drivers/pwm_output.h"
                        onoffBeep);
...
#define DEFINE_DMA_CHANNEL(d,s,f) { .tag = DMA_TAG(d, s, 0), .dma = DMA ##d, .ref = DMA ##d ##_Stream ##s, .irqHandlerCallback = NULL, .flagsShift = f, .irqNumber = DMA ##d ##_Stream ##s ##_IRQn, .rcc = RCC_AHB1Periph_DMA ##d, .userParam = 0 }
# 73 "./src/main/drivers/dma.h"
...
# 26 "./src/main/drivers/timer.h" 2
# 1 "./src/main/drivers/timer_def.h" 1
# 18 "./src/main/drivers/timer_def.h"
...
# 1 "./src/main/drivers/timer_def_stm32f4xx.h" 1
# 18 "./src/main/drivers/timer_def_stm32f4xx.h"
...
# 70 "./src/main/drivers/timer_def.h" 2
...
typedef struct TCH_s {
    struct timHardwareContext_s * timCtx;
...
extern timHardwareContext_t * timerCtx[14];
extern const timerDef_t timerDefinitions[14];
...
void timerChConfigIC(TCH_t * tch, 
...
# 193 "./src/main/drivers/timer.h" 3 4
_Bool 
# 193 "./src/main/drivers/timer.h"
    timerPWMConfigChannelDMA(TCH_t * tch, void * dmaBuffer, uint32_t dmaBufferSize);
void timerPWMPrepareDMA(TCH_t * tch, uint32_t dmaBufferSize);
void timerPWMStartDMA(TCH_t * tch);
void timerPWMStopDMA(TCH_t * tch);

# 197 "./src/main/drivers/timer.h" 3 4
_Bool 
# 197 "./src/main/drivers/timer.h"
    timerPWMDMAInProgress(TCH_t * tch);
...
# 78 "./src/main/drivers/bus_spi.h" 3 4
_Bool 
# 78 "./src/main/drivers/bus_spi.h"
    spiInit(SPIDevice device);

# 79 "./src/main/drivers/bus_spi.h" 3 4
_Bool 
# 79 "./src/main/drivers/bus_spi.h"
...
# 82 "./src/main/drivers/bus_spi.h"
    spiTransfer(SPI_TypeDef *instance, uint8_t *rxData, const uint8_t *txData, int len);
...
# 256 "./src/main/drivers/bus.h" 3 4
_Bool 
# 256 "./src/main/drivers/bus.h"
    i2cBusWriteBuffer(const busDevice_t * dev, uint8_t reg, const uint8_t * data, uint8_t length);

# 257 "./src/main/drivers/bus.h" 3 4
_Bool 
# 257 "./src/main/drivers/bus.h"
    i2cBusWriteRegister(const busDevice_t * dev, uint8_t reg, uint8_t data);

# 258 "./src/main/drivers/bus.h" 3 4
_Bool 
# 258 "./src/main/drivers/bus.h"
    i2cBusReadBuffer(const busDevice_t * dev, uint8_t reg, uint8_t * data, uint8_t length);

# 259 "./src/main/drivers/bus.h" 3 4
_Bool 
# 259 "./src/main/drivers/bus.h"
    i2cBusReadRegister(const busDevice_t * dev, uint8_t reg, uint8_t * data);


# 261 "./src/main/drivers/bus.h" 3 4
_Bool 
# 261 "./src/main/drivers/bus.h"
    spiBusIsBusy(const busDevice_t * dev);
void spiBusSetSpeed(const busDevice_t * dev, busSpeed_e speed);

# 263 "./src/main/drivers/bus.h" 3 4
_Bool 
# 263 "./src/main/drivers/bus.h"
    spiBusTransfer(const busDevice_t * dev, uint8_t * rxBuf, const uint8_t * txBuf, int length);

# 264 "./src/main/drivers/bus.h" 3 4
_Bool 
# 264 "./src/main/drivers/bus.h"
    spiBusTransferMultiple(const busDevice_t * dev, busTransferDescriptor_t * dsc, int count);

# 265 "./src/main/drivers/bus.h" 3 4
_Bool 
# 265 "./src/main/drivers/bus.h"
...
# 54 "./src/main/drivers/sensor.h"
            (*sensorTempReadFuncPtr)(struct temperatureDev_s *tempDev, int16_t *temperature);
struct opflowDev_s;
typedef 
# 56 "./src/main/drivers/sensor.h" 3 4
       _Bool 
# 56 "./src/main/drivers/sensor.h"
            (*sensorOpflowInitFuncPtr)(struct opflowDev_s *mag);
typedef 
# 57 "./src/main/drivers/sensor.h" 3 4
       _Bool 
# 57 "./src/main/drivers/sensor.h"
...
# 67 "./src/main/sensors/gyro.h" 3 4
_Bool 
# 67 "./src/main/sensors/gyro.h"
    gyroInit(void);
...
# 76 "./src/main/sensors/gyro.h" 3 4
_Bool 
# 76 "./src/main/sensors/gyro.h"
...
# 87 "./src/main/drivers/io.h" 2


# 88 "./src/main/drivers/io.h" 3 4
_Bool 
# 88 "./src/main/drivers/io.h"
    IORead(IO_t io);
void IOWrite(IO_t io, 
# 89 "./src/main/drivers/io.h" 3 4
                     _Bool 
# 89 "./src/main/drivers/io.h"
                          value);
void IOHi(IO_t io);
void IOLo(IO_t io);
...
# 61 "./src/main/sensors/rangefinder.h" 3 4
_Bool 
# 61 "./src/main/sensors/rangefinder.h"
...
# 142 "./src/main/io/serial.h"
    isSerialPortShared(const serialPortConfig_t *portConfig, uint32_t functionMask, serialPortFunction_e sharedWithFunction);
...
# 180 "./src/main/io/osd.h" 3 4
   _Bool 
# 180 "./src/main/io/osd.h"
           estimations_wind_compensation;
    uint8_t coordinate_digits;

    
# 183 "./src/main/io/osd.h" 3 4
   _Bool 
# 183 "./src/main/io/osd.h"
...
# 201 "./src/main/io/osd.h" 3 4
                      _Bool 
# 201 "./src/main/io/osd.h"
                           *overridden);

# 202 "./src/main/io/osd.h" 3 4
_Bool 
# 202 "./src/main/io/osd.h"
...
# 69 "./src/main/flight/mixer.h" 3 4
   _Bool 
# 69 "./src/main/flight/mixer.h"
        hasFlaps;
...
# 109 "./src/main/flight/mixer.h" 3 4
_Bool 
# 109 "./src/main/flight/mixer.h"
...
# 134 "./src/main/flight/servos.h" 3 4
_Bool 
# 134 "./src/main/flight/servos.h"
...
typedef struct pidProfile_s {
    ...
    float fixedWingItermLimitOnStickPosition;
...
# 132 "./src/main/flight/pid.h" 3 4
_Bool 
# 132 "./src/main/flight/pid.h"
    pidInitFilters(void);
...
# 126 "./src/main/fc/config.h" 3 4
_Bool 
# 126 "./src/main/fc/config.h"
...
# 118 "./src/main/fc/rc_modes.h" 3 4
_Bool 
# 118 "./src/main/fc/rc_modes.h"
...
# 123 "./src/main/fc/rc_modes.h" 3 4
_Bool 
# 123 "./src/main/fc/rc_modes.h"
...
# 126 "./src/main/fc/rc_modes.h" 3 4
_Bool 
# 126 "./src/main/fc/rc_modes.h"
...
# 1 "./obj/main/MATEKF405SE/settings_generated.h" 1
...
# 34 "./src/main/navigation/navigation.h"
extern gpsLocation_t GPS_home;
extern uint16_t GPS_distanceToHome;
extern int16_t GPS_directionToHome;

extern 
# 38 "./src/main/navigation/navigation.h" 3 4
      _Bool 
# 38 "./src/main/navigation/navigation.h"
...
# 196 "./src/main/navigation/navigation.h" 3 4
       _Bool 
# 196 "./src/main/navigation/navigation.h"
...
# 203 "./src/main/navigation/navigation.h" 3 4
   _Bool 
# 203 "./src/main/navigation/navigation.h"
           valid;
    float scale;
    int32_t lat;
    int32_t lon;
...
# 371 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 371 "./src/main/navigation/navigation.h"
    navigationRequiresAngleMode(void);

# 372 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 372 "./src/main/navigation/navigation.h"
    navigationRequiresThrottleTiltCompensation(void);

# 373 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 373 "./src/main/navigation/navigation.h"
...
# 376 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 376 "./src/main/navigation/navigation.h"
    navigationPositionEstimateIsHealthy(void);

# 377 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 377 "./src/main/navigation/navigation.h"
    navIsCalibrationComplete(void);

# 378 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 378 "./src/main/navigation/navigation.h"
...
# 398 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 398 "./src/main/navigation/navigation.h"
...
# 429 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 429 "./src/main/navigation/navigation.h"
    geoConvertGeodeticToLocal(fpVector3_t *pos, const gpsOrigin_t *origin, const gpsLocation_t *llh, geoAltitudeConversionMode_e altConv);



# 432 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 432 "./src/main/navigation/navigation.h"
    geoConvertGeodeticToLocalOrigin(fpVector3_t * pos, const gpsLocation_t *llh, geoAltitudeConversionMode_e altConv);




# 436 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 436 "./src/main/navigation/navigation.h"
    geoConvertLocalToGeodetic(gpsLocation_t *llh, const gpsOrigin_t *origin, const fpVector3_t *pos);
float geoCalculateMagDeclination(const gpsLocation_t * llh);



# 440 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 440 "./src/main/navigation/navigation.h"
    navCalculatePathToDestination(navDestinationPath_t *result, const fpVector3_t * destinationPos);
...
# 448 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 448 "./src/main/navigation/navigation.h"
    navigationIsControllingThrottle(void);

# 449 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 449 "./src/main/navigation/navigation.h"
    isFixedWingAutoThrottleManuallyIncreased(void);

# 450 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 450 "./src/main/navigation/navigation.h"
    navigationIsFlyingAutonomousMode(void);

# 451 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 451 "./src/main/navigation/navigation.h"
    navigationIsExecutingAnEmergencyLanding(void);




# 455 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 455 "./src/main/navigation/navigation.h"
    navigationRTHAllowsLanding(void);


# 457 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 457 "./src/main/navigation/navigation.h"
    isNavLaunchEnabled(void);

# 458 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 458 "./src/main/navigation/navigation.h"
    isFixedWingLaunchDetected(void);

# 459 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 459 "./src/main/navigation/navigation.h"
...
# 467 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 467 "./src/main/navigation/navigation.h"
    isAdjustingPosition(void);

# 468 "./src/main/navigation/navigation.h" 3 4
_Bool 
# 468 "./src/main/navigation/navigation.h"
...
const featureConfig_t pgResetTemplate_featureConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .enabledFeatures = (FEATURE_TX_PROF_SEL | FEATURE_OSD | FEATURE_CURRENT_METER | FEATURE_VBAT | FEATURE_TELEMETRY | FEATURE_SOFTSERIAL) | (FEATURE_TX_PROF_SEL) }
...
const systemConfig_t pgResetTemplate_systemConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .current_profile_index = 0, .current_battery_profile_index = 0, .debug_mode = DEBUG_NONE, .i2c_speed = I2C_SPEED_400KHZ, .cpuUnderclock = 0, .throttle_tilt_compensation_strength = 0, .pwmRxInputFilteringMode = INPUT_FILTERING_DISABLED, .name = { 0 } }
# 120 "./src/main/fc/config.c"
 ;
...
# 208 "./src/main/fc/config.c"
    ...
    if (featureConfigured(FEATURE_SOFTSERIAL) && featureConfigured(FEATURE_LED_STRIP)) {
        ...
        if (ledTimerHardware != 
# 221 "./src/main/fc/config.c" 3 4
                               ((void *)0)
# 221 "./src/main/fc/config.c"
                                   ) {
            
# 222 "./src/main/fc/config.c" 3 4
           _Bool 
# 222 "./src/main/fc/config.c"
                sameTimerUsed = 
# 222 "./src/main/fc/config.c" 3 4
                                0
# 222 "./src/main/fc/config.c"
            ...
            const timerHardware_t *ss1TimerHardware = timerGetByTag(((((0) + 1) << 4) | (2)), TIM_USE_ANY);
            if (ss1TimerHardware != 
# 226 "./src/main/fc/config.c" 3 4
                                   ((void *)0) 
# 226 "./src/main/fc/config.c"
                                        && ss1TimerHardware->tim == ledTimerHardware->tim) {
                sameTimerUsed = 
# 227 "./src/main/fc/config.c" 3 4
                               1
# 227 "./src/main/fc/config.c"
                                   ;
            }
...
# 301 "./src/main/fc/config.c"
    ...
    if (settingsValidate(
# 311 "./src/main/fc/config.c" 3 4
                        ((void *)0)
# 311 "./src/main/fc/config.c"
                            )) {
...
# 434 "./src/main/fc/config.c" 3 4
_Bool 
# 434 "./src/main/fc/config.c"
    setConfigProfile(uint8_t profileIndex)
{
    
# 436 "./src/main/fc/config.c" 3 4
   _Bool 
# 436 "./src/main/fc/config.c"
        ret = 
# 436 "./src/main/fc/config.c" 3 4
              1
# 436 "./src/main/fc/config.c"
    ...
    if (systemConfig()->current_profile_index == profileIndex) {
        ret = 
# 438 "./src/main/fc/config.c" 3 4
              0
# 438 "./src/main/fc/config.c"
                   ;
    }
    if (profileIndex >= 3) {
        profileIndex = 0;
...
# 465 "./src/main/fc/config.c" 3 4
_Bool 
# 465 "./src/main/fc/config.c"
    setConfigBatteryProfile(uint8_t profileIndex)
{
    
# 467 "./src/main/fc/config.c" 3 4
   _Bool 
# 467 "./src/main/fc/config.c"
        ret = 
# 467 "./src/main/fc/config.c" 3 4
              1
# 467 "./src/main/fc/config.c"
    ...
    if (systemConfig()->current_battery_profile_index == profileIndex) {
        ret = 
# 469 "./src/main/fc/config.c" 3 4
              0
# 469 "./src/main/fc/config.c"
                   ;
    }
    if (profileIndex >= 3) {
        profileIndex = 0;
