...
typedef enum {
    ...
    BOOT_EVENT_HARDWARE_IO_CONFLICT = 22,
...
# 72 "./src/main/drivers/serial_uart.h" 3 4
_Bool 
# 72 "./src/main/drivers/serial_uart.h"
...
#define VTX_RTC6705_BOOT_DELAY 350
...
# 67 "./src/main/drivers/vtx_common.h"
...
# 121 "./src/main/drivers/vtx_common.h" 3 4
   _Bool 
# 121 "./src/main/drivers/vtx_common.h"
...
# 136 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 136 "./src/main/drivers/vtx_common.h"
...
# 1 "./src/main/io/vtx_ffpv24g.h" 1
# 25 "./src/main/io/vtx_ffpv24g.h"
       
# 37 "./src/main/io/vtx_ffpv24g.h"
...
extern const char * const ffpvBandNames[2 + 1];
extern const char * const ffpvChannelNames[8 + 1];
extern const char * const ffpvPowerNames[4 + 1];
extern const uint16_t ffpvFrequencyTable[2][8];


# 47 "./src/main/io/vtx_ffpv24g.h" 3 4
_Bool 
# 47 "./src/main/io/vtx_ffpv24g.h"
    vtxFuriousFPVInit(void);
...
# 41 "./src/main/drivers/pinio.h" 3 4
                        _Bool 
# 41 "./src/main/drivers/pinio.h"
                             on);
# 28 "./src/main/io/piniobox.h" 2
...
{
    ledSet(1, 
# 158 "./src/main/fc/fc_init.c" 3 4
   1
# 158 "./src/main/fc/fc_init.c"
   );
    ledSet(0, 
# 159 "./src/main/fc/fc_init.c" 3 4
   0
# 159 "./src/main/fc/fc_init.c"
    ...
    for (uint8_t i = 0; i < 10; i++) {
        ...
        if (!(getPreferredBeeperOffMask() & (1 << (BEEPER_SYSTEM_INIT - 1))))
            systemBeep(
# 165 "./src/main/fc/fc_init.c" 3 4
           1
# 165 "./src/main/fc/fc_init.c"
           );
        delay(25);
        systemBeep(
# 167 "./src/main/fc/fc_init.c" 3 4
       0
# 167 "./src/main/fc/fc_init.c"
       );
    }
    ledSet(0, 
# 169 "./src/main/fc/fc_init.c" 3 4
   0
# 169 "./src/main/fc/fc_init.c"
   );
    ledSet(1, 
# 170 "./src/main/fc/fc_init.c" 3 4
   0
# 170 "./src/main/fc/fc_init.c"
   );
}
...
# 198 "./src/main/fc/fc_init.c"
    ...
    ledInit(
# 222 "./src/main/fc/fc_init.c" 3 4
           0
# 222 "./src/main/fc/fc_init.c"
                );
...
# 292 "./src/main/fc/fc_init.c"
    ...
    if (motorConfig()->motorPwmProtocol == PWM_TYPE_BRUSHED) {
        pwm_params.useFastPwm = 
# 326 "./src/main/fc/fc_init.c" 3 4
                               0
# 326 "./src/main/fc/fc_init.c"
                                    ;
    ...
    if (feature(FEATURE_PWM_SERVO_DRIVER)) {
        pwm_params.useServoOutputs = 
# 342 "./src/main/fc/fc_init.c" 3 4
                                    0
# 342 "./src/main/fc/fc_init.c"
                                         ;
    }
    ...
    if (!pwm_params.useFastPwm)
        motorControlEnable = 
# 352 "./src/main/fc/fc_init.c" 3 4
                            1
# 352 "./src/main/fc/fc_init.c"
                                ;
    ...
    beeperDevConfig_t beeperDevConfig = {
        ...
        .isOD = 
# 361 "./src/main/fc/fc_init.c" 3 4
               0
# 361 "./src/main/fc/fc_init.c"
                    ,
        .isInverted = 
# 362 "./src/main/fc/fc_init.c" 3 4
                     1
...
# 380 "./src/main/fc/fc_init.c"
    ...
    spiInit(SPIDEV_3);
# 428 "./src/main/fc/fc_init.c"
            i2cInit(I2CDEV_1);
# 438 "./src/main/fc/fc_init.c"
            i2cInit(I2CDEV_2);
...
# 496 "./src/main/fc/fc_init.c"
    ...
    if (!isMPUSoftReset()) {
        ...
        ledSet(1, 
# 502 "./src/main/fc/fc_init.c" 3 4
       1
# 502 "./src/main/fc/fc_init.c"
       );
        ledSet(0, 
# 503 "./src/main/fc/fc_init.c" 3 4
       0
# 503 "./src/main/fc/fc_init.c"
       );
        ...
        ledSet(0, 
# 511 "./src/main/fc/fc_init.c" 3 4
       0
# 511 "./src/main/fc/fc_init.c"
       );
        ledSet(1, 
# 512 "./src/main/fc/fc_init.c" 3 4
       0
# 512 "./src/main/fc/fc_init.c"
       );
    }
...
# 623 "./src/main/fc/fc_init.c"
    ...
    latchActiveFeatures();
    motorControlEnable = 
# 676 "./src/main/fc/fc_init.c" 3 4
                        1
# 676 "./src/main/fc/fc_init.c"
                            ;
    fcTasksInit();
