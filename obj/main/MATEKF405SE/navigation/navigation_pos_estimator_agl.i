...
# 55 "./src/main/navigation/navigation_pos_estimator_agl.c" 3 4
   _Bool 
# 55 "./src/main/navigation/navigation_pos_estimator_agl.c"
        surfaceMeasurementWithinRange = 
# 55 "./src/main/navigation/navigation_pos_estimator_agl.c" 3 4
                                        0
# 55 "./src/main/navigation/navigation_pos_estimator_agl.c"
                                             ;
    ...
    if (newSurfaceAlt >= 0) {
        if (newSurfaceAlt <= positionEstimationConfig()->max_surface_altitude) {
            ...
            surfaceMeasurementWithinRange = 
# 62 "./src/main/navigation/navigation_pos_estimator_agl.c" 3 4
                                           1
# 62 "./src/main/navigation/navigation_pos_estimator_agl.c"
                                               ;
    ...
    if (surfaceDtUs > ((400) * 1000)) {
        posEstimator.surface.reliability = 0.0f;
    }
    else {
        const float surfaceDt = ((surfaceDtUs) * 1e-6f);
        const float relAlpha = surfaceDt / (surfaceDt + (0.47802f));
...
# 96 "./src/main/navigation/navigation_pos_estimator_agl.c" 3 4
       _Bool 
# 96 "./src/main/navigation/navigation_pos_estimator_agl.c"
        ...
        switch (posEstimator.est.aglQual) {
            case SURFACE_QUAL_LOW:
                if (posEstimator.surface.reliability >= (0.75f)) {
                    ...
                    resetSurfaceEstimate = 
# 101 "./src/main/navigation/navigation_pos_estimator_agl.c" 3 4
                                          1
# 101 "./src/main/navigation/navigation_pos_estimator_agl.c"
                                              ;
                }
        ...
        posEstimator.est.aglAlt += posEstimator.imu.accelNEU.z * ((ctx->dt)*(ctx->dt)) / 2.0f;
