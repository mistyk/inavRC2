...
# 88 "./src/main/navigation/navigation.c" 3 4
0 
# 88 "./src/main/navigation/navigation.c"
} }
# 169 "./src/main/navigation/navigation.c"
 ;
...
# 190 "./src/main/navigation/navigation.c" 3 4
                                   _Bool 
# 190 "./src/main/navigation/navigation.c"
                                        useTerrainFollowing);
...
# 203 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 203 "./src/main/navigation/navigation.c"
...
# 848 "./src/main/navigation/navigation.c" 3 4
                           0
# 848 "./src/main/navigation/navigation.c"
                                );
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_ALTHOLD_INITIALIZE(navigationFSMState_t previousState)
{
    ...
    const 
# 858 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 858 "./src/main/navigation/navigation.c"
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_POSHOLD_3D_INITIALIZE(navigationFSMState_t previousState)
{
    const navigationFSMStateFlags_t prevFlags = navGetStateFlags(previousState);
    const 
# 891 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 891 "./src/main/navigation/navigation.c"
              terrainFollowingToggled = (posControl.flags.isTerrainFollowEnabled != navTerrainFollowingRequested());
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_RTH_INITIALIZE(navigationFSMState_t previousState)
{
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE) || navConfig()->general.flags.rth_climb_ignore_emerg) {
        ...
        if ((prevFlags & NAV_CTL_ALT) == 0 || posControl.flags.isTerrainFollowEnabled) {
            ...
            resetAltitudeController(
# 1063 "./src/main/navigation/navigation.c" 3 4
                                   0
# 1063 "./src/main/navigation/navigation.c"
                                        );
            setupAltitudeController();
        }
...
# 1174 "./src/main/navigation/navigation.c" 3 4
                                                            1
# 1174 "./src/main/navigation/navigation.c"
                                                                )) {
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_WAYPOINT_INITIALIZE(navigationFSMState_t previousState)
{
    ...
    if (posControl.waypointCount == 0 || !posControl.waypointListValid) {
        ...
        resetAltitudeController(
# 1336 "./src/main/navigation/navigation.c" 3 4
                               0
# 1336 "./src/main/navigation/navigation.c"
                                    );
        setupAltitudeController();
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_WAYPOINT_IN_PROGRESS(navigationFSMState_t previousState)
{
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE) && (posControl.flags.estHeadingStatus >= EST_USABLE)) {
        const 
# 1368 "./src/main/navigation/navigation.c" 3 4
             _Bool 
# 1368 "./src/main/navigation/navigation.c"
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_WAYPOINT_NEXT(navigationFSMState_t previousState)
{
    ...
    const 
# 1432 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 1432 "./src/main/navigation/navigation.c"
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_EMERGENCY_LANDING_INITIALIZE(navigationFSMState_t previousState)
{
    ...
    resetAltitudeController(
# 1470 "./src/main/navigation/navigation.c" 3 4
                           0
# 1470 "./src/main/navigation/navigation.c"
                                );
...
float navPidApply3(pidController_t *pid, const float setpoint, const float measurement, const float dt, const float outMin, const float outMax, const pidControllerFlags_e pidFlags, const float gainScaler)
{
    ...
    if (pid->reset) {
        ...
        pid->reset = 
# 1642 "./src/main/navigation/navigation.c" 3 4
                    0
# 1642 "./src/main/navigation/navigation.c"
                         ;
    }
...
{
    pid->reset = 
# 1696 "./src/main/navigation/navigation.c" 3 4
                1
# 1696 "./src/main/navigation/navigation.c"
                    ;
...
# 1737 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 1737 "./src/main/navigation/navigation.c"
    isThrustFacingDownwards(void)
{
    ...
    checkForPositionSensorTimeout(void)
{
    if (navConfig()->general.pos_failure_timeout) {
        if ((posControl.flags.estPosStatus == EST_NONE) && ((millis() - posControl.lastValidPositionTimeMs) > (1000 * navConfig()->general.pos_failure_timeout))) {
            return 
# 1750 "./src/main/navigation/navigation.c" 3 4
                  1
# 1750 "./src/main/navigation/navigation.c"
                      ;
        }
        else {
            return 
...
# 1753 "./src/main/navigation/navigation.c"
        ...
        return 
# 1758 "./src/main/navigation/navigation.c" 3 4
              0
# 1758 "./src/main/navigation/navigation.c"
                   ;
    }
}
...
void updateActualHorizontalPositionAndVelocity(
# 1765 "./src/main/navigation/navigation.c" 3 4
                                              _Bool 
# 1765 "./src/main/navigation/navigation.c"
                                                   estPosValid, 
# 1765 "./src/main/navigation/navigation.c" 3 4
                                                                _Bool 
# 1765 "./src/main/navigation/navigation.c"
...
void updateActualAltitudeAndClimbRate(
# 1811 "./src/main/navigation/navigation.c" 3 4
                                     _Bool 
# 1811 "./src/main/navigation/navigation.c"
                                          estimateValid, float newAltitude, float newVelocity, float surfaceDistance, float surfaceVelocity, navigationEstimateStatus_e surfaceStatus)
{
...
void updateActualHeading(
# 1864 "./src/main/navigation/navigation.c" 3 4
                        _Bool 
# 1864 "./src/main/navigation/navigation.c"
                             headingValid, int32_t newHeading)
{
...
# 1948 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 1948 "./src/main/navigation/navigation.c"
    navCalculatePathToDestination(navDestinationPath_t *result, const fpVector3_t * destinationPos)
{
    if (posControl.flags.estPosStatus == EST_NONE ||
        ...
        return 
# 1953 "./src/main/navigation/navigation.c" 3 4
              0
# 1953 "./src/main/navigation/navigation.c"
                   ;
    }
...
# 1968 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 1968 "./src/main/navigation/navigation.c"
    isWaypointMissed(const navWaypointPosition_t * waypoint)
{
...
# 1976 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 1976 "./src/main/navigation/navigation.c"
    isWaypointReached(const navWaypointPosition_t * waypoint, const 
# 1976 "./src/main/navigation/navigation.c" 3 4
                                                                    _Bool 
# 1976 "./src/main/navigation/navigation.c"
...
# 2041 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2041 "./src/main/navigation/navigation.c"
    validateRTHSanityChecker(void)
{
    const timeMs_t currentTimeMs = millis();
    
# 2044 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 2044 "./src/main/navigation/navigation.c"
        checkResult = 
# 2044 "./src/main/navigation/navigation.c" 3 4
                      1
# 2044 "./src/main/navigation/navigation.c"
    ...
    if (navConfig()->general.rth_abort_threshold == 0) {
        return 
# 2048 "./src/main/navigation/navigation.c" 3 4
              1
# 2048 "./src/main/navigation/navigation.c"
                  ;
    }
    ...
    if ((currentTimeMs - posControl.rthSanityChecker.lastCheckTime) > 100) {
        ...
        if (currentDistanceToHome < posControl.rthSanityChecker.minimalDistanceToHome) {
            ...
            checkResult = 
# 2060 "./src/main/navigation/navigation.c" 3 4
                         0
# 2060 "./src/main/navigation/navigation.c"
                              ;
        }
...
# 2141 "./src/main/navigation/navigation.c" 3 4
           _Bool 
# 2141 "./src/main/navigation/navigation.c"
            ...
            switch ((nav_reset_type_e)positionEstimationConfig()->reset_home_type) {
                ...
                case NAV_RESET_ON_EACH_ARM:
                    setHome = 
# 2149 "./src/main/navigation/navigation.c" 3 4
                             1
# 2149 "./src/main/navigation/navigation.c"
                                 ;
                    break;
            }
            if (setHome) {
        ...
        static 
# 2158 "./src/main/navigation/navigation.c" 3 4
              _Bool 
# 2158 "./src/main/navigation/navigation.c"
                   isHomeResetAllowed = 
# 2158 "./src/main/navigation/navigation.c" 3 4
                                        0
# 2158 "./src/main/navigation/navigation.c"
        ...
        if (IS_RC_MODE_ACTIVE(BOXHOMERESET)) {
            if (isHomeResetAllowed && !(flightModeFlags & (FAILSAFE_MODE)) && !(flightModeFlags & (NAV_RTH_MODE)) && !(flightModeFlags & (NAV_WP_MODE)) && (posControl.flags.estPosStatus >= EST_USABLE)) {
                ...
                isHomeResetAllowed = 
# 2165 "./src/main/navigation/navigation.c" 3 4
                                    0
# 2165 "./src/main/navigation/navigation.c"
                                         ;
            }
        }
        else {
            isHomeResetAllowed = 
# 2169 "./src/main/navigation/navigation.c" 3 4
                                1
# 2169 "./src/main/navigation/navigation.c"
                                    ;
        }
...
# 2322 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2322 "./src/main/navigation/navigation.c"
    isLandingDetected(void)
{
    
# 2324 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 2324 "./src/main/navigation/navigation.c"
        landingDetected;
...
static void resetAltitudeController(
# 2373 "./src/main/navigation/navigation.c" 3 4
                                   _Bool 
# 2373 "./src/main/navigation/navigation.c"
                                        useTerrainFollowing)
{
...
static 
# 2396 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2396 "./src/main/navigation/navigation.c"
...
static 
# 2419 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2419 "./src/main/navigation/navigation.c"
...
# 2443 "./src/main/navigation/navigation.c" 3 4
                                    _Bool 
# 2443 "./src/main/navigation/navigation.c"
                                         isAdjusting)
{
    ...
    const 
# 2450 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 2450 "./src/main/navigation/navigation.c"
              brakingEntryAllowed =
...
static 
# 2528 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2528 "./src/main/navigation/navigation.c"
           adjustPositionFromRCInput(void)
{
    
# 2530 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 2530 "./src/main/navigation/navigation.c"
        retValue;
...
# 2553 "./src/main/navigation/navigation.c" 3 4
                                                   0
# 2553 "./src/main/navigation/navigation.c"
                                                        ;
    posControl.flags.isGCSAssistedNavigationEnabled = 
# 2554 "./src/main/navigation/navigation.c" 3 4
                                                     0
# 2554 "./src/main/navigation/navigation.c"
                                                          ;
}
...
# 2650 "./src/main/navigation/navigation.c" 3 4
                                      0
# 2650 "./src/main/navigation/navigation.c"
                                           ;
    }
}
...
# 2665 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2665 "./src/main/navigation/navigation.c"
    loadNonVolatileWaypointList(void)
{
    if ((armingFlags & (ARMED)))
        return 
# 2668 "./src/main/navigation/navigation.c" 3 4
              0
# 2668 "./src/main/navigation/navigation.c"
                   ;
    ...
    saveNonVolatileWaypointList(void)
{
    if ((armingFlags & (ARMED)) || !posControl.waypointListValid)
        return 
# 2692 "./src/main/navigation/navigation.c" 3 4
              0
# 2692 "./src/main/navigation/navigation.c"
                   ;
    ...
    return 
# 2700 "./src/main/navigation/navigation.c" 3 4
          1
# 2700 "./src/main/navigation/navigation.c"
              ;
}
...
# 2737 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2737 "./src/main/navigation/navigation.c"
    isApproachingLastWaypoint(void)
{
    if (navGetStateFlags(posControl.navState) & NAV_AUTO_WP) {
        if (posControl.waypointCount == 0) {
            ...
            return 
# 2742 "./src/main/navigation/navigation.c" 3 4
                  1
# 2742 "./src/main/navigation/navigation.c"
                      ;
        }
...
# 2746 "./src/main/navigation/navigation.c"
            ...
            return 
# 2749 "./src/main/navigation/navigation.c" 3 4
                  0
# 2749 "./src/main/navigation/navigation.c"
                       ;
        }
    }
        ...
        return 
# 2754 "./src/main/navigation/navigation.c" 3 4
              1
# 2754 "./src/main/navigation/navigation.c"
                  ;
    }
    else {
        return 
# 2757 "./src/main/navigation/navigation.c" 3 4
              0
# 2757 "./src/main/navigation/navigation.c"
                   ;
    }
}
...
# 2794 "./src/main/navigation/navigation.c" 3 4
                                              0
# 2794 "./src/main/navigation/navigation.c"
                                                   ;
    }
...
# 2801 "./src/main/navigation/navigation.c"
    ...
    if ((navStateFlags & NAV_RC_YAW) && (!(flightModeFlags & (FAILSAFE_MODE)))) {
        ...
        posControl.flags.isAdjustingHeading = 
# 2808 "./src/main/navigation/navigation.c" 3 4
                                             0
# 2808 "./src/main/navigation/navigation.c"
                                                  ;
    }
}
...
# 2836 "./src/main/navigation/navigation.c" 3 4
                                             0
# 2836 "./src/main/navigation/navigation.c"
                                                  ;
        return;
    }
...
static 
# 2886 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2886 "./src/main/navigation/navigation.c"
...
static 
# 2891 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2891 "./src/main/navigation/navigation.c"
...
static 
# 2896 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2896 "./src/main/navigation/navigation.c"
...
# 2914 "./src/main/navigation/navigation.c" 3 4
       _Bool 
# 2914 "./src/main/navigation/navigation.c"
        ...
        if ((stateFlags & (FIXED_WING))) {
            if (isNavLaunchEnabled()) {
                if (canActivateLaunchMode) {
                    canActivateLaunchMode = 
# 2922 "./src/main/navigation/navigation.c" 3 4
                                           0
# 2922 "./src/main/navigation/navigation.c"
                                                ;
        ...
        if (posControl.flags.forcedRTHActivated || (IS_RC_MODE_ACTIVE(BOXNAVRTH) && canActivatePosHold && canActivateNavigation && canActivateAltHold && (stateFlags & (GPS_FIX_HOME)))) {
            ...
            canActivateWaypoint = 
# 2946 "./src/main/navigation/navigation.c" 3 4
                                 0
# 2946 "./src/main/navigation/navigation.c"
                                      ;
        ...
        if (IS_RC_MODE_ACTIVE(BOXMANUAL)) {
            canActivateWaypoint = 
# 2952 "./src/main/navigation/navigation.c" 3 4
                                 0
# 2952 "./src/main/navigation/navigation.c"
                                      ;
            return NAV_FSM_EVENT_SWITCH_TO_IDLE;
        }
        ...
        if (IS_RC_MODE_ACTIVE(BOXNAVWP)) {
            ...
            canActivateWaypoint = 
# 2962 "./src/main/navigation/navigation.c" 3 4
                                 1
# 2962 "./src/main/navigation/navigation.c"
                                     ;
        }
        ...
        canActivateWaypoint = 
# 2988 "./src/main/navigation/navigation.c" 3 4
                             0
# 2988 "./src/main/navigation/navigation.c"
                                  ;
...
# 3000 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3000 "./src/main/navigation/navigation.c"
    navigationRequiresThrottleTiltCompensation(void)
{
...
# 3008 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3008 "./src/main/navigation/navigation.c"
    navigationRequiresAngleMode(void)
{
...
# 3017 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3017 "./src/main/navigation/navigation.c"
    navigationRequiresTurnAssistance(void)
{
    const navigationFSMStateFlags_t currentState = navGetStateFlags(posControl.navState);
    if ((stateFlags & (FIXED_WING))) {
        ...
        return 
# 3025 "./src/main/navigation/navigation.c" 3 4
              0
# 3025 "./src/main/navigation/navigation.c"
                   ;
    }
}
...
# 3053 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3053 "./src/main/navigation/navigation.c"
    navigationTerrainFollowingEnabled(void)
{
...
{
    const 
# 3060 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 3060 "./src/main/navigation/navigation.c"
    ...
    const 
# 3061 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 3061 "./src/main/navigation/navigation.c"
...
# 3062 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 3062 "./src/main/navigation/navigation.c"
        shouldBlockArming = 
# 3062 "./src/main/navigation/navigation.c" 3 4
                            0
# 3062 "./src/main/navigation/navigation.c"
    ...
    if (!navConfig()->general.flags.extra_arming_safety)
        return 
# 3065 "./src/main/navigation/navigation.c" 3 4
              0
# 3065 "./src/main/navigation/navigation.c"
                   ;
    ...
    if ((isUsingNavigationModes() || failsafeMayRequireNavigationMode()) && !((posControl.flags.estPosStatus >= EST_USABLE) && (stateFlags & (GPS_FIX_HOME)))) {
        shouldBlockArming = 
# 3069 "./src/main/navigation/navigation.c" 3 4
                           1
# 3069 "./src/main/navigation/navigation.c"
                               ;
    }
...
# 3082 "./src/main/navigation/navigation.c"
        ...
        if (navWpMissionStartTooFar) {
            shouldBlockArming = 
# 3085 "./src/main/navigation/navigation.c" 3 4
                               1
# 3085 "./src/main/navigation/navigation.c"
                                   ;
        }
    }
...
# 3093 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3093 "./src/main/navigation/navigation.c"
    navigationPositionEstimateIsHealthy(void)
{
...
{
    static 
# 3103 "./src/main/navigation/navigation.c" 3 4
          _Bool 
# 3103 "./src/main/navigation/navigation.c"
               posReadyBeepDone = 
# 3103 "./src/main/navigation/navigation.c" 3 4
                                  0
# 3103 "./src/main/navigation/navigation.c"
    ...
    if (navigationPositionEstimateIsHealthy() && !posReadyBeepDone) {
        ...
        posReadyBeepDone = 
# 3108 "./src/main/navigation/navigation.c" 3 4
                          1
# 3108 "./src/main/navigation/navigation.c"
                              ;
    }
}
...
void updateFlightBehaviorModifiers(void)
{
    if (posControl.flags.isGCSAssistedNavigationEnabled && !IS_RC_MODE_ACTIVE(BOXGCSNAV)) {
        posControl.flags.isGCSAssistedNavigationReset = 
# 3115 "./src/main/navigation/navigation.c" 3 4
                                                       1
# 3115 "./src/main/navigation/navigation.c"
                                                           ;
    }
...
void navigationInit(void)
{
    ...
    posControl.activeWaypointIndex = 0;
    posControl.waypointListValid = 
# 3219 "./src/main/navigation/navigation.c" 3 4
                                  0
# 3219 "./src/main/navigation/navigation.c"
                                       ;
...
{
    posControl.flags.forcedRTHActivated = 
# 3249 "./src/main/navigation/navigation.c" 3 4
                                         1
# 3249 "./src/main/navigation/navigation.c"
                                             ;
    navProcessFSMEvents(selectNavEventFromBoxModeInput());
}
...
void abortForcedRTH(void)
{
    ...
    posControl.flags.forcedRTHActivated = 
# 3257 "./src/main/navigation/navigation.c" 3 4
                                         0
# 3257 "./src/main/navigation/navigation.c"
                                              ;
...
# 3277 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3277 "./src/main/navigation/navigation.c"
    navigationIsExecutingAnEmergencyLanding(void)
{
...
# 3282 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3282 "./src/main/navigation/navigation.c"
    navigationIsControllingThrottle(void)
{
...
# 3288 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3288 "./src/main/navigation/navigation.c"
    navigationIsFlyingAutonomousMode(void)
{
    navigationFSMStateFlags_t stateFlags = navGetCurrentStateFlags();
...
# 3294 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3294 "./src/main/navigation/navigation.c"
    navigationRTHAllowsLanding(void)
{
...
# 3301 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3301 "./src/main/navigation/navigation.c"
    isNavLaunchEnabled(void)
{
...
# 3320 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3320 "./src/main/navigation/navigation.c"
    isAdjustingPosition(void) {
    return posControl.flags.isAdjustingPosition;
}


# 3324 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3324 "./src/main/navigation/navigation.c"
    isAdjustingHeading(void) {
