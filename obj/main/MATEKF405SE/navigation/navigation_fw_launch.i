...
{
    const float swingVelocity = (fabsf(imuMeasuredRotationBF.z) > ((100) * (3.14159265358979323846f / 180.0f))) ? (imuMeasuredAccelBF.y / imuMeasuredRotationBF.z) : 0;
    const 
...
{
    launchState.launchFinished = 
# 127 "./src/main/navigation/navigation_fw_launch.c" 3 4
                                1
# 127 "./src/main/navigation/navigation_fw_launch.c"
                                    ;
}
...
static void applyFixedWingLaunchIdleLogic(void)
{
    ...
    else
    {
        ...
        {
            const float timeSinceMotorStartMs = ( __extension__ ({ __typeof__(millis() - timeThrottleRaisedMs) _left0 = (millis() - timeThrottleRaisedMs); __typeof__(1500) _right1 = (1500); _left0 < _right1 ? _left0 : _right1; }));
...
static inline 
# 163 "./src/main/navigation/navigation_fw_launch.c" 3 4
             _Bool 
# 163 "./src/main/navigation/navigation_fw_launch.c"
...
static inline 
# 172 "./src/main/navigation/navigation_fw_launch.c" 3 4
             _Bool 
# 172 "./src/main/navigation/navigation_fw_launch.c"
...
static inline 
# 177 "./src/main/navigation/navigation_fw_launch.c" 3 4
             _Bool 
# 177 "./src/main/navigation/navigation_fw_launch.c"
...
# 187 "./src/main/navigation/navigation_fw_launch.c" 3 4
       _Bool 
# 187 "./src/main/navigation/navigation_fw_launch.c"
...
# 187 "./src/main/navigation/navigation_fw_launch.c"
        ...
        if (launchState.motorControlAllowed) {
            ...
            if (timeElapsedSinceLaunchMs >= navConfig()->fw.launch_motor_timer) {
                ...
                applyLaunchIdleLogic = 
# 198 "./src/main/navigation/navigation_fw_launch.c" 3 4
                                      0
# 198 "./src/main/navigation/navigation_fw_launch.c"
                                           ;
                ...
                if (navConfig()->fw.launch_motor_spinup_time > 0) {
                    ...
                    const uint16_t minIdleThrottle = ( __extension__ ({ __typeof__(motorConfig()->minthrottle) _left2 = (motorConfig()->minthrottle); __typeof__(navConfig()->fw.launch_idle_throttle) _right3 = (navConfig()->fw.launch_idle_throttle); _left2 > _right3 ? _left2 : _right3; }));
                    rcCommand[THROTTLE] = scaleRangef(timeSinceMotorStartMs,
