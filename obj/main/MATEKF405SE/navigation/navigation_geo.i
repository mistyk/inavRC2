...
# 150 "./src/main/navigation/navigation_geo.c" 3 4
_Bool 
# 150 "./src/main/navigation/navigation_geo.c"
    geoConvertGeodeticToLocal(fpVector3_t *pos, const gpsOrigin_t *origin, const gpsLocation_t *llh, geoAltitudeConversionMode_e altConv)
{
    if (origin->valid) {
        ...
        return 
# 162 "./src/main/navigation/navigation_geo.c" 3 4
              1
# 162 "./src/main/navigation/navigation_geo.c"
                  ;
    }
    ...
    pos->z = 0.0f;
    return 
# 168 "./src/main/navigation/navigation_geo.c" 3 4
          0
# 168 "./src/main/navigation/navigation_geo.c"
               ;
}


# 171 "./src/main/navigation/navigation_geo.c" 3 4
_Bool 
# 171 "./src/main/navigation/navigation_geo.c"
    geoConvertGeodeticToLocalOrigin(fpVector3_t * pos, const gpsLocation_t *llh, geoAltitudeConversionMode_e altConv)
{
...
# 176 "./src/main/navigation/navigation_geo.c" 3 4
_Bool 
# 176 "./src/main/navigation/navigation_geo.c"
    geoConvertLocalToGeodetic(gpsLocation_t *llh, const gpsOrigin_t * origin, const fpVector3_t *pos)
{
    float scaleLonDown;
