...
# 47 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 51 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 53 "./src/main/navigation/navigation_fixedwing.c" 2
...
# 62 "./src/main/navigation/navigation_fixedwing.c"
                                         ;
static 
# 63 "./src/main/navigation/navigation_fixedwing.c" 3 4
      _Bool 
# 63 "./src/main/navigation/navigation_fixedwing.c"
...
static 
# 65 "./src/main/navigation/navigation_fixedwing.c" 3 4
      _Bool 
# 65 "./src/main/navigation/navigation_fixedwing.c"
...
void resetFixedWingAltitudeController(void)
{
    ...
    isPitchAdjustmentValid = 
# 82 "./src/main/navigation/navigation_fixedwing.c" 3 4
                            0
# 82 "./src/main/navigation/navigation_fixedwing.c"
                                 ;
    throttleSpeedAdjustment = 0;
}


# 86 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 86 "./src/main/navigation/navigation_fixedwing.c"
    adjustFixedWingAltitudeFromRCInput(void)
{
    ...
    if (rcAdjustment) {
        ...
        return 
# 94 "./src/main/navigation/navigation_fixedwing.c" 3 4
              1
# 94 "./src/main/navigation/navigation_fixedwing.c"
                  ;
    }
    else {
        ...
        return 
# 101 "./src/main/navigation/navigation_fixedwing.c" 3 4
              0
# 101 "./src/main/navigation/navigation_fixedwing.c"
                   ;
    }
}
...
void applyFixedWingAltitudeAndThrottleController(timeUs_t currentTimeUs)
{
    ...
    if ((posControl.flags.estAltStatus >= EST_USABLE)) {
        ...
        isPitchAdjustmentValid = 
# 179 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                1
# 179 "./src/main/navigation/navigation_fixedwing.c"
                                    ;
    }
    else {

        isPitchAdjustmentValid = 
# 183 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                0
# 183 "./src/main/navigation/navigation_fixedwing.c"
                                     ;
    }
}
...
# 190 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 190 "./src/main/navigation/navigation_fixedwing.c"
    adjustFixedWingHeadingFromRCInput(void)
{
    if (( __extension__ ({ __typeof__(rcCommand[YAW]) _abs0 = (rcCommand[YAW]); _abs0 < 0 ? -_abs0 : _abs0; })) > rcControlsConfig()->pos_hold_deadband) {
        return 
# 193 "./src/main/navigation/navigation_fixedwing.c" 3 4
              1
# 193 "./src/main/navigation/navigation_fixedwing.c"
                  ;
    }

    return 
# 196 "./src/main/navigation/navigation_fixedwing.c" 3 4
          0
# 196 "./src/main/navigation/navigation_fixedwing.c"
               ;
}
...
void resetFixedWingPositionController(void)
{
    ...
    isRollAdjustmentValid = 
# 213 "./src/main/navigation/navigation_fixedwing.c" 3 4
                           0
# 213 "./src/main/navigation/navigation_fixedwing.c"
                                ;
...
static int8_t loiterDirection(void) {
    ...
    if (pidProfile()->loiter_direction == NAV_LOITER_YAW) {
        if (rcCommand[YAW] < -250) loiterDirYaw = 1;
        if (rcCommand[YAW] > 250) loiterDirYaw = -1;
        dir = loiterDirYaw;
    }
...
# 242 "./src/main/navigation/navigation_fixedwing.c" 3 4
   _Bool 
# 242 "./src/main/navigation/navigation_fixedwing.c"
    ...
    if (needToCalculateCircularLoiter) {
        ...
        float loiterAngle = atan2_approx(-posErrorY, -posErrorX) + ((loiterDirection() * 45.0f) * (3.14159265358979323846f / 180.0f));
...
# 279 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 279 "./src/main/navigation/navigation_fixedwing.c"
    adjustFixedWingPositionFromRCInput(void)
{
    int16_t rcRollAdjustment = applyDeadband(rcCommand[ROLL], rcControlsConfig()->pos_hold_deadband);
...
# 289 "./src/main/navigation/navigation_fixedwing.c"
               errorIsDecreasing;
    static 
# 290 "./src/main/navigation/navigation_fixedwing.c" 3 4
          _Bool 
# 290 "./src/main/navigation/navigation_fixedwing.c"
               forceTurnDirection = 
# 290 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                    0
# 290 "./src/main/navigation/navigation_fixedwing.c"
    ...
    if (( __extension__ ({ __typeof__(navHeadingError) _abs3 = (navHeadingError); _abs3 < 0 ? -_abs3 : _abs3; })) > 17000) {
        forceTurnDirection = 
# 301 "./src/main/navigation/navigation_fixedwing.c" 3 4
                            1
# 301 "./src/main/navigation/navigation_fixedwing.c"
                                ;
    }
    else if (( __extension__ ({ __typeof__(navHeadingError) _abs4 = (navHeadingError); _abs4 < 0 ? -_abs4 : _abs4; })) < 9000 && forceTurnDirection) {
        forceTurnDirection = 
# 304 "./src/main/navigation/navigation_fixedwing.c" 3 4
                            0
# 304 "./src/main/navigation/navigation_fixedwing.c"
                                 ;
    }


    if (forceTurnDirection) {
        navHeadingError = loiterDirection() * ( __extension__ ({ __typeof__(navHeadingError) _abs5 = (navHeadingError); _abs5 < 0 ? -_abs5 : _abs5; }));
    }
...
void applyFixedWingPositionController(timeUs_t currentTimeUs)
{
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE)) {
        ...
        isRollAdjustmentValid = 
# 378 "./src/main/navigation/navigation_fixedwing.c" 3 4
                               1
# 378 "./src/main/navigation/navigation_fixedwing.c"
                                   ;
    }
    else {

        isRollAdjustmentValid = 
# 382 "./src/main/navigation/navigation_fixedwing.c" 3 4
                               0
# 382 "./src/main/navigation/navigation_fixedwing.c"
                                    ;
    }
}
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE)) {
        ...
        if (posControl.flags.horizontalPositionDataNew) {
            ...
            if (deltaMicrosPositionUpdate < (1000000 / (5))) {
                ...
                if (fabsf(posControl.actualState.velXY - 700.0f) > 50) {
    ...
    if (isPitchAdjustmentValid && (navStateFlags & NAV_CTL_ALT)) {
        ...
        if (navConfig()->fw.allow_manual_thr_increase && !(flightModeFlags & (FAILSAFE_MODE))) {
            if (rcCommand[THROTTLE] < 1000 + (2000 - 1000) * 0.95)
                correctedThrottleValue += ( __extension__ ({ __typeof__(0) _left8 = (0); __typeof__(rcCommand[THROTTLE] - navConfig()->fw.cruise_throttle) _right9 = (rcCommand[THROTTLE] - navConfig()->fw.cruise_throttle); _left8 > _right9 ? _left8 : _right9; }));
            else
            ...
            isAutoThrottleManuallyIncreased = 
# 479 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                             0
# 479 "./src/main/navigation/navigation_fixedwing.c"
                                                  ;
        }
...
# 508 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 508 "./src/main/navigation/navigation_fixedwing.c"
...
# 523 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 523 "./src/main/navigation/navigation_fixedwing.c"
    isFixedWingLandingDetected(void)
{
    ...
    return 
# 528 "./src/main/navigation/navigation_fixedwing.c" 3 4
          0
# 528 "./src/main/navigation/navigation_fixedwing.c"
               ;
}
...
void applyFixedWingNavigationController(navigationFSMStateFlags_t navStateFlags, timeUs_t currentTimeUs)
{
    if (navStateFlags & NAV_CTL_LAUNCH) {
        ...
        if (
# 570 "./src/main/navigation/navigation_fixedwing.c" 3 4
           1
# 570 "./src/main/navigation/navigation_fixedwing.c"
               ) {
