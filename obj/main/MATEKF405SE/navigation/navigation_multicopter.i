    ...
    adjustMulticopterPositionFromRCInput(int16_t rcPitchAdjustment, int16_t rcRollAdjustment)
{
    if (rcPitchAdjustment || rcRollAdjustment) {
        ...
        return 
# 296 "./src/main/navigation/navigation_multicopter.c" 3 4
              1
# 296 "./src/main/navigation/navigation_multicopter.c"
                  ;
    }
    else {
        ...
        return 
# 306 "./src/main/navigation/navigation_multicopter.c" 3 4
              0
# 306 "./src/main/navigation/navigation_multicopter.c"
                   ;
    }
}
...
static void updatePositionAccelController_MC(timeDelta_t deltaMicros, float maxAccelLimit)
{
    ...
    float maxAccelChange = ((deltaMicros) * 1e-6f) * 1700.0f;
    ...
    float newAccelX = navPidApply2(&posControl.pids.vel[X], posControl.desiredState.vel.x, navGetCurrentActualPositionAndVelocity()->vel.x, ((deltaMicros) * 1e-6f), accelLimitXMin, accelLimitXMax, 0);
    float newAccelY = navPidApply2(&posControl.pids.vel[Y], posControl.desiredState.vel.y, navGetCurrentActualPositionAndVelocity()->vel.y, ((deltaMicros) * 1e-6f), accelLimitYMin, accelLimitYMax, 0);

    int32_t maxBankAngle = ((navConfig()->mc.max_bank_angle) * 10);
    uint8_t accCutoffFrequency = 2;



    if ((stateFlags & (NAV_CRUISE_BRAKING_BOOST)) && navConfig()->mc.braking_boost_factor > 0)
    {
        ...
        maxBankAngle = ((navConfig()->mc.braking_bank_angle) * 10);
        accCutoffFrequency = 2 * 2;
    }
    ...
    const float accelN = pt1FilterApply4(&mcPosControllerAccFilterStateX, newAccelX, accCutoffFrequency, ((deltaMicros) * 1e-6f));
    const float accelE = pt1FilterApply4(&mcPosControllerAccFilterStateY, newAccelY, accCutoffFrequency, ((deltaMicros) * 1e-6f));
...
# 469 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 469 "./src/main/navigation/navigation_multicopter.c"
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE)) {
        ...
        bypassPositionController = 
# 509 "./src/main/navigation/navigation_multicopter.c" 3 4
                                  1
# 509 "./src/main/navigation/navigation_multicopter.c"
                                      ;
    }
...
# 536 "./src/main/navigation/navigation_multicopter.c" 3 4
_Bool 
# 536 "./src/main/navigation/navigation_multicopter.c"
    isMulticopterLandingDetected(void)
{
...
# 546 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 546 "./src/main/navigation/navigation_multicopter.c"
        verticalMovement = fabsf(navGetCurrentActualPositionAndVelocity()->vel.z) > 25.0f;


    
# 549 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 549 "./src/main/navigation/navigation_multicopter.c"
...
# 555 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 555 "./src/main/navigation/navigation_multicopter.c"
        isAtMinimalThrust = 
# 555 "./src/main/navigation/navigation_multicopter.c" 3 4
                            0
# 555 "./src/main/navigation/navigation_multicopter.c"
...
# 562 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 562 "./src/main/navigation/navigation_multicopter.c"
    ...
    if (!possibleLandingDetected) {
        ...
        return 
# 578 "./src/main/navigation/navigation_multicopter.c" 3 4
              0
# 578 "./src/main/navigation/navigation_multicopter.c"
                   ;
    }
    else {
        return ((currentTimeUs - landingTimer) > (navConfig()->mc.auto_disarm_delay * 1000)) ? 
# 581 "./src/main/navigation/navigation_multicopter.c" 3 4
                                                                                              1 
# 581 "./src/main/navigation/navigation_multicopter.c"
                                                                                                   : 
# 581 "./src/main/navigation/navigation_multicopter.c" 3 4
                                                                                                     0
# 581 "./src/main/navigation/navigation_multicopter.c"
