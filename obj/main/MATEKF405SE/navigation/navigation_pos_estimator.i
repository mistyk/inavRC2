...
# 27 "./src/main/navigation/navigation_pos_estimator_private.h"
...
# 28 "./src/main/navigation/navigation_pos_estimator_private.h" 2
...
# 64 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
   _Bool 
# 64 "./src/main/navigation/navigation_pos_estimator_private.h"
               glitchDetected;
    
# 65 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
   _Bool 
# 65 "./src/main/navigation/navigation_pos_estimator_private.h"
               glitchRecovery;
...
# 100 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
   _Bool 
# 100 "./src/main/navigation/navigation_pos_estimator_private.h"
               isValid;
    float quality;
    float flowRate[2];
    float bodyRate[2];
...
# 128 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
   _Bool 
# 128 "./src/main/navigation/navigation_pos_estimator_private.h"
...
# 144 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
   _Bool 
# 144 "./src/main/navigation/navigation_pos_estimator_private.h"
               isBaroGroundValid;
...
extern 
# 180 "./src/main/navigation/navigation_pos_estimator_private.h" 3 4
      _Bool 
# 180 "./src/main/navigation/navigation_pos_estimator_private.h"
...
void updatePositionEstimator_BaroTopic(timeUs_t currentTimeUs)
{
    ...
    if (sensors(SENSOR_BARO) && baroIsCalibrationComplete()) {
        ...
        if (baroDtUs <= ((200) * 1000)) {
            pt1FilterApply3(&posEstimator.baro.avgFilter, posEstimator.baro.alt, ((baroDtUs) * 1e-6f));
        }
    }
    else {
...
# 356 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     0
# 356 "./src/main/navigation/navigation_pos_estimator.c"
                                                          ;
    }
    else {
        fpVector3_t accelBF;
        ...
        if (!(armingFlags & (ARMED)) && !posEstimator.imu.gravityCalibrationComplete) {
            ...
            if (fabsf(gravityOffsetError) < positionEstimationConfig()->gravity_calibration_tolerance) {
                if ((millis() - gravityCalibrationTimeout) > 250) {
                    posEstimator.imu.gravityCalibrationComplete = 
# 387 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                                 1
# 387 "./src/main/navigation/navigation_pos_estimator.c"
                                                                     ;
                }
            }
            else {
...
static 
# 419 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 419 "./src/main/navigation/navigation_pos_estimator.c"
           navIsAccelerationUsable(void)
{
    return 
# 421 "./src/main/navigation/navigation_pos_estimator.c" 3 4
          1
# 421 "./src/main/navigation/navigation_pos_estimator.c"
              ;
}
...
static uint32_t calculateCurrentValidityFlags(timeUs_t currentTimeUs)
{
    ...
    if (sensors(SENSOR_RANGEFINDER) && ((currentTimeUs - posEstimator.surface.lastUpdateTime) <= ((400) * 1000))) {
...
static 
# 500 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 500 "./src/main/navigation/navigation_pos_estimator.c"
...
# 507 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                  1
# 507 "./src/main/navigation/navigation_pos_estimator.c"
                                                      ;
            ...
            if (posEstimator.est.vel.z > 15) {
                if (currentTimeUs > posEstimator.state.baroGroundTimeout) {
                    posEstimator.state.isBaroGroundValid = 
# 513 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                          0
# 513 "./src/main/navigation/navigation_pos_estimator.c"
                                                               ;
                }
            }
            else {
...
# 522 "./src/main/navigation/navigation_pos_estimator.c" 3 4
       _Bool 
# 522 "./src/main/navigation/navigation_pos_estimator.c"
        ...
        return 
# 546 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              1
# 546 "./src/main/navigation/navigation_pos_estimator.c"
                  ;
    }
        ...
        if (!(ctx->newFlags & EST_Z_VALID)) {
            ...
            ctx->newEPV = updateEPE(posEstimator.est.epv, ctx->dt, ( __extension__ ({ __typeof__(posEstimator.gps.epv) _left1 = (posEstimator.gps.epv); __typeof__(gpsAltResudual) _right2 = (gpsAltResudual); _left1 > _right2 ? _left1 : _right2; })), positionEstimationConfig()->w_z_gps_p);
        ...
        return 
# 569 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              1
# 569 "./src/main/navigation/navigation_pos_estimator.c"
                  ;
    }
           ...
           estimationCalculateCorrection_XY_GPS(estimationContext_t * ctx)
{
    if (ctx->newFlags & EST_GPS_XY_VALID) {
        ...
        if (!(ctx->newFlags & EST_XY_VALID)) {
            ...
            ctx->newEPH = updateEPE(posEstimator.est.eph, ctx->dt, ( __extension__ ({ __typeof__(posEstimator.gps.eph) _left3 = (posEstimator.gps.eph); __typeof__(gpsPosResidualMag) _right4 = (gpsPosResidualMag); _left3 > _right4 ? _left3 : _right4; })), w_xy_gps_p);
        }

        return 
# 619 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              1
# 619 "./src/main/navigation/navigation_pos_estimator.c"
                  ;
    }
...
static void updateEstimatedTopic(timeUs_t currentTimeUs)
{
    ...
    const 
# 660 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 660 "./src/main/navigation/navigation_pos_estimator.c"
              estZCorrectOk =
    ...
    const 
# 665 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 665 "./src/main/navigation/navigation_pos_estimator.c"
              estXYCorrectOk =
...
# 721 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     1
# 721 "./src/main/navigation/navigation_pos_estimator.c"
                                                         , 
# 721 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                           1
# 721 "./src/main/navigation/navigation_pos_estimator.c"
...
# 730 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                            1
# 730 "./src/main/navigation/navigation_pos_estimator.c"
...
# 744 "./src/main/navigation/navigation_pos_estimator.c" 3 4
_Bool 
# 744 "./src/main/navigation/navigation_pos_estimator.c"
    isGPSGlitchDetected(void)
{
...
void initializePositionEstimator(void)
{
    ...
    posEstimator.imu.gravityCalibrationComplete = 
# 771 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                 0
# 771 "./src/main/navigation/navigation_pos_estimator.c"
                                                      ;
    ...
    pt1FilterInit(&posEstimator.baro.avgFilter, 1.0f, 0.0f);
    pt1FilterInit(&posEstimator.surface.avgFilter, 1.0f, 0.0f);
}
...
# 808 "./src/main/navigation/navigation_pos_estimator.c" 3 4
_Bool 
# 808 "./src/main/navigation/navigation_pos_estimator.c"
    navIsCalibrationComplete(void)
{
