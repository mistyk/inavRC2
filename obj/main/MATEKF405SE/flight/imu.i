...
static 
# 239 "./src/main/flight/imu.c" 3 4
      _Bool 
# 239 "./src/main/flight/imu.c"
           imuValidateQuaternion(const fpQuaternion_t * quat)
{
    const float check = fabs(quat->q0) + fabs(quat->q1) + fabs(quat->q2) + fabs(quat->q3);

    if (!
# 243 "./src/main/flight/imu.c" 3
        (__builtin_isnan (
# 243 "./src/main/flight/imu.c"
        check
# 243 "./src/main/flight/imu.c" 3
        )) 
# 243 "./src/main/flight/imu.c"
...
# 243 "./src/main/flight/imu.c"
        ...
        return 
# 244 "./src/main/flight/imu.c" 3 4
              1
# 244 "./src/main/flight/imu.c"
                  ;
    }
...
# 249 "./src/main/flight/imu.c"
    ...
    return 
# 252 "./src/main/flight/imu.c" 3 4
          0
# 252 "./src/main/flight/imu.c"
               ;
}
...
static void imuCheckAndResetOrientationQuaternion(const fpQuaternion_t * quat, const fpVector3_t * accBF)
{
    ...
    if (imuValidateQuaternion(quat)) {
        ...
        debugTracePrintf(
# 269 "./src/main/flight/imu.c" 3 4
       0
# 269 "./src/main/flight/imu.c"
       , "AHRS orientation quaternion error. Reset to last known good value");
        ...
        debugTracePrintf(
# 275 "./src/main/flight/imu.c" 3 4
       0
# 275 "./src/main/flight/imu.c"
...
# 285 "./src/main/flight/imu.c" 3 4
                                                                                                                           _Bool 
# 285 "./src/main/flight/imu.c"
           ...
           imuCanUseAccelerometerForCorrection(void)
{
    ...
    return (nearness > 25) ? 
# 475 "./src/main/flight/imu.c" 3 4
                                             0 
# 475 "./src/main/flight/imu.c"
                                                   : 
# 475 "./src/main/flight/imu.c" 3 4
                                                     1
# 475 "./src/main/flight/imu.c"
...
# 481 "./src/main/flight/imu.c"
    ...
    const 
# 486 "./src/main/flight/imu.c" 3 4
         _Bool 
# 486 "./src/main/flight/imu.c"
              useAcc = imuCanUseAccelerometerForCorrection();

    float courseOverGround = 0;
    
# 489 "./src/main/flight/imu.c" 3 4
   _Bool 
# 489 "./src/main/flight/imu.c"
        useMag = 
# 489 "./src/main/flight/imu.c" 3 4
                 0
# 489 "./src/main/flight/imu.c"
...
# 490 "./src/main/flight/imu.c" 3 4
   _Bool 
# 490 "./src/main/flight/imu.c"
        useCOG = 
# 490 "./src/main/flight/imu.c" 3 4
                 0
# 490 "./src/main/flight/imu.c"
...
# 515 "./src/main/flight/imu.c"
            ...
            useMag = 
# 519 "./src/main/flight/imu.c" 3 4
                    1
# 519 "./src/main/flight/imu.c"
                        ;
            gpsHeadingInitialized = 
# 520 "./src/main/flight/imu.c" 3 4
                                   1
# 520 "./src/main/flight/imu.c"
                                       ;
        }
    }
    else {
        ...
        if (canUseMAG) {
            useMag = 
# 526 "./src/main/flight/imu.c" 3 4
                    1
# 526 "./src/main/flight/imu.c"
                        ;
        }
    }
...
# 539 "./src/main/flight/imu.c" 3 4
                                                          ((void *)0)
# 539 "./src/main/flight/imu.c"
                                                              ,
                            useMag ? &measuredMagBF : 
# 540 "./src/main/flight/imu.c" 3 4
                                                     ((void *)0)
# 540 "./src/main/flight/imu.c"
                                                         ,
                            useCOG, courseOverGround);

    imuUpdateEulerAngles();
}
# 564 "./src/main/flight/imu.c"
void imuUpdateAccelerometer(void)
{
...
# 624 "./src/main/flight/imu.c" 3 4
_Bool 
# 624 "./src/main/flight/imu.c"
    isImuReady(void)
{
...
# 629 "./src/main/flight/imu.c" 3 4
_Bool 
# 629 "./src/main/flight/imu.c"
    isImuHeadingValid(void)
{
