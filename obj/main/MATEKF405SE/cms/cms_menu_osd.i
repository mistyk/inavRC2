...
# 147 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ...
    ((OSD_Entry){ "3D SPEED", OME_Submenu, {.itemId = OSD_3D_SPEED}, &cmsx_menuOsdElementActions, 0 }),
    ((OSD_Entry){ "PLUS CODE", OME_Submenu, {.itemId = OSD_PLUS_CODE}, &cmsx_menuOsdElementActions, 0 }),
    ...
    ((OSD_Entry){ "ALTITUDE MSL", OME_Submenu, {.itemId = OSD_ALTITUDE_MSL}, &cmsx_menuOsdElementActions, 0 }),
    ...
    ((OSD_Entry){ "TEMPERATURE", OME_Submenu, {.itemId = OSD_TEMPERATURE}, &cmsx_menuOsdElementActions, 0 }),

    ((OSD_Entry){ "BACK", OME_Back, {.func = 
# 250 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 250 "./src/main/cms/cms_menu_osd.c"
   }, 
# 250 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 250 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ((OSD_Entry){ 
# 251 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 251 "./src/main/cms/cms_menu_osd.c"
   , OME_END, {.func = 
# 251 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 251 "./src/main/cms/cms_menu_osd.c"
...
const CMS_Menu menuOsdElements = {
    ...
    .onGlobalExit = 
# 268 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 268 "./src/main/cms/cms_menu_osd.c"
                       ,
...
# 277 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 277 "./src/main/cms/cms_menu_osd.c"
   }, 
# 277 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 277 "./src/main/cms/cms_menu_osd.c"
...
# 279 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 279 "./src/main/cms/cms_menu_osd.c"
   }, &menuOsdElements, 0 }),

    ((OSD_Entry){ "ALTERNATE 1", OME_Submenu, {.func = 
# 281 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 281 "./src/main/cms/cms_menu_osd.c"
   }, &menuOsdElements, 0 }),
...
const CMS_Menu cmsx_menuOsdLayout = {
    ...
    .onEnter = 
# 299 "./src/main/cms/cms_menu_osd.c" 3 4
              ((void *)0)
# 299 "./src/main/cms/cms_menu_osd.c"
                  ,
    .onExit = 
# 300 "./src/main/cms/cms_menu_osd.c" 3 4
             ((void *)0)
# 300 "./src/main/cms/cms_menu_osd.c"
                 ,
    .onGlobalExit = 
...
# 326 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 333, 0 }, 0 },
    { "COORD. DIGITS", OME_Setting, 
# 327 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 327 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 334, 0 }, 0 },
    { "CROSSHAIRS STYLE", OME_Setting, 
# 328 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 328 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 329, 0 }, 0 },
    { "LEFT SCROLL", OME_Setting, 
# 329 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 329 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 330, 0 }, 0 },
    { "RIGHT SCROLL", OME_Setting, 
# 330 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 330 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 331, 0 }, 0 },
    { "SCROLL ARROWS", OME_Setting, 
# 331 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 331 "./src/main/cms/cms_menu_osd.c"
   , &(const OSD_SETTING_t){ 332, 0 }, 0 },


    ((OSD_Entry){ "BACK", OME_Back, {.func = 
# 334 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 334 "./src/main/cms/cms_menu_osd.c"
   }, 
# 334 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 334 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ((OSD_Entry){ 
# 335 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 335 "./src/main/cms/cms_menu_osd.c"
   , OME_END, {.func = 
# 335 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 335 "./src/main/cms/cms_menu_osd.c"
...
static const CMS_Menu cmsx_menuOsdSettings = {
    ...
    .onEnter = 
# 343 "./src/main/cms/cms_menu_osd.c" 3 4
              ((void *)0)
# 343 "./src/main/cms/cms_menu_osd.c"
                  ,
    .onExit = 
# 344 "./src/main/cms/cms_menu_osd.c" 3 4
             ((void *)0)
# 344 "./src/main/cms/cms_menu_osd.c"
                 ,
    .onGlobalExit = 
# 345 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 345 "./src/main/cms/cms_menu_osd.c"
                       ,
...
# 352 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 352 "./src/main/cms/cms_menu_osd.c"
...
# 354 "./src/main/cms/cms_menu_osd.c"
    ...
    ((OSD_Entry){ "BACK", OME_Back, {.func = 
# 356 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 356 "./src/main/cms/cms_menu_osd.c"
   }, 
# 356 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 356 "./src/main/cms/cms_menu_osd.c"
   , 0 }),
    ((OSD_Entry){ 
# 357 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 357 "./src/main/cms/cms_menu_osd.c"
   , OME_END, {.func = 
# 357 "./src/main/cms/cms_menu_osd.c" 3 4
   ((void *)0)
# 357 "./src/main/cms/cms_menu_osd.c"
...
const CMS_Menu cmsx_menuOsd = {
    ...
    .onEnter = 
# 366 "./src/main/cms/cms_menu_osd.c" 3 4
              ((void *)0)
# 366 "./src/main/cms/cms_menu_osd.c"
                  ,
    .onExit = 
# 367 "./src/main/cms/cms_menu_osd.c" 3 4
             ((void *)0)
# 367 "./src/main/cms/cms_menu_osd.c"
                 ,
    .onGlobalExit = 
# 368 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 368 "./src/main/cms/cms_menu_osd.c"
                       ,
