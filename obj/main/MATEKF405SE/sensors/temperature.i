...
# 31 "./src/main/sensors/temperature.c" 2
...
# 4 "./src/main/drivers/temperature/temperature.h" 2

typedef struct temperatureDev_s {
    busDevice_t *busDev;
    sensorTempReadFuncPtr read;
} temperatureDev_t;
# 32 "./src/main/sensors/temperature.c" 2
...
# 33 "./src/main/sensors/temperature.c" 2
...
# 35 "./src/main/sensors/temperature.c" 2
...
# 37 "./src/main/sensors/temperature.c" 2
...
# 38 "./src/main/sensors/temperature.c" 2
...
# 39 "./src/main/sensors/temperature.c" 2
...
# 59 "./src/main/sensors/barometer.h"
    baroIsHealthy(void);
# 40 "./src/main/sensors/temperature.c" 2
...
static 
# 46 "./src/main/sensors/temperature.c" 3 4
      _Bool 
# 46 "./src/main/sensors/temperature.c"
           lm75Detected = 
# 46 "./src/main/sensors/temperature.c" 3 4
                          0
# 46 "./src/main/sensors/temperature.c"
