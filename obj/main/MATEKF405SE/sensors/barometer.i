...
# 1 "./src/main/drivers/barometer/barometer_lps25h.h" 1
# 18 "./src/main/drivers/barometer/barometer_lps25h.h"
       



# 21 "./src/main/drivers/barometer/barometer_lps25h.h" 3 4
_Bool 
# 21 "./src/main/drivers/barometer/barometer_lps25h.h"
    lps25hDetect(baroDev_t *baro);
...
# 46 "./src/main/sensors/barometer.c" 2
...
const barometerConfig_t pgResetTemplate_barometerConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .baro_hardware = BARO_AUTODETECT, .use_median_filtering = 1 }
...
static 
# 70 "./src/main/sensors/barometer.c" 3 4
      _Bool 
# 70 "./src/main/sensors/barometer.c"
           baroCalibrationFinished = 
# 70 "./src/main/sensors/barometer.c" 3 4
                                     0
# 70 "./src/main/sensors/barometer.c"
                                          ;
...
# 74 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 74 "./src/main/sensors/barometer.c"
    baroDetect(baroDev_t *dev, baroSensor_e baroHardwareToUse)
{
    ...
    if (baroHardware == BARO_NONE) {
        ...
        return 
# 170 "./src/main/sensors/barometer.c" 3 4
              0
# 170 "./src/main/sensors/barometer.c"
                   ;
    }
    ...
    return 
# 175 "./src/main/sensors/barometer.c" 3 4
          1
# 175 "./src/main/sensors/barometer.c"
              ;
}


# 178 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 178 "./src/main/sensors/barometer.c"
    baroInit(void)
{
    if (!baroDetect(&baro.dev, barometerConfig()->baro_hardware)) {
        return 
# 181 "./src/main/sensors/barometer.c" 3 4
              0
# 181 "./src/main/sensors/barometer.c"
                   ;
    }
    return 
# 183 "./src/main/sensors/barometer.c" 3 4
          1
# 183 "./src/main/sensors/barometer.c"
              ;
}


# 186 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 186 "./src/main/sensors/barometer.c"
    baroIsCalibrationComplete(void)
{
...
void baroStartCalibration(void)
{
    ...
    baroCalibrationFinished = 
# 194 "./src/main/sensors/barometer.c" 3 4
                             0
# 194 "./src/main/sensors/barometer.c"
                                  ;
}

#define PRESSURE_SAMPLES_MEDIAN 3
# 208 "./src/main/sensors/barometer.c"
...
static int32_t applyBarometerMedianFilter(int32_t newPressureReading)
{
    ...
    static 
# 213 "./src/main/sensors/barometer.c" 3 4
          _Bool 
# 213 "./src/main/sensors/barometer.c"
               medianFilterReady = 
# 213 "./src/main/sensors/barometer.c" 3 4
                                   0
# 213 "./src/main/sensors/barometer.c"
    ...
    if (nextSampleIndex == 3) {
        nextSampleIndex = 0;
        medianFilterReady = 
# 218 "./src/main/sensors/barometer.c" 3 4
                           1
# 218 "./src/main/sensors/barometer.c"
                               ;
    }
    int previousSampleIndex = currentFilterSampleIndex - 1;
    if (previousSampleIndex < 0) {
        previousSampleIndex = 3 - 1;
    }
    const int previousPressureReading = barometerFilterSamples[previousSampleIndex];

    if (medianFilterReady) {
        if (( __extension__ ({ __typeof__(previousPressureReading - newPressureReading) _abs0 = (previousPressureReading - newPressureReading); _abs0 < 0 ? -_abs0 : _abs0; })) < 1000) {
...
static void performBaroCalibrationCycle(void)
{
    ...
    if (fabsf(baroGroundPressureError) < (baroGroundPressure * 0.00005f)) {
        if ((millis() - baroCalibrationTimeout) > 250) {
            baroGroundAltitude = pressureToAltitude(baroGroundPressure);
            baroCalibrationFinished = 
# 286 "./src/main/sensors/barometer.c" 3 4
                                     1
# 286 "./src/main/sensors/barometer.c"
                                         ;
            debugTracePrintf(
# 287 "./src/main/sensors/barometer.c" 3 4
           1
# 287 "./src/main/sensors/barometer.c"
           , "Barometer calibration complete (%d)", lrintf(baroGroundAltitude));
        }
    }
    else {
        baroCalibrationTimeout = millis();
...
int16_t baroGetTemperature(void)
{
    return ((baro.baroTemperature) / 10);
}


# 325 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 325 "./src/main/sensors/barometer.c"
    baroIsHealthy(void)
{
    return 
# 327 "./src/main/sensors/barometer.c" 3 4
          1
# 327 "./src/main/sensors/barometer.c"
              ;
}
