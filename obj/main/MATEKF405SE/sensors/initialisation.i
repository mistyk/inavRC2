...
# 47 "./src/main/sensors/initialisation.c" 3 4
_Bool 
# 47 "./src/main/sensors/initialisation.c"
    sensorsAutodetect(void)
{
...
# 49 "./src/main/sensors/initialisation.c"
    ...
    if (!gyroInit()) {
        return 
# 52 "./src/main/sensors/initialisation.c" 3 4
              0
# 52 "./src/main/sensors/initialisation.c"
                   ;
    }
    ...
    if (accelerometerConfig()->acc_hardware == ACC_AUTODETECT) {
        ...
        eepromUpdatePending = 
# 83 "./src/main/sensors/initialisation.c" 3 4
                             1
# 83 "./src/main/sensors/initialisation.c"
                                 ;
    }
    ...
    if (barometerConfig()->baro_hardware == BARO_AUTODETECT) {
        ...
        eepromUpdatePending = 
# 89 "./src/main/sensors/initialisation.c" 3 4
                             1
# 89 "./src/main/sensors/initialisation.c"
                                 ;
    }
    ...
    if (compassConfig()->mag_hardware == MAG_AUTODETECT) {
        ...
        eepromUpdatePending = 
# 96 "./src/main/sensors/initialisation.c" 3 4
                             1
# 96 "./src/main/sensors/initialisation.c"
                                 ;
    }
    ...
    if (pitotmeterConfig()->pitot_hardware == PITOT_AUTODETECT) {
        ...
        eepromUpdatePending = 
# 103 "./src/main/sensors/initialisation.c" 3 4
                             1
# 103 "./src/main/sensors/initialisation.c"
                                 ;
    }
    ...
    return 
# 111 "./src/main/sensors/initialisation.c" 3 4
          1
# 111 "./src/main/sensors/initialisation.c"
              ;
}
