...
# 68 "./src/main/sensors/pitotmeter.h"
    pitotIsHealthy(void);
# 45 "./src/main/sensors/pitotmeter.c" 2
...
const pitotmeterConfig_t pgResetTemplate_pitotmeterConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .pitot_hardware = PITOT_AUTODETECT, .pitot_lpf_milli_hz = 350, .pitot_scale = 1.00f }
...
# 68 "./src/main/sensors/pitotmeter.c" 3 4
_Bool 
# 68 "./src/main/sensors/pitotmeter.c"
    pitotDetect(pitotDev_t *dev, uint8_t pitotHardwareToUse)
{
    ...
    switch (pitotHardwareToUse) {
        ...
        case PITOT_VIRTUAL:
# 111 "./src/main/sensors/pitotmeter.c"
            if (pitotHardwareToUse != PITOT_AUTODETECT) {
                break;
            }
            __attribute__ ((fallthrough));
    ...
    if (pitotHardware == PITOT_NONE) {
        ...
        return 
# 138 "./src/main/sensors/pitotmeter.c" 3 4
              0
# 138 "./src/main/sensors/pitotmeter.c"
                   ;
    }
    ...
    return 
# 143 "./src/main/sensors/pitotmeter.c" 3 4
          1
# 143 "./src/main/sensors/pitotmeter.c"
              ;
}


# 146 "./src/main/sensors/pitotmeter.c" 3 4
_Bool 
# 146 "./src/main/sensors/pitotmeter.c"
    pitotInit(void)
{
    if (!pitotDetect(&pitot.dev, pitotmeterConfig()->pitot_hardware)) {
        return 
# 149 "./src/main/sensors/pitotmeter.c" 3 4
              0
# 149 "./src/main/sensors/pitotmeter.c"
                   ;
    }
    return 
...
# 154 "./src/main/sensors/pitotmeter.c" 3 4
_Bool 
# 154 "./src/main/sensors/pitotmeter.c"
    pitotIsCalibrationComplete(void)
{
...
void pitotStartCalibration(void)
{
    ...
    pitot.calibrationFinished = 
# 162 "./src/main/sensors/pitotmeter.c" 3 4
                               0
# 162 "./src/main/sensors/pitotmeter.c"
                                    ;
}
...
static void performPitotCalibrationCycle(void)
{
    ...
    if (fabsf(pitotPressureZeroError) < (101325.0f * 0.000005f)) {
        if ((millis() - pitot.calibrationTimeoutMs) > 500) {
            pitot.calibrationFinished = 
# 172 "./src/main/sensors/pitotmeter.c" 3 4
                                       1
# 172 "./src/main/sensors/pitotmeter.c"
                                           ;
        }
    }
    else {
...
static struct ptState_s pitotThread_protothreadState = {0, 0, 0, 0}; static void pitotThread(void)
{
    struct ptState_s * currentPt = (&pitotThread_protothreadState); 
# 182 "./src/main/sensors/pitotmeter.c" 3 4
   _Bool 
# 182 "./src/main/sensors/pitotmeter.c"
   ptYielded = 
# 182 "./src/main/sensors/pitotmeter.c" 3 4
   1
# 182 "./src/main/sensors/pitotmeter.c"
   ; (void) ptYielded; switch (currentPt->line) { case 0:;
    ...
    while(1) {
        ...
        do { (currentPt)->startTime = (timeUs_t)micros(); (currentPt)->delayTime = (pitot.dev.delay); do { currentPt->line = 197; __attribute__ ((fallthrough)); case 197:; } while (0); if ((timeDelta_t)(micros() - (currentPt)->startTime) <= (currentPt)->delayTime) { return; } } while (0);
        ...
        pitot.dev.calculate(&pitot.dev, &pitotPressureTmp, 
# 204 "./src/main/sensors/pitotmeter.c" 3 4
                                                          ((void *)0)
# 204 "./src/main/sensors/pitotmeter.c"
                                                              );
        do { ptYielded = 
# 205 "./src/main/sensors/pitotmeter.c" 3 4
       0
# 205 "./src/main/sensors/pitotmeter.c"
       ; do { currentPt->line = 205; __attribute__ ((fallthrough)); case 205:; } while (0); if (!ptYielded) { return; } } while (0);
        ...
        do { (currentPt)->startTime = (timeUs_t)micros(); (currentPt)->delayTime = (pitot.dev.delay); do { currentPt->line = 211; __attribute__ ((fallthrough)); case 211:; } while (0); if ((timeDelta_t)(micros() - (currentPt)->startTime) <= (currentPt)->delayTime) { return; } } while (0);


        if (pitotIsCalibrationComplete()) {
# 223 "./src/main/sensors/pitotmeter.c"
            pitot.airSpeed = pitotmeterConfig()->pitot_scale * sqrtf(2.0f * fabsf(pitot.pressure - pitot.pressureZero) / 1.225f) * 100;
        } else {
...
# 243 "./src/main/sensors/pitotmeter.c" 3 4
_Bool 
# 243 "./src/main/sensors/pitotmeter.c"
    pitotIsHealthy(void)
{
    return (millis() - pitot.lastSeenHealthyMs) < 500;
}
