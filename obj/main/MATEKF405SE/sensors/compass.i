...
# 88 "./src/main/sensors/compass.c"
    ...
    case MAG_IST8308:
# 218 "./src/main/sensors/compass.c"
        if (magHardwareToUse != MAG_AUTODETECT) {
            break;
        }
        __attribute__ ((fallthrough));
...
# 291 "./src/main/sensors/compass.c"
    ...
    ledSet(1, 
# 294 "./src/main/sensors/compass.c" 3 4
   1
# 294 "./src/main/sensors/compass.c"
   );
    const 
...
# 295 "./src/main/sensors/compass.c"
    ...
    ledSet(1, 
# 296 "./src/main/sensors/compass.c" 3 4
   0
# 296 "./src/main/sensors/compass.c"
   );
