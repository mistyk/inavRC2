...
static 
# 110 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 110 "./src/main/sensors/acceleration.c"
...
# 207 "./src/main/sensors/acceleration.c"
    case ACC_MPU6000:
        ...
        __attribute__ ((fallthrough));
# 300 "./src/main/sensors/acceleration.c"
    default:
    case ACC_NONE:
    ...
    if (accHardware == ACC_NONE) {
        return 
# 309 "./src/main/sensors/acceleration.c" 3 4
              0
# 309 "./src/main/sensors/acceleration.c"
                   ;
    }
...
# 317 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 317 "./src/main/sensors/acceleration.c"
...
# 349 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 349 "./src/main/sensors/acceleration.c"
    accIsCalibrationComplete(void)
{
...
static 
# 354 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 354 "./src/main/sensors/acceleration.c"
...
# 421 "./src/main/sensors/acceleration.c" 3 4
                                      0
# 421 "./src/main/sensors/acceleration.c"
                                           ;
            accSamples[axis][X] = 0;
            accSamples[axis][Y] = 0;
            accSamples[axis][Z] = 0;
...
# 437 "./src/main/sensors/acceleration.c" 3 4
                                               1
# 437 "./src/main/sensors/acceleration.c"
                                                   ;
...
void accUpdate(void)
{
    ...
    for (int axis = 0; axis < 3; axis++) {
        ...
        {if (debugMode == (DEBUG_ACC)) {debug[(axis)] = (accADC[axis]);}};
    }
    ...
    if (fabsf(acc.accADCf[X]) > 7.9f || fabsf(acc.accADCf[Y]) > 7.9f || fabsf(acc.accADCf[Z]) > 7.9f) {
        acc.accClipCount++;
    }
...
# 623 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 623 "./src/main/sensors/acceleration.c"
    accIsHealthy(void)
{
    return 
# 625 "./src/main/sensors/acceleration.c" 3 4
          1
# 625 "./src/main/sensors/acceleration.c"
              ;
}
