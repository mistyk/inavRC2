...
#define CHR_IS_METADATA(chr) ((chr)->data[0] == 'I' && (chr)->data[1] == 'N' && (chr)->data[2] == 'A' && (chr)->data[3] == 'V' && (chr)->data[4] == 1)
...
static 
# 109 "./src/main/io/displayport_max7456.c" 3 4
      _Bool 
# 109 "./src/main/io/displayport_max7456.c"
           readChar(displayPort_t *displayPort, uint8_t x, uint8_t y, uint16_t *c, textAttributes_t *attr)
{
    (void)(displayPort);
...
static 
# 115 "./src/main/io/displayport_max7456.c" 3 4
      _Bool 
# 115 "./src/main/io/displayport_max7456.c"
           isTransferInProgress(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 118 "./src/main/io/displayport_max7456.c" 3 4
          0
# 118 "./src/main/io/displayport_max7456.c"
               ;
}
...
static uint32_t txBytesFree(const displayPort_t *displayPort)
{
    (void)(displayPort);
    return 
# 138 "./src/main/io/displayport_max7456.c" 3 4
          (0xffffffffUL)
# 138 "./src/main/io/displayport_max7456.c"
                    ;
}
...
static 
# 152 "./src/main/io/displayport_max7456.c" 3 4
      _Bool 
# 152 "./src/main/io/displayport_max7456.c"
           getFontMetadata(displayFontMetadata_t *metadata, const displayPort_t *displayPort)
{
    (void)(displayPort);
    ...
    if (((&chr)->data[0] == 'I' && (&chr)->data[1] == 'N' && (&chr)->data[2] == 'A' && (&chr)->data[3] == 'V' && (&chr)->data[4] == 1)) {
        ...
        return 
# 171 "./src/main/io/displayport_max7456.c" 3 4
              1
# 171 "./src/main/io/displayport_max7456.c"
                  ;
    }

    return 
# 174 "./src/main/io/displayport_max7456.c" 3 4
          0
# 174 "./src/main/io/displayport_max7456.c"
               ;
}
