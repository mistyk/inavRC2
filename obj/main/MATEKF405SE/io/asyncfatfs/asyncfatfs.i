...
# 23 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 24 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 55 "./src/main/drivers/sdcard.h" 3 4
_Bool 
# 55 "./src/main/drivers/sdcard.h"
...
# 63 "./src/main/drivers/sdcard.h" 3 4
_Bool 
# 63 "./src/main/drivers/sdcard.h"
    sdcard_isInserted(void);

# 64 "./src/main/drivers/sdcard.h" 3 4
_Bool 
# 64 "./src/main/drivers/sdcard.h"
    sdcard_isInitialized(void);

# 65 "./src/main/drivers/sdcard.h" 3 4
_Bool 
# 65 "./src/main/drivers/sdcard.h"
...
# 34 "./src/main/io/asyncfatfs/asyncfatfs.c" 2
...
# 182 "./src/main/io/asyncfatfs/asyncfatfs.c"
    unsigned locked:1;
...
# 361 "./src/main/io/asyncfatfs/asyncfatfs.c"
    uint32_t logicalSize;
# 374 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 453 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 453 "./src/main/io/asyncfatfs/asyncfatfs.c"
        filesystemFull;
...
static 
# 501 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 501 "./src/main/io/asyncfatfs/asyncfatfs.c"
           isPowerOfTwo(unsigned int x)
{
    return ((x != 0) && ((x & (~x + 1)) == x));
}
# 513 "./src/main/io/asyncfatfs/asyncfatfs.c"
static 
# 513 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 513 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_assert(
# 513 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
...
static 
# 528 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 528 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 599 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                                  _Bool 
# 599 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                                       locked)
{
...
static void afatfs_sdcardReadComplete(sdcardBlockOperation_e operation, uint32_t sectorIndex, uint8_t *buffer, uint32_t callbackData)
{
    ...
    for (int i = 0; i < 8; i++) {
        if (afatfs.cacheDescriptor[i].state != AFATFS_CACHE_STATE_EMPTY
            ...
            if (buffer == 
# 626 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         ((void *)0)
# 626 "./src/main/io/asyncfatfs/asyncfatfs.c"
                             ) {
...
# 648 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                 0
# 648 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                      ;
    ...
    for (int i = 0; i < 8; i++) {
        ...
        if (afatfs.cacheDescriptor[i].sectorIndex == sectorIndex
            ...
            if (buffer == 
# 657 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         ((void *)0)
# 657 "./src/main/io/asyncfatfs/asyncfatfs.c"
                             ) {
...
static void afatfs_cacheFlushSector(int cacheIndex)
{
    ...
    switch (sdcard_writeBlock(cacheDescriptor->sectorIndex, afatfs_cacheSectorGetMemory(cacheIndex), afatfs_sdcardWriteComplete, 0)) {
        case SDCARD_OPERATION_IN_PROGRESS:
            ...
            afatfs.cacheFlushInProgress = 
# 689 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                         1
# 689 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                             ;
            break;
...
static afatfsCacheBlockDescriptor_t* afatfs_findCacheSector(uint32_t sectorIndex)
{
    ...
    return 
# 717 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          ((void *)0)
# 717 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 731 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 796 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                   0
# 796 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                        );
    }
...
# 805 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 805 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_flush(void)
{
    if (afatfs.cacheDirtyEntries > 0) {
        ...
        if (earliestSectorIndex > -1) {
            ...
            return 
# 825 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 825 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
...
# 892 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 927 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                            (0xffff)
# 927 "./src/main/io/asyncfatfs/asyncfatfs.c"
                            ) ? (eraseCount) : (
# 927 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                            (0xffff)
# 927 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        default:
            ...
            afatfs_assert(
# 956 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         0
# 956 "./src/main/io/asyncfatfs/asyncfatfs.c"
                              );
            return AFATFS_OPERATION_FAILURE;
    }
}
...
static 
# 964 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 964 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_parseMBR(const uint8_t *sector)
{

    if (sector[512 - 2] != 0x55 || sector[512 - 1] != 0xAA)
        return 
# 968 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 968 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    for (int i = 0; i < 4; i++) {
        if (
            ...
            return 
# 984 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  1
# 984 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
    }

    return 
# 988 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          0
# 988 "./src/main/io/asyncfatfs/asyncfatfs.c"
               ;
}
           ...
           afatfs_parseVolumeID(const uint8_t *sector)
{
    ...
    if (volume->bytesPerSector != 512 || volume->numFATs != 2
        ...
        return 
# 999 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 999 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
...
# 1006 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    if (afatfs.numClusters <= 4084) {
        ...
        return 
# 1023 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1023 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 1041 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 1041 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
static 
# 1062 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1062 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1084 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1112 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
{
    file->logicalSize = ((file->logicalSize) > (file->cursorOffset) ? (file->logicalSize) : (file->cursorOffset));
}
...
static void afatfs_fileUnlockCacheSector(afatfsFilePtr_t file)
{
    ...
    if (file->readRetainCacheIndex != -1) {
        afatfs.cacheDescriptor[file->readRetainCacheIndex].retainCount = (((int) afatfs.cacheDescriptor[file->readRetainCacheIndex].retainCount - 1) > (0) ? ((int) afatfs.cacheDescriptor[file->readRetainCacheIndex].retainCount - 1) : (0));
        file->readRetainCacheIndex = -1;
    }
}
# 1179 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1185 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 1185 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    switch (condition) {
        ...
        default:
            afatfs_assert(
# 1206 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         0
...
# 1283 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1322 "./src/main/io/asyncfatfs/asyncfatfs.c"
static afatfsOperationStatus_e afatfs_FATFillWithPattern(afatfsFATPattern_e pattern, uint32_t *startCluster, uint32_t endCluster)
{
    ...
    while (*startCluster < endCluster) {
        ...
        uint32_t lastEntryIndex = ((firstEntryIndex + (endCluster - *startCluster)) < (afatfs_fatEntriesPerSector()) ? (firstEntryIndex + (endCluster - *startCluster)) : (afatfs_fatEntriesPerSector()));
...
# 1364 "./src/main/io/asyncfatfs/asyncfatfs.c"
        switch (pattern) {
...
# 1423 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1489 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1565 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                   1
# 1565 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                       ;
            return AFATFS_OPERATION_FAILURE;
        break;
    }
...
# 1594 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1631 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1654 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1719 "./src/main/io/asyncfatfs/asyncfatfs.c"
static afatfsOperationStatus_e afatfs_appendSupercluster(afatfsFilePtr_t file)
{
    ...
    if (afatfs.freeFile.logicalSize < superClusterSize) {
        afatfs.filesystemFull = 
# 1728 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                               1
# 1728 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                   ;
    }
...
static 
# 1771 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1771 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static uint8_t* afatfs_fileRetainCursorSectorForRead(afatfsFilePtr_t file)
{
    ...
    if (file->readRetainCacheIndex != -1) {
        if (!afatfs_assert(physicalSector == afatfs.cacheDescriptor[file->readRetainCacheIndex].sectorIndex)) {
            return 
# 1797 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1797 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (afatfs_isEndOfAllocatedFile(file)) {
            return 
# 1803 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1803 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (status != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1817 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1817 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
static uint8_t* afatfs_fileLockCursorSectorForWrite(afatfsFilePtr_t file)
{
    ...
    if (file->writeLockedCacheIndex != -1) {
        ...
        if (!afatfs_assert(physicalSector == afatfs.cacheDescriptor[file->writeLockedCacheIndex].sectorIndex)) {
            return 
# 1842 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1842 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (afatfs_isEndOfAllocatedFile(file) && afatfs_appendFreeCluster(file) != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1852 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1852 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (status != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1890 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1890 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
# 1911 "./src/main/io/asyncfatfs/asyncfatfs.c"
static 
# 1911 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1911 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_fseekAtomic(afatfsFilePtr_t file, int32_t offset)
{
    ...
    if (newSectorOffset < 512) {
        ...
        return 
# 1919 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 1919 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
    ...
    if (file->type == AFATFS_FILE_TYPE_FAT16_ROOT_DIRECTORY) {
        ...
        return 
# 1929 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 1929 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
    ...
    if (offset > (int32_t) clusterSizeBytes || offset < -(int32_t) offsetInCluster) {
        return 
# 1939 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1939 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (newOffsetInCluster >= clusterSizeBytes) {
        ...
        if (status == AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1959 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 1959 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
    ...
    return 
# 1968 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 1968 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
static 
# 1974 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1974 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_fseekInternalContinue(afatfsFile_t *file)
{
    ...
    while (offsetInCluster + opState->seekOffset >= clusterSizeBytes && !afatfs_isEndOfAllocatedFile(file)) {
        ...
        if (status == AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 2000 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2000 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
    ...
    return 
# 2017 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2017 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2031 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2068 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsOperationStatus_e afatfs_fseek(afatfsFilePtr_t file, int32_t offset, afatfsSeek_e whence)
{
    ...
    switch (whence) {
        case AFATFS_SEEK_CUR:
            if (offset >= 0) {
                ...
                return afatfs_fseekInternal(file, ((file->cursorOffset + offset) < (file->logicalSize) ? (file->cursorOffset + offset) : (file->logicalSize)), 
# 2077 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                                      ((void *)0)
# 2077 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                                          );
            }
    ...
    return afatfs_fseekInternal(file, (((uint32_t) offset) < (file->logicalSize) ? ((uint32_t) offset) : (file->logicalSize)), 
# 2107 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                ((void *)0)
# 2107 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                    );
}
...
# 2115 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2115 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_ftell(afatfsFilePtr_t file, uint32_t *position)
{
    if (afatfs_fileIsBusy(file)) {
        return 
# 2118 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2118 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    } else {
    ...
    if (sector) {
        ...
        *dirEntry = (fatDirectoryEntry_t*) sector + finder->entryIndex;
        ...
        if (afatfs_isEndOfAllocatedFile(directory)) {
            *dirEntry = 
# 2158 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                       ((void *)0)
# 2158 "./src/main/io/asyncfatfs/asyncfatfs.c"
                           ;
...
static afatfsOperationStatus_e afatfs_extendSubdirectoryContinue(afatfsFile_t *directory)
{
    ...
    switch (opState->phase) {
        ...
        case AFATFS_EXTEND_SUBDIRECTORY_PHASE_FAILURE:
            ...
            if (opState->callback) {
                opState->callback(
# 2266 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                 ((void *)0)
# 2266 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                     );
            }
            return AFATFS_OPERATION_FAILURE;
        break;
...
# 2286 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2325 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2343 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                         ((void *)0)
# 2343 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                             , 
# 2343 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                               ((void *)0)
# 2343 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static afatfsFilePtr_t afatfs_allocateFileHandle(void)
{
    ...
    return 
# 2370 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          ((void *)0)
# 2370 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2380 "./src/main/io/asyncfatfs/asyncfatfs.c"
static afatfsOperationStatus_e afatfs_ftruncateContinue(afatfsFilePtr_t file, 
# 2380 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                             _Bool 
# 2380 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                  markDeleted)
{
    ...
    switch (opState->phase) {
        ...
        case AFATFS_TRUNCATE_FILE_ERASE_FAT_CHAIN_NORMAL:
            while (!afatfs_FATIsEndOfChainMarker(opState->currentCluster)) {
                ...
                afatfs.lastClusterAllocated = ((afatfs.lastClusterAllocated) < (opState->currentCluster - 1) ? (afatfs.lastClusterAllocated) : (opState->currentCluster - 1));
            }
...
# 2487 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2487 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2487 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_ftruncate(afatfsFilePtr_t file, afatfsFileCallback_t callback)
{
...
# 2492 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    return 
# 2520 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2520 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
            ...
            do {
                ...
                switch (status) {
                    case AFATFS_OPERATION_SUCCESS:
                        ...
                        if (entry == 
# 2556 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                    ((void *)0) 
# 2556 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        case AFATFS_CREATEFILE_PHASE_CREATE_NEW_FILE:
            ...
            if (status == AFATFS_OPERATION_SUCCESS) {
                ...
                if (rtcGetDateTimeLocal(&now)) {
                    entry->creationDate = (now.day | (now.month << 5) | ((now.year - 1980) << 9));
                    entry->creationTime = ((now.seconds / 2) | (now.minutes << 5) | (now.hours << 11));
                } else {
        ...
        case AFATFS_CREATEFILE_PHASE_FAILURE:
            ...
            opState->callback(
# 2682 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                             ((void *)0)
# 2682 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                 );
        break;
    }
}
...
# 2702 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                           1
# 2702 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
    ...
    afatfs_funlink(afatfsFilePtr_t file, afatfsCallback_t callback)
{
    ...
    if (!file || file->type == AFATFS_FILE_TYPE_NONE) {
        return 
# 2722 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2722 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
...
# 2732 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    return 
# 2742 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2742 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2755 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2810 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    if ((file->mode & 32) != 0) {
        ...
        if (descriptor) {
            descriptor->retainCount = (((int) descriptor->retainCount - 1) > (0) ? ((int) descriptor->retainCount - 1) : (0));
        }
    }
...
# 2854 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2854 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2854 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_fclose(afatfsFilePtr_t file, afatfsCallback_t callback)
{
    if (!file || file->type == AFATFS_FILE_TYPE_NONE) {
        return 
# 2857 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2857 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    } else if (afatfs_fileIsBusy(file)) {
        return 
# 2859 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2859 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    } else {
        afatfs_fileUpdateFilesize(file);
        ...
        return 
# 2866 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2866 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2877 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2877 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2877 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_mkdir(const char *filename, afatfsFileCallback_t callback)
{
    ...
    if (file) {
        ...
        callback(
# 2884 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                ((void *)0)
# 2884 "./src/main/io/asyncfatfs/asyncfatfs.c"
                    );
    }

    return file != 
# 2887 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 2887 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
}
# 2897 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2897 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2897 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_chdir(afatfsFilePtr_t directory)
{
    if (afatfs_fileIsBusy(&afatfs.currentDirectory)) {
        return 
# 2900 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2900 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
    ...
    if (directory) {
        if (afatfs_fileIsBusy(directory)) {
            return 
# 2905 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2905 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        memcpy(&afatfs.currentDirectory, directory, sizeof(*directory));
        return 
# 2909 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2909 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    } else {
        ...
        return 
# 2928 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2928 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2958 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2958 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2958 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_fopen(const char *filename, const char *mode, afatfsFileCallback_t complete)
{
    ...
    if (file) {
        ...
        complete(
# 2995 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                ((void *)0)
# 2995 "./src/main/io/asyncfatfs/asyncfatfs.c"
                    );
    }

    return file != 
# 2998 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 2998 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
}
...
# 3035 "./src/main/io/asyncfatfs/asyncfatfs.c"
uint32_t afatfs_fwrite(afatfsFilePtr_t file, const uint8_t *buffer, uint32_t len)
{
    if ((file->mode & (4 | 2)) == 0) {
        return 0;
    ...
    while (len > 0) {
        uint32_t bytesToWriteThisSector = ((512 - cursorOffsetInSector) < (len) ? (512 - cursorOffsetInSector) : (len));
        uint8_t *sectorBuffer;
...
# 3072 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs_fseekInternal(file, bytesToWriteThisSector, 
# 3072 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                              ((void *)0)
# 3072 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                  ) == AFATFS_OPERATION_IN_PROGRESS) {
            break;
...
# 3102 "./src/main/io/asyncfatfs/asyncfatfs.c"
uint32_t afatfs_fread(afatfsFilePtr_t file, uint8_t *buffer, uint32_t len)
{
    if ((file->mode & 1) == 0) {
        return 0;
    ...
    len = ((file->logicalSize - file->cursorOffset) < (len) ? (file->logicalSize - file->cursorOffset) : (len));

    uint32_t readBytes = 0;
    uint32_t cursorOffsetInSector = file->cursorOffset % 512;

    while (len > 0) {
        uint32_t bytesToReadThisSector = ((512 - cursorOffsetInSector) < (len) ? (512 - cursorOffsetInSector) : (len));
        uint8_t *sectorBuffer;
...
# 3147 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs_fseekInternal(file, bytesToReadThisSector, 
# 3147 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                             ((void *)0)
# 3147 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                 ) == AFATFS_OPERATION_IN_PROGRESS) {
            break;
...
# 3163 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 3163 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_feof(afatfsFilePtr_t file)
{
...
# 3190 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                          0
# 3190 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
        break;
...
# 3256 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    while (1) {
        switch (opState->phase) {
            ...
            case AFATFS_FREE_SPACE_SEARCH_PHASE_GROW_HOLE:
                ...
                searchLimit = (((uint64_t) opState->candidateStart + 0xFFFFFFFF / afatfs_clusterSize()) < (afatfs.numClusters + 2) ? ((uint64_t) opState->candidateStart + 0xFFFFFFFF / afatfs_clusterSize()) : (afatfs.numClusters + 2));
        ...
        case AFATFS_INITIALIZATION_READ_VOLUME_ID:
            if (afatfs_cacheSector(afatfs.partitionStartSector, &sector, 1 | 8, 0) == AFATFS_OPERATION_SUCCESS) {
                if (afatfs_parseVolumeID(sector)) {
                    ...
                    afatfs_chdir(
# 3373 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                ((void *)0)
# 3373 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                    );
...
# 3506 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 3506 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_destroy(
# 3506 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                   _Bool 
# 3506 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3514 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                   ((void *)0)
# 3514 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                       );
...
# 3522 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                           ((void *)0)
# 3522 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
            openFileCount++;
        }
...
# 3528 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                   ((void *)0)
# 3528 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                       );
            openFileCount++;
        }
        ...
        if (!afatfs_flush()) {
            return 
# 3535 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3535 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        if (afatfs.cacheFlushInProgress) {
            return 
# 3539 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3539 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        if (openFileCount > 0) {
            return 
# 3543 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3543 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
# 3554 "./src/main/io/asyncfatfs/asyncfatfs.c"
    }
    ...
    return 
# 3559 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 3559 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
