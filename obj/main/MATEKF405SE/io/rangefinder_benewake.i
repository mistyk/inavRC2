# 1 "./src/main/io/rangefinder_benewake.c"
...
# 1 "./src/main/io/rangefinder_benewake.c"
# 25 "./src/main/io/rangefinder_benewake.c"
...
# 26 "./src/main/io/rangefinder_benewake.c" 2
...
# 27 "./src/main/io/rangefinder_benewake.c" 2
...
# 28 "./src/main/io/rangefinder_benewake.c" 2
...
# 29 "./src/main/io/rangefinder_benewake.c" 2
...
# 64 "./src/main/platform.h" 2
# 31 "./src/main/io/rangefinder_benewake.c" 2
...
# 33 "./src/main/io/rangefinder_benewake.c" 2
...
# 34 "./src/main/io/rangefinder_benewake.c" 2
...
# 36 "./src/main/io/rangefinder_benewake.c" 2
...
# 38 "./src/main/io/rangefinder_benewake.c" 2
...
# 41 "./src/main/io/rangefinder_benewake.c" 2
...
# 42 "./src/main/io/rangefinder_benewake.c" 2
...
# 43 "./src/main/io/rangefinder_benewake.c" 2
...
# 59 "./src/main/io/rangefinder_benewake.c" 3 4
                                  ((void *)0)
# 59 "./src/main/io/rangefinder_benewake.c"
                                      ;
static serialPortConfig_t * portConfig;
static uint8_t buffer[sizeof(tfminiPacket_t)];
static unsigned bufferPtr;

static 
# 64 "./src/main/io/rangefinder_benewake.c" 3 4
      _Bool 
# 64 "./src/main/io/rangefinder_benewake.c"
           hasNewData = 
# 64 "./src/main/io/rangefinder_benewake.c" 3 4
                        0
# 64 "./src/main/io/rangefinder_benewake.c"
...
static 
# 67 "./src/main/io/rangefinder_benewake.c" 3 4
      _Bool 
# 67 "./src/main/io/rangefinder_benewake.c"
           benewakeRangefinderDetect(void)
{
    portConfig = findSerialPortConfig(FUNCTION_RANGEFINDER);
    if (!portConfig) {
        return 
# 71 "./src/main/io/rangefinder_benewake.c" 3 4
              0
# 71 "./src/main/io/rangefinder_benewake.c"
                   ;
    }

    return 
# 74 "./src/main/io/rangefinder_benewake.c" 3 4
          1
# 74 "./src/main/io/rangefinder_benewake.c"
              ;
}
...
static void benewakeRangefinderInit(void)
{
    ...
    serialPort = openSerialPort(portConfig->identifier, FUNCTION_RANGEFINDER, 
# 83 "./src/main/io/rangefinder_benewake.c" 3 4
                                                                             ((void *)0)
# 83 "./src/main/io/rangefinder_benewake.c"
                                                                                 , 
# 83 "./src/main/io/rangefinder_benewake.c" 3 4
                                                                                   ((void *)0)
# 83 "./src/main/io/rangefinder_benewake.c"
                                                                                       , baudRates[BAUD_115200], MODE_RX, SERIAL_NOT_INVERTED);
    if (!serialPort) {
        return;
    }
...
static void benewakeRangefinderUpdate(void)
{
    ...
    while (serialRxBytesWaiting(serialPort) > 0) {
        ...
        if (bufferPtr < sizeof(tfminiPacket_t)) {
            buffer[bufferPtr++] = c;
        }
...
static int32_t benewakeRangefinderGetDistance(void)
{
    if (hasNewData) {
        hasNewData = 
# 144 "./src/main/io/rangefinder_benewake.c" 3 4
                    0
# 144 "./src/main/io/rangefinder_benewake.c"
                         ;
