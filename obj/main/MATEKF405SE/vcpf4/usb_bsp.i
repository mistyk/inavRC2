...
# 40 "./src/main/vcpf4/../drivers/nvic.h"
...
# 56 "./src/main/vcpf4/../drivers/io.h"
...
# 87 "./src/main/vcpf4/../drivers/io.h" 2


# 88 "./src/main/vcpf4/../drivers/io.h" 3 4
_Bool 
# 88 "./src/main/vcpf4/../drivers/io.h"
    IORead(IO_t io);
void IOWrite(IO_t io, 
# 89 "./src/main/vcpf4/../drivers/io.h" 3 4
                     _Bool 
# 89 "./src/main/vcpf4/../drivers/io.h"
                          value);
void IOHi(IO_t io);
void IOLo(IO_t io);
...
# 59 "./src/main/vcpf4/usb_bsp.c"
    ...
    IOConfigGPIO(IOGetByTag(((((2) + 1) << 4) | (13))), ((GPIO_Mode_IN) | ((0) << 2) | ((0) << 4) | ((GPIO_PuPd_NOPULL) << 5)));
