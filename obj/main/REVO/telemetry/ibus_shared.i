...
# 42 "./src/main/telemetry/ibus_shared.c" 2
...
# 22 "./src/main/sensors/pitotmeter.h" 2
...
# 68 "./src/main/sensors/pitotmeter.h"
    pitotIsHealthy(void);
# 44 "./src/main/telemetry/ibus_shared.c" 2
...
# 89 "./src/main/telemetry/ibus_shared.c" 3 4
                                     ((void *)0)
# 89 "./src/main/telemetry/ibus_shared.c"
                                         ;
...
static 
# 123 "./src/main/telemetry/ibus_shared.c" 3 4
      _Bool 
# 123 "./src/main/telemetry/ibus_shared.c"
...
static uint8_t dispatchMeasurementRequest(ibusAddress_t address) {
    ...
    if (SENSOR_ADDRESS_TYPE_LOOKUP[address].value == IBUS_MEAS_VALUE_TEMPERATURE) {
        if (sensors(SENSOR_BARO)) return sendIbusMeasurement2(address, (uint16_t) ((((getCurrentTemperature()) * 100) + 50) / 10 + (0x0190)));
        else {
