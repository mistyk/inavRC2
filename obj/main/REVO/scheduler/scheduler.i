...
# 275 "./src/main/scheduler/scheduler.c"
    ...
    if (selectedTask) {
        ...
        selectedTask->movingSumExecutionTime += taskExecutionTime - selectedTask->movingSumExecutionTime / 32;
        selectedTask->totalExecutionTime += taskExecutionTime;
        selectedTask->maxExecutionTime = ( __extension__ ({ __typeof__(selectedTask->maxExecutionTime) _left10 = (selectedTask->maxExecutionTime); __typeof__(taskExecutionTime) _right11 = (taskExecutionTime); _left10 > _right11 ? _left10 : _right11; }));
