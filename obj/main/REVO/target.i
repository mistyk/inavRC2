# 1 "./src/main/target/REVO/target.c"
...
#define __REVISION__ ""
# 1 "./src/main/target/REVO/target.c"
# 18 "./src/main/target/REVO/target.c"
...
# 19 "./src/main/target/REVO/target.c" 2
...
# 64 "./src/main/platform.h" 2
# 21 "./src/main/target/REVO/target.c" 2
...
# 22 "./src/main/target/REVO/target.c" 2
...
# 23 "./src/main/target/REVO/target.c" 2
...
# 24 "./src/main/target/REVO/target.c" 2
...
# 26 "./src/main/target/REVO/target.c" 2


extern const busDeviceDescriptor_t busdev_hmc5883_int_registry; static busDevice_t busdev_hmc5883_int_memory; const busDeviceDescriptor_t busdev_hmc5883_int_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_hmc5883_int_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_HMC5883, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CDEV_1, .address = 0x1E }, .irqPin = 0 }; struct _dummy;

extern const busDeviceDescriptor_t busdev_hmc5883_registry; static busDevice_t busdev_hmc5883_memory; const busDeviceDescriptor_t busdev_hmc5883_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_hmc5883_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_HMC5883, .flags = DEVFLAGS_NONE, .tag = 1, .busdev.i2c = { .i2cBus = I2CDEV_2, .address = 0x1E }, .irqPin = 0 }; struct _dummy;
extern const busDeviceDescriptor_t busdev_qmc5883_registry; static busDevice_t busdev_qmc5883_memory; const busDeviceDescriptor_t busdev_qmc5883_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_qmc5883_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_QMC5883, .flags = DEVFLAGS_NONE, .tag = 1, .busdev.i2c = { .i2cBus = I2CDEV_2, .address = 0x0D }, .irqPin = 0 }; struct _dummy;
extern const busDeviceDescriptor_t busdev_mag3110_registry; static busDevice_t busdev_mag3110_memory; const busDeviceDescriptor_t busdev_mag3110_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_mag3110_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_MAG3110, .flags = DEVFLAGS_NONE, .tag = 1, .busdev.i2c = { .i2cBus = I2CDEV_2, .address = 0x0E }, .irqPin = 0 }; struct _dummy;



const timerHardware_t timerHardware[] = {
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ((((1) + 1) << 4) | (0)), 2, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x02), TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR, ( (((1) & 0x03) << 7) | (((7) & 0x07) << 4) | (((5) & 0x0F) << 0) ) },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ((((1) + 1) << 4) | (1)), 3, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x02), TIM_USE_MC_MOTOR | TIM_USE_FW_MOTOR, ( (((1) & 0x03) << 7) | (((2) & 0x07) << 4) | (((5) & 0x0F) << 0) ) },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((((0) + 1) << 4) | (3)), 3, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x01), TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, ( (((1) & 0x03) << 7) | (((6) & 0x07) << 4) | (((3) & 0x0F) << 0) ) },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), ((((0) + 1) << 4) | (2)), 2, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x01), TIM_USE_MC_MOTOR | TIM_USE_FW_SERVO, ( (((1) & 0x03) << 7) | (((1) & 0x07) << 4) | (((3) & 0x0F) << 0) ) },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), ((((0) + 1) << 4) | (1)), 1, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x02), TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO | TIM_USE_FW_SERVO | TIM_USE_ANY, ( (((1) & 0x03) << 7) | (((4) & 0x07) << 4) | (((6) & 0x0F) << 0) ) },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0C00)), ((((0) + 1) << 4) | (0)), 0, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x02), TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO | TIM_USE_FW_SERVO, ( (((1) & 0x03) << 7) | (((2) & 0x07) << 4) | (((6) & 0x0F) << 0) ) },

    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), ((((1) + 1) << 4) | (14)), 0, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x09), TIM_USE_PWM | TIM_USE_PPM, (0) },
    { ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), ((((1) + 1) << 4) | (15)), 1, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x09), TIM_USE_PWM, (0) },
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), ((((2) + 1) << 4) | (6)), 0, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x03), TIM_USE_PWM | TIM_USE_FW_SERVO, ( (((2) & 0x03) << 7) | (((2) & 0x07) << 4) | (((0) & 0x0F) << 0) ) },
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), ((((2) + 1) << 4) | (7)), 1, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x03), TIM_USE_PWM | TIM_USE_FW_SERVO, ( (((2) & 0x03) << 7) | (((2) & 0x07) << 4) | (((0) & 0x0F) << 0) ) },
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), ((((2) + 1) << 4) | (8)), 2, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x03), TIM_USE_PWM | TIM_USE_FW_SERVO, ( (((2) & 0x03) << 7) | (((2) & 0x07) << 4) | (((0) & 0x0F) << 0) ) },
    { ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0400)), ((((2) + 1) << 4) | (9)), 3, (TIMER_OUTPUT_NONE) | 0, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), ((uint8_t)0x03), TIM_USE_PWM | TIM_USE_FW_SERVO, ( (((2) & 0x03) << 7) | (((7) & 0x07) << 4) | (((7) & 0x0F) << 0) ) },
};
