...
# 108 "./src/main/sensors/rangefinder.c"
        ...
        case RANGEFINDER_SRF10:
            ...
            if (vl53l0xDetect(dev)) {
                ...
                rescheduleTask(TASK_RANGEFINDER, ((33) * 1000));
            }
    ...
    if (rangefinderHardware == RANGEFINDER_NONE) {
        ...
        return 
# 173 "./src/main/sensors/rangefinder.c" 3 4
              0
# 173 "./src/main/sensors/rangefinder.c"
                   ;
    }
    ...
    return 
# 178 "./src/main/sensors/rangefinder.c" 3 4
          1
# 178 "./src/main/sensors/rangefinder.c"
              ;
}


# 181 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 181 "./src/main/sensors/rangefinder.c"
    rangefinderInit(void)
{
...
# 184 "./src/main/sensors/rangefinder.c"
    ...
    return 
# 193 "./src/main/sensors/rangefinder.c" 3 4
          1
# 193 "./src/main/sensors/rangefinder.c"
              ;
}
...
#define DISTANCE_SAMPLES_MEDIAN 5
    ...
    static 
# 201 "./src/main/sensors/rangefinder.c" 3 4
          _Bool 
# 201 "./src/main/sensors/rangefinder.c"
               medianFilterReady = 
# 201 "./src/main/sensors/rangefinder.c" 3 4
                                   0
# 201 "./src/main/sensors/rangefinder.c"
    ...
    if (newReading > (-1)) {
        ...
        if (filterSampleIndex == 5) {
            filterSampleIndex = 0;
            medianFilterReady = 
# 208 "./src/main/sensors/rangefinder.c" 3 4
                               1
# 208 "./src/main/sensors/rangefinder.c"
                                   ;
        }
    }
...
# 229 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 229 "./src/main/sensors/rangefinder.c"
    rangefinderProcess(float cosTiltAngle)
{
...
# 236 "./src/main/sensors/rangefinder.c"
    ...
    return 
# 273 "./src/main/sensors/rangefinder.c" 3 4
          1
# 273 "./src/main/sensors/rangefinder.c"
              ;
}
...
# 289 "./src/main/sensors/rangefinder.c" 3 4
_Bool 
# 289 "./src/main/sensors/rangefinder.c"
    rangefinderIsHealthy(void)
{
