...
# 1 "./src/main/drivers/accgyro/accgyro_icm20689.h" 1
# 21 "./src/main/drivers/accgyro/accgyro_icm20689.h"
...
# 260 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 260 "./src/main/sensors/gyro.c"
    gyroInit(void)
{
    ...
    if (gyroDetect(&gyroDev0, GYRO_AUTODETECT) == GYRO_NONE) {
        return 
# 272 "./src/main/sensors/gyro.c" 3 4
              0
# 272 "./src/main/sensors/gyro.c"
                   ;
    }
    ...
    gyroInitFilters();
    return 
# 289 "./src/main/sensors/gyro.c" 3 4
          1
# 289 "./src/main/sensors/gyro.c"
              ;
}
...
static 
# 352 "./src/main/sensors/gyro.c" 3 4
                  _Bool 
# 352 "./src/main/sensors/gyro.c"
...
# 357 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 357 "./src/main/sensors/gyro.c"
    gyroIsCalibrationComplete(void)
{
    return gyroCalibration.calibratingG == 0;
}
...
static 
# 362 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 362 "./src/main/sensors/gyro.c"
...
static 
# 367 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 367 "./src/main/sensors/gyro.c"
...
static void performGyroCalibration(gyroDev_t *dev, gyroCalibration_t *gyroCalibration, uint8_t gyroMovementCalibrationThreshold)
{
    ...
    if (isOnFinalGyroCalibrationCycle(gyroCalibration)) {
        debugTracePrintf(
# 401 "./src/main/sensors/gyro.c" 3 4
       1
# 401 "./src/main/sensors/gyro.c"
...
{
    for (int axis = 0; axis < 3; axis++) {
        measuredRotationRate->v[axis] = ((gyro.gyroADCf[axis]) * (3.14159265358979323846f / 180.0f));
    }
}
...
# 473 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 473 "./src/main/sensors/gyro.c"
    gyroReadTemperature(void)
{
    ...
    return 
# 480 "./src/main/sensors/gyro.c" 3 4
          0
# 480 "./src/main/sensors/gyro.c"
               ;
}
    ...
    gyroSyncCheckUpdate(void)
{
    if (!gyroDev0.intStatusFn)
        return 
# 496 "./src/main/sensors/gyro.c" 3 4
              0
# 496 "./src/main/sensors/gyro.c"
                   ;
