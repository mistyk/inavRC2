...
# 1 "./src/main/target/REVO/target.h" 1
# 18 "./src/main/target/REVO/target.h"
...
# 1 "./obj/main/REVO/settings_generated.h" 1
...
const featureConfig_t pgResetTemplate_featureConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .enabledFeatures = (FEATURE_TX_PROF_SEL | FEATURE_BLACKBOX) | (FEATURE_TX_PROF_SEL) }
...
# 267 "./src/main/fc/config.c"
    ...
    case PWM_TYPE_DSHOT150:
        motorConfigMutable()->motorPwmRate = ( __extension__ ({ __typeof__(motorConfig()->motorPwmRate) _left6 = (motorConfig()->motorPwmRate); __typeof__(4000) _right7 = (4000); _left6 < _right7 ? _left6 : _right7; }));
        break;
    case PWM_TYPE_DSHOT300:
        motorConfigMutable()->motorPwmRate = ( __extension__ ({ __typeof__(motorConfig()->motorPwmRate) _left8 = (motorConfig()->motorPwmRate); __typeof__(8000) _right9 = (8000); _left8 < _right9 ? _left8 : _right9; }));
        break;


    case PWM_TYPE_DSHOT600:
        motorConfigMutable()->motorPwmRate = ( __extension__ ({ __typeof__(motorConfig()->motorPwmRate) _left10 = (motorConfig()->motorPwmRate); __typeof__(16000) _right11 = (16000); _left10 < _right11 ? _left10 : _right11; }));
        break;
    case PWM_TYPE_DSHOT1200:
        motorConfigMutable()->motorPwmRate = ( __extension__ ({ __typeof__(motorConfig()->motorPwmRate) _left12 = (motorConfig()->motorPwmRate); __typeof__(32000) _right13 = (32000); _left12 < _right13 ? _left12 : _right13; }));
        break;
