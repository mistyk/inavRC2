...
# 1 "./src/main/fc/rc_smoothing.h" 1
# 25 "./src/main/fc/rc_smoothing.h"
...
# 31 "./src/main/fc/rc_smoothing.h" 3 4
                         _Bool 
# 31 "./src/main/fc/rc_smoothing.h"
                              isRXDataNew);
...
typedef enum {
    ...
    TASK_PWMDRIVER,
# 99 "./src/main/scheduler/scheduler.h"
    TASK_CMS,
...
# 125 "./src/main/scheduler/scheduler.h" 3 4
   _Bool 
# 125 "./src/main/scheduler/scheduler.h"
...
# 151 "./src/main/scheduler/scheduler.h" 3 4
                                      _Bool 
# 151 "./src/main/scheduler/scheduler.h"
                                           newEnabledState);
...
# 107 "./src/main/fc/fc_core.c" 3 4
                            0
# 107 "./src/main/fc/fc_core.c"
                                 ;
...
# 114 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 114 "./src/main/fc/fc_core.c"
    isCalibrating(void)
{

    if (sensors(SENSOR_BARO) && !baroIsCalibrationComplete()) {
        return 
# 118 "./src/main/fc/fc_core.c" 3 4
              1
# 118 "./src/main/fc/fc_core.c"
                  ;
    }
    ...
    if (sensors(SENSOR_PITOT) && !pitotIsCalibrationComplete()) {
        return 
# 124 "./src/main/fc/fc_core.c" 3 4
              1
# 124 "./src/main/fc/fc_core.c"
                  ;
    }
...
# 130 "./src/main/fc/fc_core.c"
    ...
    if (!accIsCalibrationComplete() && sensors(SENSOR_ACC)) {
        return 
# 135 "./src/main/fc/fc_core.c" 3 4
              1
# 135 "./src/main/fc/fc_core.c"
                  ;
    }
...
# 139 "./src/main/fc/fc_core.c"
    ...
    return 
# 142 "./src/main/fc/fc_core.c" 3 4
          0
# 142 "./src/main/fc/fc_core.c"
               ;
}
...
# 161 "./src/main/fc/fc_core.c"
        ...
        if (isCalibrating()) {
            ...
            calibratingFinishedBeep = 
# 164 "./src/main/fc/fc_core.c" 3 4
                                     0
# 164 "./src/main/fc/fc_core.c"
                                          ;
        }
        else {
            (armingFlags &= ~(ARMING_DISABLED_SENSORS_CALIBRATING));
            ...
            if (!calibratingFinishedBeep) {
                calibratingFinishedBeep = 
# 170 "./src/main/fc/fc_core.c" 3 4
                                         1
# 170 "./src/main/fc/fc_core.c"
                                             ;
...
# 457 "./src/main/fc/fc_core.c"
                    ...
                    beeper(BEEPER_ARMED);
                    armedBeeperOn = 
# 461 "./src/main/fc/fc_core.c" 3 4
                                   1
# 461 "./src/main/fc/fc_core.c"
                                       ;
                }
            } else {
                ...
                if (armedBeeperOn) {
                    beeperSilence();
                    armedBeeperOn = 
# 472 "./src/main/fc/fc_core.c" 3 4
                                   0
# 472 "./src/main/fc/fc_core.c"
                                        ;
                }
            }
        } else {
            ...
            if (throttleStatus == THROTTLE_LOW) {
                beeper(BEEPER_ARMED);
                armedBeeperOn = 
# 479 "./src/main/fc/fc_core.c" 3 4
                               1
# 479 "./src/main/fc/fc_core.c"
                                   ;
            } else if (armedBeeperOn) {
                beeperSilence();
                armedBeeperOn = 
# 482 "./src/main/fc/fc_core.c" 3 4
                               0
# 482 "./src/main/fc/fc_core.c"
                                    ;
            }
        }
    }
...
# 496 "./src/main/fc/fc_core.c" 3 4
       _Bool 
# 496 "./src/main/fc/fc_core.c"
...
# 501 "./src/main/fc/fc_core.c" 3 4
   _Bool 
# 501 "./src/main/fc/fc_core.c"
        canUseHorizonMode = 
# 501 "./src/main/fc/fc_core.c" 3 4
                            1
# 501 "./src/main/fc/fc_core.c"
...
# 505 "./src/main/fc/fc_core.c"
    ...
    if ((flightModeFlags & (ANGLE_MODE)) || (flightModeFlags & (HORIZON_MODE))) {
        ledSet(1, 
# 526 "./src/main/fc/fc_core.c" 3 4
       1
# 526 "./src/main/fc/fc_core.c"
       );
    } else {
        ledSet(1, 
...
void taskGyro(timeUs_t currentTimeUs) {
    ...
    if (gyroConfig()->gyroSync) {
        while (
# 647 "./src/main/fc/fc_core.c" 3 4
              1
# 647 "./src/main/fc/fc_core.c"
                  ) {
            gyroUpdateUs = micros();
            if (gyroSyncCheckUpdate() || ((currentDeltaTime + cmpTimeUs(gyroUpdateUs, currentTimeUs)) >= (timeDelta_t)(getLooptime() + 100))) {
                break;
            }
        }
    }
...
void taskMainPidLoop(timeUs_t currentTimeUs)
{
    ...
    if ((armingFlags & (ARMED)) && (!(stateFlags & (FIXED_WING)) || !isNavLaunchEnabled() || (isNavLaunchEnabled() && (isFixedWingLaunchDetected() || isFixedWingLaunchFinishedOrAborted())))) {
    ...
    isRXDataNew = 
# 700 "./src/main/fc/fc_core.c" 3 4
                 0
# 700 "./src/main/fc/fc_core.c"
                      ;
...
# 791 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 791 "./src/main/fc/fc_core.c"
...
void taskUpdateRxMain(timeUs_t currentTimeUs)
{
    ...
    isRXDataNew = 
# 801 "./src/main/fc/fc_core.c" 3 4
                 1
# 801 "./src/main/fc/fc_core.c"
                     ;
}
...
void fcReboot(
# 810 "./src/main/fc/fc_core.c" 3 4
             _Bool 
# 810 "./src/main/fc/fc_core.c"
                  bootLoader)
{
    ...
    while (
# 826 "./src/main/fc/fc_core.c" 3 4
          1
# 826 "./src/main/fc/fc_core.c"
              );
}
