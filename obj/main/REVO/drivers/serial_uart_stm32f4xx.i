...
static uartDevice_t uart1 =
{
    ...
    .irq = USART1_IRQn,
    .irqPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)
};
# 84 "./src/main/drivers/serial_uart_stm32f4xx.c"
static uartDevice_t uart3 =
{
    ...
    .irq = USART3_IRQn,
    .irqPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)
};
# 132 "./src/main/drivers/serial_uart_stm32f4xx.c"
...
# 173 "./src/main/drivers/serial_uart_stm32f4xx.c"
...
# 182 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
   ((void *)0)
# 182 "./src/main/drivers/serial_uart_stm32f4xx.c"
       ,
...
# 192 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
   ((void *)0)
# 192 "./src/main/drivers/serial_uart_stm32f4xx.c"
       ,
...
# 197 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
   ((void *)0)
# 197 "./src/main/drivers/serial_uart_stm32f4xx.c"
       ,
...
# 212 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
   ((void *)0)
# 212 "./src/main/drivers/serial_uart_stm32f4xx.c"
       ,
...
{
    if (USART_GetITStatus(s->USARTx, ((uint16_t)0x0525)) == SET) {
    ...
    if (USART_GetITStatus(s->USARTx, ((uint16_t)0x0727)) == SET) {
...
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_t mode, portOptions_t options)
{
    ...
    if (!uart) return 
# 248 "./src/main/drivers/serial_uart_stm32f4xx.c" 3 4
                     ((void *)0)
# 248 "./src/main/drivers/serial_uart_stm32f4xx.c"
                         ;
    ...
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = (((uart->irqPriority)>>(4-(7-(((uint32_t)0x500)>>8))))>>4);
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = (((uart->irqPriority)&(0x0f>>(7-(((uint32_t)0x500)>>8))))>>4);
...
# 333 "./src/main/drivers/serial_uart_stm32f4xx.c"
uartPort_t *serialUART3(uint32_t baudRate, portMode_t mode, portOptions_t options)
{
...
# 375 "./src/main/drivers/serial_uart_stm32f4xx.c"
uartPort_t *serialUART6(uint32_t baudRate, portMode_t mode, portOptions_t options)
{
