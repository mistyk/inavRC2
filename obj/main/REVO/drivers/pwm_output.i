...
# 39 "./src/main/drivers/pwm_output.c" 2
...
# 40 "./src/main/drivers/pwm_output.c" 2
...
# 63 "./src/main/drivers/pwm_output.c"
    ...
    uint32_t dmaBuffer[18] __attribute__ ((aligned (4)));

} pwmOutputPort_t;

static pwmOutputPort_t pwmOutputPorts[10];
...
static 
# 84 "./src/main/drivers/pwm_output.c" 3 4
      _Bool 
# 84 "./src/main/drivers/pwm_output.c"
           isProtocolDshot = 
# 84 "./src/main/drivers/pwm_output.c" 3 4
                             0
# 84 "./src/main/drivers/pwm_output.c"
...
# 95 "./src/main/drivers/pwm_output.c"
static uint8_t allocatedOutputPortCount = 0;

static 
# 97 "./src/main/drivers/pwm_output.c" 3 4
      _Bool 
# 97 "./src/main/drivers/pwm_output.c"
           pwmMotorsEnabled = 
# 97 "./src/main/drivers/pwm_output.c" 3 4
                              1
# 97 "./src/main/drivers/pwm_output.c"
...
static pwmOutputPort_t *pwmOutConfigMotor(const timerHardware_t *timHw, uint32_t hz, uint16_t period, uint16_t value, 
# 113 "./src/main/drivers/pwm_output.c" 3 4
                                                                                                                     _Bool 
# 113 "./src/main/drivers/pwm_output.c"
                                                                                                                          enableOutput)
{
    if (allocatedOutputPortCount >= 10) {
        debugTracePrintf(
# 116 "./src/main/drivers/pwm_output.c" 3 4
       0
# 116 "./src/main/drivers/pwm_output.c"
       , "Attempt to allocate PWM output beyond MAX_PWM_OUTPUT_PORTS");
        return 
# 117 "./src/main/drivers/pwm_output.c" 3 4
              ((void *)0)
# 117 "./src/main/drivers/pwm_output.c"
                  ;
    }
    ...
    if (tch == 
# 122 "./src/main/drivers/pwm_output.c" 3 4
              ((void *)0)
# 122 "./src/main/drivers/pwm_output.c"
                  ) {
        return 
# 123 "./src/main/drivers/pwm_output.c" 3 4
              ((void *)0)
# 123 "./src/main/drivers/pwm_output.c"
                  ;
    }
    ...
    if (enableOutput) {
        IOConfigGPIOAF(io, ((GPIO_Mode_AF) | ((0) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), timHw->alternateFunction);
    }
    else {
...
{
    pwmMotorsEnabled = 
# 166 "./src/main/drivers/pwm_output.c" 3 4
                      0
# 166 "./src/main/drivers/pwm_output.c"
                           ;
}
...
{
    pwmMotorsEnabled = 
# 171 "./src/main/drivers/pwm_output.c" 3 4
                      1
# 171 "./src/main/drivers/pwm_output.c"
                          ;
}


# 174 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 174 "./src/main/drivers/pwm_output.c"
    isMotorBrushed(uint16_t motorPwmRateHz)
{
    return (motorPwmRateHz > 500);
}

static pwmOutputPort_t * motorConfigPwm(const timerHardware_t *timerHardware, float sMin, float sLen, uint32_t motorPwmRateHz, 
                                                                                                                                   ...
                                                                                                                                   enableOutput)
{
    ...
    const uint32_t prescaler = ((baseClockHz / motorPwmRateHz) + 0xffff) / 0x10000;
    ...
    if (port) {
        ...
        port->configured = 
# 191 "./src/main/drivers/pwm_output.c" 3 4
                          1
# 191 "./src/main/drivers/pwm_output.c"
                              ;
    }
                                                                                                                                             ...
                                                                                                                                             enableOutput)
{
    ...
    pwmOutputPort_t * port = pwmOutConfigMotor(timerHardware, getDshotHz(proto), 19, 0, enableOutput);
...
# 219 "./src/main/drivers/pwm_output.c"
    ...
    dshotMotorUpdateIntervalUs = ( __extension__ ({ __typeof__(dshotMotorUpdateIntervalUs) _left0 = (dshotMotorUpdateIntervalUs); __typeof__(motorIntervalUs) _right1 = (motorIntervalUs); _left0 > _right1 ? _left0 : _right1; }));


    if (timerPWMConfigChannelDMA(port->tch, port->dmaBuffer, 18)) {

        memset(port->dmaBuffer, 0, sizeof(port->dmaBuffer));
        port->configured = 
# 230 "./src/main/drivers/pwm_output.c" 3 4
                          1
# 230 "./src/main/drivers/pwm_output.c"
                              ;
    }
...
{
    for (int i = 0; i < 16; i++) {
        dmaBuffer[i] = (packet & 0x8000) ? 14 : 7;
        packet <<= 1;
    }
}

static uint16_t prepareDshotPacket(const uint16_t value, 
# 250 "./src/main/drivers/pwm_output.c" 3 4
                                                        _Bool 
# 250 "./src/main/drivers/pwm_output.c"
                                                             requestTelemetry)
{
...
void pwmCompleteDshotUpdate(uint8_t motorCount)
{
    ...
    for (int index = 0; index < motorCount; index++) {
        if (motors[index] && motors[index]->configured) {
            ...
            uint16_t packet = prepareDshotPacket(motors[index]->value, 
...
# 285 "./src/main/drivers/pwm_output.c"
            ...
            timerPWMPrepareDMA(motors[index]->tch, 18);
        }
    }
...
# 300 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 300 "./src/main/drivers/pwm_output.c"
    isMotorProtocolDshot(void)
{
...
# 306 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 306 "./src/main/drivers/pwm_output.c"
    pwmMotorConfig(const timerHardware_t *timerHardware, uint8_t motorIndex, uint16_t motorPwmRateHz, motorPwmProtocolTypes_e proto, 
# 306 "./src/main/drivers/pwm_output.c" 3 4
                                                                                                                                     _Bool 
# 306 "./src/main/drivers/pwm_output.c"
                                                                                                                                          enableOutput)
...
# 308 "./src/main/drivers/pwm_output.c" 3 4
                            ((void *)0)
# 308 "./src/main/drivers/pwm_output.c"
                                ;
    pwmWriteFuncPtr pwmWritePtr;
    ...
    case PWM_TYPE_DSHOT150:
        ...
        if (port) {
            isProtocolDshot = 
# 342 "./src/main/drivers/pwm_output.c" 3 4
                             1
# 342 "./src/main/drivers/pwm_output.c"
                                 ;
    ...
    if (port) {
        ...
        return 
# 358 "./src/main/drivers/pwm_output.c" 3 4
              1
# 358 "./src/main/drivers/pwm_output.c"
                  ;
    }

    return 
# 361 "./src/main/drivers/pwm_output.c" 3 4
          0
# 361 "./src/main/drivers/pwm_output.c"
               ;
}


# 364 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 364 "./src/main/drivers/pwm_output.c"
...
# 364 "./src/main/drivers/pwm_output.c"
                                                                                                                                    enableOutput)
{
    pwmOutputPort_t * port = pwmOutConfigMotor(timerHardware, 1000000, 1000000 / servoPwmRate, servoCenterPulse, enableOutput);

    if (port) {
        servos[servoIndex] = port;
        return 
# 370 "./src/main/drivers/pwm_output.c" 3 4
              1
# 370 "./src/main/drivers/pwm_output.c"
                  ;
    }

    return 
# 373 "./src/main/drivers/pwm_output.c" 3 4
          0
# 373 "./src/main/drivers/pwm_output.c"
               ;
}
