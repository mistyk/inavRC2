...
# 114 "./src/main/drivers/bus_spi.c"
...
static spiDevice_t spiHardwareMap[] = {
    { .dev = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)), .nss = ((((0) + 1) << 4) | (4)), .sck = ((((0) + 1) << 4) | (5)), .miso = ((((0) + 1) << 4) | (6)), .mosi = ((((0) + 1) << 4) | (7)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00001000))>65535L) + (8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L)) >>8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L)) >>8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x05), .leadingEdge = 
# 131 "./src/main/drivers/bus_spi.c" 3 4
                                                                                                                                                                                                    0
# 131 "./src/main/drivers/bus_spi.c"
                                                                                                                                                                                                                     , .divisorMap = spiDivisorMapFast },
    { .dev = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), .nss = ((((1) + 1) << 4) | (12)), .sck = ((((1) + 1) << 4) | (13)), .miso = ((((1) + 1) << 4) | (14)), .mosi = ((((1) + 1) << 4) | (15)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00004000))>65535L) + (8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x05), .leadingEdge = 
# 132 "./src/main/drivers/bus_spi.c" 3 4
                                                                                                                                                                                                    0
# 132 "./src/main/drivers/bus_spi.c"
                                                                                                                                                                                                                     , .divisorMap = spiDivisorMapSlow },
    { .dev = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)), .nss = ((((1) + 1) << 4) | (3)), .sck = ((((2) + 1) << 4) | (10)), .miso = ((((2) + 1) << 4) | (11)), .mosi = ((((2) + 1) << 4) | (12)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00008000))>65535L) + (8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L)) >>8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L)) >>8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x06), .leadingEdge = 
# 133 "./src/main/drivers/bus_spi.c" 3 4
                                                                                                                                                                                                    0
# 133 "./src/main/drivers/bus_spi.c"
                                                                                                                                                                                                                     , .divisorMap = spiDivisorMapSlow }
};
...
# 217 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 217 "./src/main/drivers/bus_spi.c"
    spiInit(SPIDevice device)
{
    switch (device) {
    case SPIINVALID:
        return 
# 221 "./src/main/drivers/bus_spi.c" 3 4
              0
# 221 "./src/main/drivers/bus_spi.c"
                   ;
    case SPIDEV_1:

        spiInitDevice(device);
        return 
# 225 "./src/main/drivers/bus_spi.c" 3 4
              1
# 225 "./src/main/drivers/bus_spi.c"
                  ;
    ...
    case SPIDEV_3:
        ...
        spiInitDevice(device);
        return 
# 239 "./src/main/drivers/bus_spi.c" 3 4
              1
# 239 "./src/main/drivers/bus_spi.c"
                  ;
    ...
    return 
# 251 "./src/main/drivers/bus_spi.c" 3 4
          0
# 251 "./src/main/drivers/bus_spi.c"
               ;
}
...
# 293 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 293 "./src/main/drivers/bus_spi.c"
    spiIsBusBusy(SPI_TypeDef *instance)
{
...
# 303 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 303 "./src/main/drivers/bus_spi.c"
    spiTransfer(SPI_TypeDef *instance, uint8_t *out, const uint8_t *in, int len)
{
    ...
    return 
# 333 "./src/main/drivers/bus_spi.c" 3 4
          1
# 333 "./src/main/drivers/bus_spi.c"
              ;
}
