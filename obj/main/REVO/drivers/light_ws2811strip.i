...
# 45 "./src/main/drivers/light_ws2811strip.c" 2

static uint32_t ledStripDMABuffer[((24 * 32) + 42)];
static IO_t ws2811IO = ((IO_t)0);
static TCH_t * ws2811TCH = 
# 48 "./src/main/drivers/light_ws2811strip.c" 3 4
                          ((void *)0)
# 48 "./src/main/drivers/light_ws2811strip.c"
                              ;
static 
# 49 "./src/main/drivers/light_ws2811strip.c" 3 4
      _Bool 
# 49 "./src/main/drivers/light_ws2811strip.c"
           ws2811Initialised = 
# 49 "./src/main/drivers/light_ws2811strip.c" 3 4
                               0
# 49 "./src/main/drivers/light_ws2811strip.c"
...
void ws2811LedStripInit(void)
{
    const timerHardware_t * timHw = timerGetByTag(((((0) + 1) << 4) | (1)), TIM_USE_ANY);

    if (timHw == 
# 96 "./src/main/drivers/light_ws2811strip.c" 3 4
                ((void *)0)
# 96 "./src/main/drivers/light_ws2811strip.c"
                    ) {
        return;
    }
...
# 101 "./src/main/drivers/light_ws2811strip.c"
    ...
    uint16_t period = 24000000 / 800000;

    BIT_COMPARE_1 = period * 2 / 3;
    BIT_COMPARE_0 = period / 3;

    ws2811IO = IOGetByTag(((((0) + 1) << 4) | (1)));
    IOInit(ws2811IO, OWNER_LED_STRIP, RESOURCE_OUTPUT, 0);
    IOConfigGPIOAF(ws2811IO, ((GPIO_Mode_AF) | ((GPIO_Fast_Speed) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_DOWN) << 5)), timHw->alternateFunction);

    timerConfigBase(ws2811TCH, period, 24000000);
    timerPWMConfigChannel(ws2811TCH, 0);


    if (!timerPWMConfigChannelDMA(ws2811TCH, ledStripDMABuffer, ((24 * 32) + 42))) {
        ws2811Initialised = 
# 120 "./src/main/drivers/light_ws2811strip.c" 3 4
                           0
# 120 "./src/main/drivers/light_ws2811strip.c"
                                ;
        return;
    }
    ...
    ws2811Initialised = 
# 126 "./src/main/drivers/light_ws2811strip.c" 3 4
                       1
# 126 "./src/main/drivers/light_ws2811strip.c"
                           ;
...
# 131 "./src/main/drivers/light_ws2811strip.c" 3 4
_Bool 
# 131 "./src/main/drivers/light_ws2811strip.c"
    isWS2811LedStripReady(void)
{
...
void ws2811UpdateStrip(void)
{
    ...
    timerPWMPrepareDMA(ws2811TCH, ((24 * 32) + 42));
