...
# 222 "./src/main/target/common_hardware.c"
#define VL53L0X_I2C_BUS RANGEFINDER_I2C_BUS



    extern const busDeviceDescriptor_t busdev_vl53l0x_registry; static busDevice_t busdev_vl53l0x_memory; const busDeviceDescriptor_t busdev_vl53l0x_registry __attribute__ ((section(".busdev_registry"), used, aligned(4))) = { .devicePtr = (void *) & busdev_vl53l0x_memory, .busType = BUSTYPE_I2C, .devHwType = DEVHW_VL53L0X, .flags = DEVFLAGS_NONE, .tag = 0, .busdev.i2c = { .i2cBus = I2CDEV_2, .address = 0x29 }, .irqPin = 0 }; struct _dummy;
