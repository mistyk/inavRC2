...
typedef 
# 23 "./src/main/drivers/pitotmeter.h" 3 4
       _Bool 
# 23 "./src/main/drivers/pitotmeter.h"
            (*pitotOpFuncPtr)(struct pitotDev_s * pitot);
...
# 24 "./src/main/sensors/pitotmeter.h" 2
...
# 53 "./src/main/sensors/pitotmeter.h" 3 4
   _Bool 
# 53 "./src/main/sensors/pitotmeter.h"
        calibrationFinished;
...
# 63 "./src/main/sensors/pitotmeter.h" 3 4
_Bool 
# 63 "./src/main/sensors/pitotmeter.h"
    pitotInit(void);

# 64 "./src/main/sensors/pitotmeter.h" 3 4
_Bool 
# 64 "./src/main/sensors/pitotmeter.h"
    pitotIsCalibrationComplete(void);
void pitotStartCalibration(void);
void pitotUpdate(void);
int32_t pitotCalculateAirSpeed(void);

# 68 "./src/main/sensors/pitotmeter.h" 3 4
_Bool 
# 68 "./src/main/sensors/pitotmeter.h"
    pitotIsHealthy(void);
...
# 93 "./src/main/blackbox/blackbox.c"
...
const blackboxConfig_t pgResetTemplate_blackboxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .device = BLACKBOX_DEVICE_FLASH, .rate_num = 1, .rate_denom = 1, .invertedCardDetection = 0, }
...
static const blackboxDeltaFieldDefinition_t blackboxMainFields[] = {
    ...
    {"debug", 4, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_AVERAGE_2, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_DEBUG},
    {"debug", 5, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_AVERAGE_2, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_DEBUG},
    {"debug", 6, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_AVERAGE_2, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_DEBUG},
    {"debug", 7, FLIGHT_LOG_FIELD_SIGNED, .Ipredict = FLIGHT_LOG_FIELD_PREDICTOR_0, .Iencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, .Ppredict = FLIGHT_LOG_FIELD_PREDICTOR_AVERAGE_2, .Pencode = FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_DEBUG},
...
static const blackboxConditionalFieldDefinition_t blackboxGpsGFields[] = {
    ...
    {"GPS_velned", 0, FLIGHT_LOG_FIELD_SIGNED, FLIGHT_LOG_FIELD_PREDICTOR_0, FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_ALWAYS},
    {"GPS_velned", 1, FLIGHT_LOG_FIELD_SIGNED, FLIGHT_LOG_FIELD_PREDICTOR_0, FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_ALWAYS},
    {"GPS_velned", 2, FLIGHT_LOG_FIELD_SIGNED, FLIGHT_LOG_FIELD_PREDICTOR_0, FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB, FLIGHT_LOG_FIELD_CONDITION_ALWAYS}
};
...
static const blackboxSimpleFieldDefinition_t blackboxSlowFields[] = {
    ...
    {"temperature", -1, FLIGHT_LOG_FIELD_SIGNED, FLIGHT_LOG_FIELD_PREDICTOR_0, FLIGHT_LOG_FIELD_ENCODING_SIGNED_VB},
    {"temperatureSource", -1, FLIGHT_LOG_FIELD_UNSIGNED, FLIGHT_LOG_FIELD_PREDICTOR_0, FLIGHT_LOG_FIELD_ENCODING_UNSIGNED_VB},
};
...
# 450 "./src/main/blackbox/blackbox.c" 3 4
   _Bool 
# 450 "./src/main/blackbox/blackbox.c"
        rxSignalReceived;
    
# 451 "./src/main/blackbox/blackbox.c" 3 4
   _Bool 
# 451 "./src/main/blackbox/blackbox.c"
...
static 
# 508 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 508 "./src/main/blackbox/blackbox.c"
...
# 513 "./src/main/blackbox/blackbox.c" 3 4
_Bool 
# 513 "./src/main/blackbox/blackbox.c"
    blackboxMayEditConfig(void)
{
...
static 
# 518 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 518 "./src/main/blackbox/blackbox.c"
...
static 
# 523 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 523 "./src/main/blackbox/blackbox.c"
           testBlackboxConditionUncached(FlightLogFieldCondition condition)
{
    switch (condition) {
    case FLIGHT_LOG_FIELD_CONDITION_ALWAYS:
        return 
# 527 "./src/main/blackbox/blackbox.c" 3 4
              1
# 527 "./src/main/blackbox/blackbox.c"
                  ;
    ...
    case FLIGHT_LOG_FIELD_CONDITION_NEVER:
        return 
# 605 "./src/main/blackbox/blackbox.c" 3 4
              0
# 605 "./src/main/blackbox/blackbox.c"
                   ;

    default:
        return 
# 608 "./src/main/blackbox/blackbox.c" 3 4
              0
# 608 "./src/main/blackbox/blackbox.c"
                   ;
    }
}
...
static 
# 622 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 622 "./src/main/blackbox/blackbox.c"
...
static void blackboxSetState(BlackboxState newState)
{
    ...
    case BLACKBOX_STATE_PREPARE_LOG_FILE:
        blackboxLoggedAnyFrames = 
# 632 "./src/main/blackbox/blackbox.c" 3 4
                                 0
# 632 "./src/main/blackbox/blackbox.c"
                                      ;
        break;
...
static void writeIntraframe(void)
{
    ...
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_DEBUG)) {
        blackboxWriteSignedVBArray(blackboxCurrent->debug, 8);
    }
    ...
    blackboxLoggedAnyFrames = 
# 818 "./src/main/blackbox/blackbox.c" 3 4
                             1
# 818 "./src/main/blackbox/blackbox.c"
                                 ;
}
...
# 969 "./src/main/blackbox/blackbox.c" 3 4
                                                    __builtin_offsetof (
# 969 "./src/main/blackbox/blackbox.c"
                                                    blackboxMainState_t
# 969 "./src/main/blackbox/blackbox.c" 3 4
                                                    , 
# 969 "./src/main/blackbox/blackbox.c"
...
# 969 "./src/main/blackbox/blackbox.c"
                                                                                          , 3);
    blackboxWriteMainStateArrayUsingAveragePredictor(
# 970 "./src/main/blackbox/blackbox.c" 3 4
                                                    __builtin_offsetof (
# 970 "./src/main/blackbox/blackbox.c"
                                                    blackboxMainState_t
# 970 "./src/main/blackbox/blackbox.c" 3 4
                                                    , 
# 970 "./src/main/blackbox/blackbox.c"
...
# 970 "./src/main/blackbox/blackbox.c"
                                                                                         , 3);
    blackboxWriteMainStateArrayUsingAveragePredictor(
# 971 "./src/main/blackbox/blackbox.c" 3 4
                                                    __builtin_offsetof (
# 971 "./src/main/blackbox/blackbox.c"
                                                    blackboxMainState_t
# 971 "./src/main/blackbox/blackbox.c" 3 4
                                                    , 
# 971 "./src/main/blackbox/blackbox.c"
...
# 971 "./src/main/blackbox/blackbox.c"
    ...
    if (testBlackboxCondition(FLIGHT_LOG_FIELD_CONDITION_DEBUG)) {
        blackboxWriteMainStateArrayUsingAveragePredictor(
# 973 "./src/main/blackbox/blackbox.c" 3 4
                                                        __builtin_offsetof (
# 973 "./src/main/blackbox/blackbox.c"
                                                        blackboxMainState_t
# 973 "./src/main/blackbox/blackbox.c" 3 4
                                                        , 
# 973 "./src/main/blackbox/blackbox.c"
...
# 973 "./src/main/blackbox/blackbox.c"
    ...
    blackboxWriteMainStateArrayUsingAveragePredictor(
# 975 "./src/main/blackbox/blackbox.c" 3 4
                                                    __builtin_offsetof (
# 975 "./src/main/blackbox/blackbox.c"
                                                    blackboxMainState_t
# 975 "./src/main/blackbox/blackbox.c" 3 4
                                                    , 
# 975 "./src/main/blackbox/blackbox.c"
...
# 975 "./src/main/blackbox/blackbox.c"
    ...
    blackboxLoggedAnyFrames = 
# 1016 "./src/main/blackbox/blackbox.c" 3 4
                             1
# 1016 "./src/main/blackbox/blackbox.c"
                                 ;
}
...
static 
# 1091 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 1091 "./src/main/blackbox/blackbox.c"
...
# 1094 "./src/main/blackbox/blackbox.c" 3 4
   _Bool 
# 1094 "./src/main/blackbox/blackbox.c"
    ...
    if (shouldWrite) {
        ...
        if (memcmp(&newSlowState, &slowHistory, sizeof(slowHistory)) != 0) {
            ...
            shouldWrite = 
# 1107 "./src/main/blackbox/blackbox.c" 3 4
                         1
# 1107 "./src/main/blackbox/blackbox.c"
                             ;
        }
    }
...
# 1188 "./src/main/blackbox/blackbox.c"
...
# 1218 "./src/main/blackbox/blackbox.c" 3 4
                                                  ((void *)0)
# 1218 "./src/main/blackbox/blackbox.c"
                                                      );
...
static void writeGPSFrame(timeUs_t currentTimeUs)
{
    ...
    blackboxWriteSigned16VBArray(gpsSol.velNED, 3);
...
# 1407 "./src/main/blackbox/blackbox.c"
static 
# 1407 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 1407 "./src/main/blackbox/blackbox.c"
        ...
        const void *secondFieldDefinition, int fieldCount, const uint8_t *conditions, const uint8_t *secondCondition)
{
    ...
    static 
# 1412 "./src/main/blackbox/blackbox.c" 3 4
          _Bool 
# 1412 "./src/main/blackbox/blackbox.c"
               needComma = 
# 1412 "./src/main/blackbox/blackbox.c" 3 4
                           0
# 1412 "./src/main/blackbox/blackbox.c"
    ...
    if (xmitState.u.fieldIndex == -1) {
        if (xmitState.headerIndex >= headerCount) {
            return 
# 1430 "./src/main/blackbox/blackbox.c" 3 4
                  0
# 1430 "./src/main/blackbox/blackbox.c"
                       ;
        }
        ...
        if (blackboxDeviceReserveBufferSpace(charsToBeWritten) != BLACKBOX_RESERVE_SUCCESS) {
            return 
# 1436 "./src/main/blackbox/blackbox.c" 3 4
                  1
# 1436 "./src/main/blackbox/blackbox.c"
        ...
        needComma = 
# 1442 "./src/main/blackbox/blackbox.c" 3 4
                   0
# 1442 "./src/main/blackbox/blackbox.c"
                        ;
    }
    ...
    for (; xmitState.u.fieldIndex < fieldCount; xmitState.u.fieldIndex++) {
        ...
        if (!conditions || testBlackboxCondition(conditions[conditionsStride * xmitState.u.fieldIndex])) {
            ...
            if (blackboxDeviceReserveBufferSpace(bytesToWrite) != BLACKBOX_RESERVE_SUCCESS) {
                ...
                return 
# 1467 "./src/main/blackbox/blackbox.c" 3 4
                      1
# 1467 "./src/main/blackbox/blackbox.c"
                          ;
            }
            ...
            if (needComma) {
                ...
                needComma = 
# 1475 "./src/main/blackbox/blackbox.c" 3 4
                           1
# 1475 "./src/main/blackbox/blackbox.c"
                               ;
            }
...
# 1528 "./src/main/blackbox/blackbox.c"
static 
# 1528 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 1528 "./src/main/blackbox/blackbox.c"
           blackboxWriteSysinfo(void)
{
    ...
    if (blackboxDeviceReserveBufferSpace(64) != BLACKBOX_RESERVE_SUCCESS) {
        return 
# 1532 "./src/main/blackbox/blackbox.c" 3 4
              0
# 1532 "./src/main/blackbox/blackbox.c"
                   ;
    }
    ...
    switch (xmitState.headerIndex) {
        ...
        case 1: blackboxPrintfHeaderLine("Firmware revision", "INAV %s (%s) %s", "2" "." "1" "." "0", shortGitRevision, targetName); break;;
        ...
        case
            ...
            11
# 1550 "./src/main/blackbox/blackbox.c"
        ...
        case
                                                                                                                       ...
                                                                                                                       12
# 1557 "./src/main/blackbox/blackbox.c"
...
# 1562 "./src/main/blackbox/blackbox.c"
        ...
        case 15: blackboxPrintfHeaderLine("looptime", "%d", getLooptime()); break;;
        ...
        case
                                                                                                                            ...
                                                                                                                            23
# 1578 "./src/main/blackbox/blackbox.c"
        ...
        case
                                                                                                      ...
                                                                                                      24
# 1581 "./src/main/blackbox/blackbox.c"
...
# 1584 "./src/main/blackbox/blackbox.c"
        ...
        case
                                                                                                     ...
                                                                                                     26
# 1587 "./src/main/blackbox/blackbox.c"
        ...
        case
                                                                                                       ...
                                                                                                       27
# 1590 "./src/main/blackbox/blackbox.c"
...
# 1596 "./src/main/blackbox/blackbox.c"
        ...
        case
                                                                                                       ...
                                                                                                       30
# 1599 "./src/main/blackbox/blackbox.c"
        ...
        case
                                                                                                       ...
                                                                                                       32
# 1603 "./src/main/blackbox/blackbox.c"
...
# 1617 "./src/main/blackbox/blackbox.c"
        ...
        default:
            return 
# 1639 "./src/main/blackbox/blackbox.c" 3 4
                  1
# 1639 "./src/main/blackbox/blackbox.c"
                      ;
    }

    xmitState.headerIndex++;
    return 
# 1643 "./src/main/blackbox/blackbox.c" 3 4
          0
# 1643 "./src/main/blackbox/blackbox.c"
               ;
}
...
static 
# 1721 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 1721 "./src/main/blackbox/blackbox.c"
...
static 
# 1729 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 1729 "./src/main/blackbox/blackbox.c"
...
static void blackboxLogIteration(timeUs_t currentTimeUs)
{
    ...
    if (blackboxShouldLogIFrame()) {
        ...
        if (blackboxShouldLogPFrame(blackboxPFrameIndex)) {
            ...
            writeSlowFrameIfNeeded(
# 1769 "./src/main/blackbox/blackbox.c" 3 4
                                  1
# 1769 "./src/main/blackbox/blackbox.c"
                                      );
...
# 1853 "./src/main/blackbox/blackbox.c" 3 4
               ((void *)0)
# 1853 "./src/main/blackbox/blackbox.c"
                   , 
# 1853 "./src/main/blackbox/blackbox.c" 3 4
                     ((void *)0)
# 1853 "./src/main/blackbox/blackbox.c"
...
# 1868 "./src/main/blackbox/blackbox.c" 3 4
               ((void *)0)
# 1868 "./src/main/blackbox/blackbox.c"
                   , 
# 1868 "./src/main/blackbox/blackbox.c" 3 4
                     ((void *)0)
# 1868 "./src/main/blackbox/blackbox.c"
...
static 
# 1936 "./src/main/blackbox/blackbox.c" 3 4
      _Bool 
# 1936 "./src/main/blackbox/blackbox.c"
