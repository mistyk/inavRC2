...
const rxConfig_t pgResetTemplate_rxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .receiverType = RX_TYPE_SERIAL, .rcmap = {0, 1, 3, 2}, .halfDuplex = 0, .serialrx_provider = 0, .rx_spi_protocol = 0, .spektrum_sat_bind = 0, .serialrx_inverted = 0, .mincheck = 1100, .maxcheck = 1900, .rx_min_usec = 885, .rx_max_usec = 2115, .rssi_channel = 0, .rssiMin = 0, .rssiMax = 100, .sbusSyncInterval = 3000, .rcFilterFrequency = 50, }
