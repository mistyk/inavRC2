...
# 395 "./src/main/navigation/navigation_private.h"
    adjustMulticopterPositionFromRCInput(int16_t rcPitchAdjustment, int16_t rcRollAdjustment);
...
# 184 "./src/main/navigation/navigation.c" 3 4
                                   _Bool 
# 184 "./src/main/navigation/navigation.c"
                                        useTerrainFollowing);
...
# 197 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 197 "./src/main/navigation/navigation.c"
...
static 
# 831 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 831 "./src/main/navigation/navigation.c"
...
# 842 "./src/main/navigation/navigation.c" 3 4
                           0
# 842 "./src/main/navigation/navigation.c"
                                );
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_ALTHOLD_INITIALIZE(navigationFSMState_t previousState)
{
    ...
    const 
# 852 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 852 "./src/main/navigation/navigation.c"
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_POSHOLD_3D_INITIALIZE(navigationFSMState_t previousState)
{
    const navigationFSMStateFlags_t prevFlags = navGetStateFlags(previousState);
    const 
# 885 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 885 "./src/main/navigation/navigation.c"
              terrainFollowingToggled = (posControl.flags.isTerrainFollowEnabled != navTerrainFollowingRequested());
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_RTH_INITIALIZE(navigationFSMState_t previousState)
{
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE) || navConfig()->general.flags.rth_climb_ignore_emerg) {
        ...
        if ((prevFlags & NAV_CTL_ALT) == 0 || posControl.flags.isTerrainFollowEnabled) {
            ...
            resetAltitudeController(
# 1057 "./src/main/navigation/navigation.c" 3 4
                                   0
# 1057 "./src/main/navigation/navigation.c"
                                        );
            setupAltitudeController();
        }
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_RTH_CLIMB_TO_SAFE_ALT(navigationFSMState_t previousState)
{
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE) || !checkForPositionSensorTimeout() || navConfig()->general.flags.rth_climb_ignore_emerg) {
        const float rthAltitudeMargin = (stateFlags & (FIXED_WING)) ?
                ( __extension__ ({ __typeof__(100) _left0 = (100); __typeof__((15/100.0) * fabsf(posControl.homeWaypointAbove.pos.z - posControl.homePosition.pos.z)) _right1 = ((15/100.0) * fabsf(posControl.homeWaypointAbove.pos.z - posControl.homePosition.pos.z)); _left0 > _right1 ? _left0 : _right1; })) :
                ( __extension__ ({ __typeof__(100) _left2 = (100); __typeof__((15/100.0) * fabsf(posControl.homeWaypointAbove.pos.z - posControl.homePosition.pos.z)) _right3 = ((15/100.0) * fabsf(posControl.homeWaypointAbove.pos.z - posControl.homePosition.pos.z)); _left2 > _right3 ? _left2 : _right3; }));
...
# 1168 "./src/main/navigation/navigation.c" 3 4
                                                            1
# 1168 "./src/main/navigation/navigation.c"
                                                                )) {
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_RTH_HOVER_PRIOR_TO_LANDING(navigationFSMState_t previousState)
{
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE) || !checkForPositionSensorTimeout()) {
        ...
        if ((stateFlags & (FIXED_WING))) {
            ...
            if (( __extension__ ({ __typeof__(wrap_18000(posControl.homeWaypointAbove.yaw - posControl.actualState.yaw)) _abs4 = (wrap_18000(posControl.homeWaypointAbove.yaw - posControl.actualState.yaw)); _abs4 < 0 ? -_abs4 : _abs4; })) < ((15) * 100)) {
                resetLandingDetector();
                updateClimbRateToAltitudeController(0, ROC_TO_ALT_RESET);
                return navigationRTHAllowsLanding() ? NAV_FSM_EVENT_SUCCESS : NAV_FSM_EVENT_SWITCH_TO_RTH_HOVER_ABOVE_HOME;
            }
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_RTH_LANDING(navigationFSMState_t previousState)
{
    ...
    if (!(armingFlags & (ARMED))) {
        ...
        if ((posControl.flags.estAglStatus == EST_TRUSTED) && posControl.actualState.agl.pos.z < 50.0f) {
            ...
            descentVelLimited = ( __extension__ ({ __typeof__(-0.15f * navConfig()->general.land_descent_rate) _left5 = (-0.15f * navConfig()->general.land_descent_rate); __typeof__(-30.0f) _right6 = (-30.0f); _left5 < _right6 ? _left5 : _right6; }));
        }
        else {
            ...
            descentVelLimited = ( __extension__ ({ __typeof__(-descentVelScaling * navConfig()->general.land_descent_rate) _left7 = (-descentVelScaling * navConfig()->general.land_descent_rate); __typeof__(-50.0f) _right8 = (-50.0f); _left7 < _right8 ? _left7 : _right8; }));
        }
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_WAYPOINT_INITIALIZE(navigationFSMState_t previousState)
{
    ...
    if (posControl.waypointCount == 0 || !posControl.waypointListValid) {
        ...
        resetAltitudeController(
# 1330 "./src/main/navigation/navigation.c" 3 4
                               0
# 1330 "./src/main/navigation/navigation.c"
                                    );
        setupAltitudeController();
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_WAYPOINT_IN_PROGRESS(navigationFSMState_t previousState)
{
    ...
    if ((posControl.flags.estPosStatus >= EST_USABLE) && (posControl.flags.estHeadingStatus >= EST_USABLE)) {
        const 
# 1362 "./src/main/navigation/navigation.c" 3 4
             _Bool 
# 1362 "./src/main/navigation/navigation.c"
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_WAYPOINT_NEXT(navigationFSMState_t previousState)
{
    ...
    const 
# 1426 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 1426 "./src/main/navigation/navigation.c"
...
static navigationFSMEvent_t navOnEnteringState_NAV_STATE_EMERGENCY_LANDING_INITIALIZE(navigationFSMState_t previousState)
{
    ...
    resetAltitudeController(
# 1464 "./src/main/navigation/navigation.c" 3 4
                           0
# 1464 "./src/main/navigation/navigation.c"
                                );
...
float navPidApply3(pidController_t *pid, const float setpoint, const float measurement, const float dt, const float outMin, const float outMax, const pidControllerFlags_e pidFlags, const float gainScaler)
{
    ...
    if (pid->reset) {
        ...
        pid->reset = 
# 1636 "./src/main/navigation/navigation.c" 3 4
                    0
# 1636 "./src/main/navigation/navigation.c"
                         ;
    }
...
{
    pid->reset = 
# 1690 "./src/main/navigation/navigation.c" 3 4
                1
# 1690 "./src/main/navigation/navigation.c"
                    ;
...
# 1731 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 1731 "./src/main/navigation/navigation.c"
    isThrustFacingDownwards(void)
{
...
# 1740 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 1740 "./src/main/navigation/navigation.c"
    checkForPositionSensorTimeout(void)
{
    if (navConfig()->general.pos_failure_timeout) {
        if ((posControl.flags.estPosStatus == EST_NONE) && ((millis() - posControl.lastValidPositionTimeMs) > (1000 * navConfig()->general.pos_failure_timeout))) {
            return 
# 1744 "./src/main/navigation/navigation.c" 3 4
                  1
# 1744 "./src/main/navigation/navigation.c"
                      ;
        }
        else {
            return 
# 1747 "./src/main/navigation/navigation.c" 3 4
                  0
# 1747 "./src/main/navigation/navigation.c"
                       ;
        }
    }
    else {
        ...
        return 
# 1752 "./src/main/navigation/navigation.c" 3 4
              0
# 1752 "./src/main/navigation/navigation.c"
                   ;
    }
}
...
void updateActualHorizontalPositionAndVelocity(
# 1759 "./src/main/navigation/navigation.c" 3 4
                                              _Bool 
# 1759 "./src/main/navigation/navigation.c"
                                                   estPosValid, 
# 1759 "./src/main/navigation/navigation.c" 3 4
                                                                _Bool 
# 1759 "./src/main/navigation/navigation.c"
...
void updateActualAltitudeAndClimbRate(
# 1805 "./src/main/navigation/navigation.c" 3 4
                                     _Bool 
# 1805 "./src/main/navigation/navigation.c"
                                          estimateValid, float newAltitude, float newVelocity, float surfaceDistance, float surfaceVelocity, navigationEstimateStatus_e surfaceStatus)
{
    ...
    if ((armingFlags & (ARMED))) {
        if ((posControl.flags.estAglStatus == EST_TRUSTED) && surfaceDistance > 0) {
            if (posControl.actualState.surfaceMin > 0) {
                posControl.actualState.surfaceMin = ( __extension__ ({ __typeof__(posControl.actualState.surfaceMin) _left9 = (posControl.actualState.surfaceMin); __typeof__(surfaceDistance) _right10 = (surfaceDistance); _left9 < _right10 ? _left9 : _right10; }));
            }
            else {
...
void updateActualHeading(
# 1858 "./src/main/navigation/navigation.c" 3 4
                        _Bool 
# 1858 "./src/main/navigation/navigation.c"
                             headingValid, int32_t newHeading)
{
...
# 1942 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 1942 "./src/main/navigation/navigation.c"
    navCalculatePathToDestination(navDestinationPath_t *result, const fpVector3_t * destinationPos)
{
    if (posControl.flags.estPosStatus == EST_NONE ||
        ...
        return 
# 1947 "./src/main/navigation/navigation.c" 3 4
              0
# 1947 "./src/main/navigation/navigation.c"
                   ;
    }
    ...
    return 
# 1956 "./src/main/navigation/navigation.c" 3 4
          1
# 1956 "./src/main/navigation/navigation.c"
              ;
}
...
# 1962 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 1962 "./src/main/navigation/navigation.c"
    isWaypointMissed(const navWaypointPosition_t * waypoint)
{
    int32_t bearingError = calculateBearingToDestination(&waypoint->pos) - waypoint->yaw;
    bearingError = wrap_18000(bearingError);

    return ( __extension__ ({ __typeof__(bearingError) _abs11 = (bearingError); _abs11 < 0 ? -_abs11 : _abs11; })) > 10000;
}


# 1970 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 1970 "./src/main/navigation/navigation.c"
    isWaypointReached(const navWaypointPosition_t * waypoint, const 
# 1970 "./src/main/navigation/navigation.c" 3 4
                                                                    _Bool 
# 1970 "./src/main/navigation/navigation.c"
...
float RTHAltitude() {
    switch (navConfig()->general.flags.rth_alt_control_mode) {
        ...
        case NAV_RTH_MAX_ALT:
            return(( __extension__ ({ __typeof__(posControl.homeWaypointAbove.pos.z) _left12 = (posControl.homeWaypointAbove.pos.z); __typeof__(posControl.actualState.abs.pos.z) _right13 = (posControl.actualState.abs.pos.z); _left12 > _right13 ? _left12 : _right13; })));
        case NAV_RTH_AT_LEAST_ALT:
            return(( __extension__ ({ __typeof__(posControl.homePosition.pos.z + navConfig()->general.rth_altitude) _left14 = (posControl.homePosition.pos.z + navConfig()->general.rth_altitude); __typeof__(posControl.actualState.abs.pos.z) _right15 = (posControl.actualState.abs.pos.z); _left14 > _right15 ? _left14 : _right15; })));
...
# 2035 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2035 "./src/main/navigation/navigation.c"
    validateRTHSanityChecker(void)
{
    const timeMs_t currentTimeMs = millis();
    
# 2038 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 2038 "./src/main/navigation/navigation.c"
        checkResult = 
# 2038 "./src/main/navigation/navigation.c" 3 4
                      1
# 2038 "./src/main/navigation/navigation.c"
    ...
    if (navConfig()->general.rth_abort_threshold == 0) {
        return 
# 2042 "./src/main/navigation/navigation.c" 3 4
              1
# 2042 "./src/main/navigation/navigation.c"
                  ;
    }
    ...
    if ((currentTimeMs - posControl.rthSanityChecker.lastCheckTime) > 100) {
        ...
        if (currentDistanceToHome < posControl.rthSanityChecker.minimalDistanceToHome) {
            ...
            checkResult = 
# 2054 "./src/main/navigation/navigation.c" 3 4
                         0
# 2054 "./src/main/navigation/navigation.c"
                              ;
        }
...
# 2135 "./src/main/navigation/navigation.c" 3 4
           _Bool 
# 2135 "./src/main/navigation/navigation.c"
            ...
            switch ((nav_reset_type_e)positionEstimationConfig()->reset_home_type) {
                ...
                case NAV_RESET_ON_EACH_ARM:
                    setHome = 
# 2143 "./src/main/navigation/navigation.c" 3 4
                             1
# 2143 "./src/main/navigation/navigation.c"
                                 ;
                    break;
            }
            if (setHome) {
        ...
        static 
# 2152 "./src/main/navigation/navigation.c" 3 4
              _Bool 
# 2152 "./src/main/navigation/navigation.c"
                   isHomeResetAllowed = 
# 2152 "./src/main/navigation/navigation.c" 3 4
                                        0
# 2152 "./src/main/navigation/navigation.c"
        ...
        if (IS_RC_MODE_ACTIVE(BOXHOMERESET)) {
            if (isHomeResetAllowed && !(flightModeFlags & (FAILSAFE_MODE)) && !(flightModeFlags & (NAV_RTH_MODE)) && !(flightModeFlags & (NAV_WP_MODE)) && (posControl.flags.estPosStatus >= EST_USABLE)) {
                ...
                isHomeResetAllowed = 
# 2159 "./src/main/navigation/navigation.c" 3 4
                                    0
# 2159 "./src/main/navigation/navigation.c"
                                         ;
            }
        }
        else {
            isHomeResetAllowed = 
# 2163 "./src/main/navigation/navigation.c" 3 4
                                1
# 2163 "./src/main/navigation/navigation.c"
                                    ;
        }
...
void setDesiredPosition(const fpVector3_t * pos, int32_t yaw, navSetWaypointFlags_t useMask)
{
    ...
    if ((useMask & NAV_POS_UPDATE_XY) != 0 && !(stateFlags & (NAV_CRUISE_BRAKING))) {
...
# 2311 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2311 "./src/main/navigation/navigation.c"
    isLandingDetected(void)
{
    
# 2313 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 2313 "./src/main/navigation/navigation.c"
        landingDetected;
...
static void resetAltitudeController(
# 2362 "./src/main/navigation/navigation.c" 3 4
                                   _Bool 
# 2362 "./src/main/navigation/navigation.c"
                                        useTerrainFollowing)
{
...
static 
# 2385 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2385 "./src/main/navigation/navigation.c"
...
static void processBrakingMode(const 
# 2432 "./src/main/navigation/navigation.c" 3 4
                                    _Bool 
# 2432 "./src/main/navigation/navigation.c"
                                         isAdjusting)
{
    ...
    const 
# 2439 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 2439 "./src/main/navigation/navigation.c"
              brakingEntryAllowed =
        IS_RC_MODE_ACTIVE(BOXBRAKING) &&
        !(stateFlags & (NAV_CRUISE_BRAKING_LOCKED)) &&
    ...
    if (brakingEntryAllowed) {
        ...
        if (posControl.actualState.velXY > navConfig()->mc.braking_boost_speed_threshold) {
            (stateFlags |= (NAV_CRUISE_BRAKING_BOOST));
    ...
    if ((stateFlags & (NAV_CRUISE_BRAKING_LOCKED)) && isAdjusting) {
        (stateFlags &= ~(NAV_CRUISE_BRAKING_LOCKED));
    }
    ...
    if ((stateFlags & (NAV_CRUISE_BRAKING)) && (
...
static 
# 2517 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2517 "./src/main/navigation/navigation.c"
           adjustPositionFromRCInput(void)
{
    
# 2519 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 2519 "./src/main/navigation/navigation.c"
        retValue;
...
# 2542 "./src/main/navigation/navigation.c" 3 4
                                                   0
# 2542 "./src/main/navigation/navigation.c"
                                                        ;
    posControl.flags.isGCSAssistedNavigationEnabled = 
# 2543 "./src/main/navigation/navigation.c" 3 4
                                                     0
# 2543 "./src/main/navigation/navigation.c"
                                                          ;
}
...
# 2639 "./src/main/navigation/navigation.c" 3 4
                                      0
# 2639 "./src/main/navigation/navigation.c"
                                           ;
    }
}


# 2643 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2643 "./src/main/navigation/navigation.c"
    isWaypointListValid(void)
{
...
# 2654 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2654 "./src/main/navigation/navigation.c"
    loadNonVolatileWaypointList(void)
{
    if ((armingFlags & (ARMED)))
        return 
# 2657 "./src/main/navigation/navigation.c" 3 4
              0
# 2657 "./src/main/navigation/navigation.c"
                   ;
...
# 2678 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2678 "./src/main/navigation/navigation.c"
    saveNonVolatileWaypointList(void)
{
    if ((armingFlags & (ARMED)) || !posControl.waypointListValid)
        return 
# 2681 "./src/main/navigation/navigation.c" 3 4
              0
# 2681 "./src/main/navigation/navigation.c"
                   ;
    ...
    return 
# 2689 "./src/main/navigation/navigation.c" 3 4
          1
# 2689 "./src/main/navigation/navigation.c"
              ;
}
...
# 2726 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2726 "./src/main/navigation/navigation.c"
    isApproachingLastWaypoint(void)
{
    if (navGetStateFlags(posControl.navState) & NAV_AUTO_WP) {
        if (posControl.waypointCount == 0) {
            ...
            return 
# 2731 "./src/main/navigation/navigation.c" 3 4
                  1
# 2731 "./src/main/navigation/navigation.c"
                      ;
        }
            ...
            return 
# 2735 "./src/main/navigation/navigation.c" 3 4
                  1
# 2735 "./src/main/navigation/navigation.c"
                      ;
        }
        else {
            return 
# 2738 "./src/main/navigation/navigation.c" 3 4
                  0
# 2738 "./src/main/navigation/navigation.c"
                       ;
        }
    }
        ...
        return 
# 2743 "./src/main/navigation/navigation.c" 3 4
              1
# 2743 "./src/main/navigation/navigation.c"
                  ;
    }
    else {
        return 
...
# 2783 "./src/main/navigation/navigation.c" 3 4
                                              0
# 2783 "./src/main/navigation/navigation.c"
                                                   ;
    }
...
# 2790 "./src/main/navigation/navigation.c" 3 4
                                              0
# 2790 "./src/main/navigation/navigation.c"
                                                   ;
    }
    ...
    if ((navStateFlags & NAV_RC_YAW) && (!(flightModeFlags & (FAILSAFE_MODE)))) {
        ...
        posControl.flags.isAdjustingHeading = 
# 2797 "./src/main/navigation/navigation.c" 3 4
                                             0
# 2797 "./src/main/navigation/navigation.c"
                                                  ;
    }
}
...
# 2825 "./src/main/navigation/navigation.c" 3 4
                                             0
# 2825 "./src/main/navigation/navigation.c"
                                                  ;
        return;
    }
...
static 
# 2875 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2875 "./src/main/navigation/navigation.c"
...
static 
# 2885 "./src/main/navigation/navigation.c" 3 4
      _Bool 
# 2885 "./src/main/navigation/navigation.c"
...
{
    static 
# 2892 "./src/main/navigation/navigation.c" 3 4
          _Bool 
# 2892 "./src/main/navigation/navigation.c"
               canActivateWaypoint = 
# 2892 "./src/main/navigation/navigation.c" 3 4
                                     0
# 2892 "./src/main/navigation/navigation.c"
                                          ;
    static 
# 2893 "./src/main/navigation/navigation.c" 3 4
          _Bool 
# 2893 "./src/main/navigation/navigation.c"
...
# 2903 "./src/main/navigation/navigation.c" 3 4
       _Bool 
# 2903 "./src/main/navigation/navigation.c"
            canActivateAltHold = canActivateAltHoldMode();
        
# 2904 "./src/main/navigation/navigation.c" 3 4
       _Bool 
# 2904 "./src/main/navigation/navigation.c"
            canActivatePosHold = canActivatePosHoldMode();
        
# 2905 "./src/main/navigation/navigation.c" 3 4
       _Bool 
# 2905 "./src/main/navigation/navigation.c"
        ...
        if ((stateFlags & (FIXED_WING))) {
            if (isNavLaunchEnabled()) {
                if (canActivateLaunchMode) {
                    canActivateLaunchMode = 
# 2911 "./src/main/navigation/navigation.c" 3 4
                                           0
# 2911 "./src/main/navigation/navigation.c"
                                                ;
        ...
        if (posControl.flags.forcedRTHActivated || (IS_RC_MODE_ACTIVE(BOXNAVRTH) && canActivatePosHold && canActivateNavigation && canActivateAltHold && (stateFlags & (GPS_FIX_HOME)))) {
            ...
            canActivateWaypoint = 
# 2935 "./src/main/navigation/navigation.c" 3 4
                                 0
# 2935 "./src/main/navigation/navigation.c"
                                      ;
        ...
        if (IS_RC_MODE_ACTIVE(BOXMANUAL)) {
            canActivateWaypoint = 
# 2941 "./src/main/navigation/navigation.c" 3 4
                                 0
# 2941 "./src/main/navigation/navigation.c"
                                      ;
            return NAV_FSM_EVENT_SWITCH_TO_IDLE;
        }
        ...
        if (IS_RC_MODE_ACTIVE(BOXNAVWP)) {
            ...
            canActivateWaypoint = 
# 2951 "./src/main/navigation/navigation.c" 3 4
                                 1
# 2951 "./src/main/navigation/navigation.c"
                                     ;
        }
        ...
        canActivateWaypoint = 
# 2977 "./src/main/navigation/navigation.c" 3 4
                             0
# 2977 "./src/main/navigation/navigation.c"
                                  ;
...
# 2989 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2989 "./src/main/navigation/navigation.c"
    navigationRequiresThrottleTiltCompensation(void)
{
...
# 2997 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 2997 "./src/main/navigation/navigation.c"
    navigationRequiresAngleMode(void)
{
...
# 3006 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3006 "./src/main/navigation/navigation.c"
    navigationRequiresTurnAssistance(void)
{
    const navigationFSMStateFlags_t currentState = navGetStateFlags(posControl.navState);
    if ((stateFlags & (FIXED_WING))) {
        ...
        return 
# 3014 "./src/main/navigation/navigation.c" 3 4
              0
# 3014 "./src/main/navigation/navigation.c"
                   ;
    }
}
...
# 3042 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3042 "./src/main/navigation/navigation.c"
    navigationTerrainFollowingEnabled(void)
{
...
# 3047 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3047 "./src/main/navigation/navigation.c"
    navigationBlockArming(void)
{
    const 
# 3049 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 3049 "./src/main/navigation/navigation.c"
    ...
    const 
# 3050 "./src/main/navigation/navigation.c" 3 4
         _Bool 
# 3050 "./src/main/navigation/navigation.c"
...
# 3051 "./src/main/navigation/navigation.c" 3 4
   _Bool 
# 3051 "./src/main/navigation/navigation.c"
        shouldBlockArming = 
# 3051 "./src/main/navigation/navigation.c" 3 4
                            0
# 3051 "./src/main/navigation/navigation.c"
    ...
    if (!navConfig()->general.flags.extra_arming_safety)
        return 
# 3054 "./src/main/navigation/navigation.c" 3 4
              0
# 3054 "./src/main/navigation/navigation.c"
                   ;
    ...
    if ((isUsingNavigationModes() || failsafeMayRequireNavigationMode()) && !((posControl.flags.estPosStatus >= EST_USABLE) && (stateFlags & (GPS_FIX_HOME)))) {
        shouldBlockArming = 
# 3058 "./src/main/navigation/navigation.c" 3 4
                           1
# 3058 "./src/main/navigation/navigation.c"
                               ;
    }
    ...
    if (!(armingFlags & (ARMED)) && navBoxModesEnabled && !navLaunchComboModesEnabled) {
        shouldBlockArming = 
# 3063 "./src/main/navigation/navigation.c" 3 4
                           1
# 3063 "./src/main/navigation/navigation.c"
                               ;
    }
    ...
    if (posControl.waypointCount > 0) {
        ...
        const 
# 3071 "./src/main/navigation/navigation.c" 3 4
             _Bool 
# 3071 "./src/main/navigation/navigation.c"
        ...
        if (navWpMissionStartTooFar) {
            shouldBlockArming = 
# 3074 "./src/main/navigation/navigation.c" 3 4
                               1
# 3074 "./src/main/navigation/navigation.c"
                                   ;
        }
    }
...
# 3082 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3082 "./src/main/navigation/navigation.c"
    navigationPositionEstimateIsHealthy(void)
{
...
{
    static 
# 3092 "./src/main/navigation/navigation.c" 3 4
          _Bool 
# 3092 "./src/main/navigation/navigation.c"
               posReadyBeepDone = 
# 3092 "./src/main/navigation/navigation.c" 3 4
                                  0
# 3092 "./src/main/navigation/navigation.c"
    ...
    if (navigationPositionEstimateIsHealthy() && !posReadyBeepDone) {
        ...
        posReadyBeepDone = 
# 3097 "./src/main/navigation/navigation.c" 3 4
                          1
# 3097 "./src/main/navigation/navigation.c"
                              ;
    }
}
...
void updateFlightBehaviorModifiers(void)
{
    if (posControl.flags.isGCSAssistedNavigationEnabled && !IS_RC_MODE_ACTIVE(BOXGCSNAV)) {
        posControl.flags.isGCSAssistedNavigationReset = 
# 3104 "./src/main/navigation/navigation.c" 3 4
                                                       1
# 3104 "./src/main/navigation/navigation.c"
                                                           ;
    }
...
void navigationInit(void)
{
    ...
    posControl.activeWaypointIndex = 0;
    posControl.waypointListValid = 
# 3204 "./src/main/navigation/navigation.c" 3 4
                                  0
# 3204 "./src/main/navigation/navigation.c"
                                       ;
...
{
    posControl.flags.forcedRTHActivated = 
# 3234 "./src/main/navigation/navigation.c" 3 4
                                         1
# 3234 "./src/main/navigation/navigation.c"
                                             ;
    navProcessFSMEvents(selectNavEventFromBoxModeInput());
}
...
void abortForcedRTH(void)
{
    ...
    posControl.flags.forcedRTHActivated = 
# 3242 "./src/main/navigation/navigation.c" 3 4
                                         0
# 3242 "./src/main/navigation/navigation.c"
                                              ;
...
# 3262 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3262 "./src/main/navigation/navigation.c"
    navigationIsExecutingAnEmergencyLanding(void)
{
...
# 3267 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3267 "./src/main/navigation/navigation.c"
    navigationIsControllingThrottle(void)
{
...
# 3273 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3273 "./src/main/navigation/navigation.c"
    navigationIsFlyingAutonomousMode(void)
{
    navigationFSMStateFlags_t stateFlags = navGetCurrentStateFlags();
...
# 3279 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3279 "./src/main/navigation/navigation.c"
    navigationRTHAllowsLanding(void)
{
...
# 3286 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3286 "./src/main/navigation/navigation.c"
    isNavLaunchEnabled(void)
{
...
# 3305 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3305 "./src/main/navigation/navigation.c"
    isAdjustingPosition(void) {
    return posControl.flags.isAdjustingPosition;
}


# 3309 "./src/main/navigation/navigation.c" 3 4
_Bool 
# 3309 "./src/main/navigation/navigation.c"
    isAdjustingHeading(void) {
